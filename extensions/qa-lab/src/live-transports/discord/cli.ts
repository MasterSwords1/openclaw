...
export const discordQaCliRegistration: LiveTransportQaCliRegistration =
  createLiveTransportQaCliRegistration({
    ...
    channelDriverHelp: "Discord transport boundary: live (default) or Crabline local provider",
    description: "Run Discord QA through the live service or Crabline local provider",
