...
export const forcedUnitFastTestFiles = [
  ...
  "src/acp/agent.boundary.test.ts",
  "src/acp/agent.prompt.test.ts",
  "src/acp/agent.sessions.test.ts",
  "src/acp/approval-host.test.ts",
  "src/acp/local-session-runtime.test.ts",
