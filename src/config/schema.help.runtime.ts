...
export const RUNTIME_FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.otel.metricNamePrefix":
    'Replaces the default "openclaw." prefix on OpenClaw-owned metric names. Include any separator you need, for example "acme."; standard gen_ai.* metric names are unchanged.',
