...
import { renderPromptMarkdownPreview } from "./prompt-preview.ts";
import { renderSegmented } from "./segmented-control.ts";
import { renderSuggestions } from "./suggestions.ts";
  ...
  const promptRow = renderFieldRow({
    ...
    control: codeLanguage
      ...
      : html`
          ...
          ></textarea>
          ${renderPromptMarkdownPreview(payloadText, ctx.payloadLocked)}
        `,
  });
