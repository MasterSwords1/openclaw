...
export const id: TranslationMap = {
  common: {
    ...
    copyCode: "Salin kode",
    resizeSplitView: "Ubah ukuran tampilan terbagi",
    delete: "Hapus",
    remove: "Hapus",
    dismiss: "Tutup",
  ...
  mcpApp: {
    ...
    errors: {
      gatewayUnavailable: "Gateway MCP App tidak tersedia",
      mountUnavailable: "Mount MCP App tidak tersedia",
      sandboxTimedOut: "Sandbox MCP App melewati batas waktu",
      sandboxUnavailable: "Sandbox MCP App tidak tersedia",
      initializationTimedOut: "Inisialisasi MCP App melewati batas waktu",
      requestFailed: "Permintaan gagal",
      invalidSandboxUrl: "URL sandbox MCP App tidak valid",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "Permintaan melewati batas waktu setelah 30 detik; server mungkin masih menerapkan perubahan — periksa profil sebelum mencoba lagi.",
        operationFailed: "{prefix}: {error}",
        updateFailed: "Pembaruan profil gagal",
        updateFailedStatus: "Pembaruan profil gagal ({status})",
        publishFailed: "Publikasi profil gagal di semua relay.",
        published: "Profil dipublikasikan ke relay.",
        importFailed: "Impor profil gagal",
        importFailedStatus: "Impor profil gagal ({status})",
        importedFromRelays: "Profil diimpor dari relay. Tinjau dan publikasikan.",
        imported: "Profil diimpor. Tinjau dan publikasikan.",
      },
    },
  },
  lazyView: {
  ...
  updates: {
    refreshRequired: "Server diperbarui — segarkan untuk kemampuan penuh",
    coalescedRestart:
      "Pembaruan terpasang. Mulai ulang gateway sedang berlangsung; status akan disegarkan setelah tersambung kembali.",
    error: "Kesalahan pembaruan: {error}",
    status: "Pembaruan {status}: {reason}. {guidance}",
    verificationFailed:
      "Pembaruan terpasang tetapi versi yang berjalan tidak berubah — mulai ulang mungkin diblokir.",
    ...
    outcomeUnknown:
      "Permintaan pembaruan mungkin telah diterima, tetapi Gateway tidak melaporkan hasil akhir setelah tersambung kembali. Jalankan `openclaw update status` sebelum mencoba lagi.",
    failureReasons: {
      ...
      buildDirty:
        "Revisi yang dipilih mengubah file checkout build. Coba lagi dengan revisi yang menyertakan artefak yang dihasilkannya.",
      uiBuildFailed: "Pembuatan ulang control UI gagal. Perbaiki kesalahan build UI dan coba lagi.",
      globalInstallFailed:
        "Instalasi paket global tidak terverifikasi di disk. Coba lagi atau instal ulang dari CLI.",
      restartDisabled:
        "Pembaruan tidak diterapkan karena mulai ulang gateway dinonaktifkan. Aktifkan mulai ulang di config, lalu coba lagi.",
      restartUnavailable:
        "Instalasi global ini tidak dapat diganti dengan aman selama mulai ulang dinonaktifkan dan tidak ada supervisor.",
      restartUnhealthy:
        "Proses pengganti tidak pernah menjadi sehat. Proses sebelumnya tetap berjalan agar Anda dapat memulihkan.",
      managedServiceHandoffAlreadyRunning:
        "Pembaruan terkelola lain sedang berjalan. Tunggu hingga selesai, lalu segarkan status pembaruan.",
      doctorFailed:
        "Perbaikan doctor gagal. Jalankan `openclaw doctor --non-interactive` dan coba lagi.",
      default:
        "Lihat log gateway untuk mengetahui kegagalan yang tepat dan coba lagi setelah penyebabnya diperbaiki.",
    },
    postRestart: {
      restartUnhealthy:
        "Proses pengganti tidak pernah menjadi sehat dan proses sebelumnya tetap berjalan.",
      default: "Periksa log gateway untuk kegagalan penggantian.",
    },
  },
  nodes: {
    pairing: {
  ...
  newSession: {
    ...
    draft: "Draf",
    draftDescription: "Simpan thread ini untuk diri Anda sampai Anda memublikasikannya",
  ...
  agents: {
    ...
    defaults: {
      title: "Default agen",
      description: "Default yang diwarisi setiap agen kecuali ditimpa.",
    },
    copyId: "Copy ID",
  ...
  configForm: {
    redactedPlaceholder: "[disunting - klik tampilkan untuk melihat]",
    sectionHelp: "Bantuan untuk {section}",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardFirstVisited: "Pertama dikunjungi {date}",
      lobsterdexCardShinySeen: "✦ Shiny terlihat {date}",
      lobsterdexCardCopyLink: "Salin tautan",
      lobsterdexOpen: "Buka Lobsterdex",
    },
    security: {
      intro: "Tinjau akses gateway, kebijakan alat, autentikasi perangkat, dan persetujuan.",
      title: "Keamanan",
  ...
  configView: {
    ...
    syncPendingHint: "Menunggu sinkronisasi melalui gateway.",
    notifications: {
  ...
  terminal: {
    ...
    uploadTooLarge: "File melebihi batas unggah terminal 16 MiB: {file}",
    uploadUnsafeCmdPath:
      "Tidak dapat menyisipkan path yang diunggah dengan aman jika mengandung % atau ! ke dalam cmd.exe",
    uploadUnsupportedShell:
      "Tidak dapat menyisipkan path yang diunggah dengan aman ke shell yang tidak didukung: {shell}",
  },
  browser: {
    title: "Browser",
    ...
    errors: {
      requestFailed: "Permintaan browser gagal: {error}",
      screenshotPathMissing: "Tangkapan layar browser tidak mengembalikan path media.",
      screenshotFetchTimedOut: "Pengambilan tangkapan layar melampaui batas waktu.",
      screenshotFetchFailed: "Pengambilan tangkapan layar gagal ({status}).",
      screenshotReadFailed: "Pembacaan tangkapan layar gagal.",
      screenshotDecodeFailed: "Dekode tangkapan layar gagal.",
      canvasUnavailable: "Konteks Canvas 2D tidak tersedia.",
    },
    annotatePrompt: {
      introTitled:
  ...
  subtitles: {
    ...
    lobsterdex: "Setiap palet lobster yang telah mengunjungi browser ini.",
    automation: "Perintah, hook, cron, dan plugin.",
    mcp: "Server MCP, autentikasi, alat, dan diagnostik.",
    memory: "Engine memori, backend, pencarian, dan dreaming.",
    talk: "Suara realtime: penyedia, model, dan suara pembicara.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} tidak menampilkan model lokal yang dapat digunakan. Tinjau hasil penyiapan, lalu coba lagi.",
    },
    manual: {
      ...
      accessValueFor: "API key atau token {provider}",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "Dari sesi sebelumnya",
      subtitle:
        "Siapkan memori tepercaya dari sesi agen sebelumnya. Dreaming mempromosikan yang berguna ke memori jangka panjang.",
      dateRange: "Rentang tanggal sesi",
      dateRangeHint: "Kosongkan salah satu tanggal untuk memindai seluruh rentang yang tersedia.",
      from: "Dari",
      to: "Ke",
      actions: "Isi ulang",
      preview: "Pratinjau",
      ...
      applying: "Menerapkan…",
      rollback: "Kembalikan",
      previewSummary: "{candidates} kandidat dalam {days} hari",
      previewTruncated:
        "Pratinjau ini menampilkan batch terbatas pertama. Terapkan akan melanjutkan sisa kandidat.",
      candidateCount: "{count} kandidat",
      noCandidates: "Tidak ada kandidat sesi tepercaya baru yang ditemukan.",
      progress: "Diproses {days} hari · {staged} disiapkan",
      processedCandidates: "{count} kandidat sesi diproses",
      processedDayCountOne: "{count} hari diproses",
      processedDayCount: "{count} hari diproses",
      complete: "{count} disiapkan; promosi terjadi melalui dreaming",
      rollbackConfirmTitle: "Rollback backfill sesi?",
      rollbackConfirmDescription:
        "Hapus entri diary dan memori yang telah di-stage yang dibuat oleh backfill sesi untuk agen ini.",
      rollbackWarning:
        "Kursor sesi yang dilacak tetap ada, jadi entri yang dihapus tidak akan di-stage lagi.",
      rollbackComplete: "Backfill sesi telah di-rollback",
      rollbackCounts: "{diary} entri diary dan {staged} entri yang di-stage telah dihapus",
      unavailable: "Backfill sesi tidak tersedia di Gateway ini.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupDismiss: "Terus gunakan aplikasi web",
    },
  },
  mcpServers: {
    add: "Tambah server",
    ...
    sessionEnableFailed:
      "Server disimpan dalam keadaan dinonaktifkan secara global, tetapi gagal mengaktifkannya untuk sesi ini: {error}",
  ...
  mcpPage: {
    ...
    setUpFirstServer: "Siapkan server MCP pertama Anda",
  ...
  talkPage: {
    intro: "Konfigurasikan penyedia suara realtime, model, dan suara pembicara.",
    voiceSection: {
      title: "Suara realtime",
      description:
        "Percakapan suara berkelanjutan dengan agen Anda. Pemilih di bawah menulis pengaturan talk.realtime; formulir lengkap lebih lanjut di bawah mencakup semua hal lainnya.",
    },
    status: {
      title: "Status",
      ready: "Siap",
      notReady: "Belum dikonfigurasi",
      unavailable: "Tidak tersedia",
      unavailableHint: "Hubungkan ke Gateway untuk memeriksa kesiapan suara realtime.",
      activeProvider: "Penyedia aktif: {provider}",
      noProvider: "Belum ada penyedia suara realtime yang dikonfigurasi.",
    },
    provider: {
      title: "Penyedia",
      description: "Auto memilih penyedia pertama dengan kredensial yang berfungsi.",
      auto: "Otomatis",
    },
    model: {
      title: "Model",
      description: "Model suara realtime untuk sesi Talk di browser.",
      default: "Default penyedia",
      defaultNamed: "Default ({model})",
    },
    voice: {
      title: "Suara pembicara",
      description:
        "Suara yang digunakan untuk balasan lisan. GPT-Live mengunci suara setelah panggilan dimulai.",
      default: "Default penyedia",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live bekerja dengan langganan ChatGPT: masuk sekali dengan “openclaw models auth login --provider openai”. Tidak perlu kunci Platform API. Hanya untuk Talk di browser. Pekerjaan yang didelegasikan dapat diarahkan saat berjalan dan memerlukan konfirmasi lisan yang tepat untuk tindakan berdampak tinggi.",
      ready: "Siap",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        awake: "Memori aktif",
        waking: "Membangunkan memori…",
        hibernating: "Memori sedang hibernasi",
        needsAttention: "Memori memerlukan perhatian",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Memeriksa mesin memori dan siklus mimpi agen ini.",
        offDescription: "Pilih mesin memori di Pengaturan untuk mengaktifkannya.",
        disabledDescription:
          "Mesin memori yang dipilih dinonaktifkan. Aktifkan kembali di Pengaturan.",
        gatewayOffline: "Gateway sedang offline, jadi status memori tidak tersedia.",
        hybridSearch: "pencarian hibrida",
        keywordSearch: "pencarian kata kunci (tanpa embedding)",
      ...
      schedule: {
        title: "Jadwal tidur",
        lightDescription:
          "Mengurutkan catatan jangka pendek baru dan menyiapkan kandidat menjanjikan tanpa mengubah memori jangka panjang.",
        remDescription:
          "Merefleksikan tema dan ide berulang di seluruh aktivitas terbaru untuk memperkuat pemeringkatan tanpa mengubah memori jangka panjang.",
        deepDescription:
          "Menilai kandidat yang disiapkan, mempromosikan yang layak ke memori jangka panjang (MEMORY.md), dan menulis buku harian mimpi.",
        nextRun: "berikutnya {time}",
        lastRun: "terakhir {time}",
        notScheduled: "Tidak dijadwalkan",
        learnMore: "Cara kerja dreaming",
        openDocs: "Buka panduan dreaming",
      },
      activity: {
        title: "Aktivitas",
        promotedToday: "Dipromosikan hari ini",
        promotedTotal: "Total dipromosikan",
        shortTermCount: "Entri jangka pendek tertunda",
        phaseHitCount: "Sinyal fase",
        lightPhaseHitCount: "Hit fase ringan",
        remPhaseHitCount: "Hit fase REM",
      },
      health: {
        title: "Kesehatan mesin",
        provider: "Provider",
        embeddings: "Embeddings",
        runtime: "Runtime embedding",
        healthy: "Siap",
        unavailable: "Tidak tersedia",
        notChecked: "Belum diperiksa",
        notCheckedDescription: "Kesiapan embedding belum diperiksa.",
        checking: "Memeriksa…",
        test: "Uji",
        testing: "Menguji…",
      },
      shortcuts: {
        title: "Jelajahi memori",
        memories: "Cari memori",
        diary: "Baca buku harian mimpi",
        settings: "Konfigurasikan memori",
      },
    },
    memories: {
      searchLabel: "Cari memori",
      searchPlaceholder: "Cari memori agen ini",
      searchButton: "Pencarian",
      idle: "Cari orang, proyek, keputusan, atau apa pun yang diingat agen ini.",
      searching: "Mencari memori…",
      results: "{count} hasil",
      empty: "Tidak ada memori yang cocok dengan “{query}”.",
      error: "Pencarian memori gagal: {message}",
      retry: "Coba lagi",
      gatewayUpdateRequired: "Perbarui gateway untuk mencari memori dari Control UI.",
      hybridSearch: "pencarian hibrida",
      keywordSearch: "pencarian kata kunci",
      lineRange: "baris {start}–{end}",
      score: "skor {score}",
      sourceMemory: "memori",
      sourceSessions: "sesi",
      fileLoading: "Memuat berkas memori lengkap…",
      fileError: "Tidak dapat memuat berkas memori ini: {message}",
      fileUnsupported: "Berkas memori ini tidak dapat ditampilkan sebagai teks.",
    },
    engine: {
      title: "Engine",
      description:
      ...
      catalogUnavailable: "Sambungkan ke gateway untuk mengubah engine memory.",
      changeFailed: "Tidak dapat mengubah engine memory",
      disabledTitle: "Engine ini dinonaktifkan",
      disabledHint:
        "Slot memory menunjuk ke plugin ini, tetapi plugin itu sendiri dinonaktifkan, sehingga memory tidak berjalan.",
      enable: "Aktifkan",
    },
    backend: {
      title: "Backend",
      description: "Bagaimana memory disimpan dan diambil untuk engine yang dipilih.",
      rowTitle: "Backend pengambilan",
      builtin: "Bawaan",
      qmd: "QMD",
      invalid: "Nilai yang dikonfigurasi tidak valid",
      ...
      invalidHint:
        "Nilai memory.backend yang dikonfigurasi tidak valid. Pilih backend atau setel ulang untuk menggunakan default.",
    },
    addons: {
      title: "Add-on",
      description:
        "Plugin ini berjalan di atas engine alih-alih bersaing memperebutkan slot, jadi kombinasi apa pun dapat berjalan sekaligus.",
      activeMemory: {
        title: "Memory aktif",
      },
      memoryWiki: {
      ...
      toggleAriaLabel: "Aktifkan atau nonaktifkan {plugin}",
      changeFailed: "Tidak dapat memperbarui {plugin}",
    ...
    import: {
      title: "Impor",
      description: "Bawa memory yang ada dari asisten lain ke ruang kerja agen.",
      link: "Buka Impor Memory",
    },
    search: {
      intro:
        "Default embedding dan pengambilan yang dibagikan oleh setiap agen yang tidak memiliki penggantian memory.",
    },
    dreaming: {
      intro:
        "Dreaming berjalan sebagai satu cron job terkelola di seluruh workspace agen, sehingga pengaturan ini bersifat global. Pengaturan ini dimiliki oleh plugin {plugin}.",
      schedule: {
        title: "Jadwal",
        description: "Kapan sweep penuh berjalan dan model mana yang menarasikannya.",
      },
      frequency: {
        label: "Frekuensi dreaming",
        help: "Irama cron untuk sweep dreaming penuh (light, REM, lalu deep). Biarkan kosong untuk default plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Zona waktu",
        ...
        default: "Zona waktu lokal Gateway",
      },
      model: {
        label: "Model dreaming",
        help: "Override provider/model untuk narasi dream diary. Memerlukan override model subagent yang diizinkan.",
        placeholder: "anthropic/claude-sonnet-4-6",
        default: "Model agen",
      },
      verboseLogging: {
        label: "Logging verbose",
        help: "Catat setiap fase dreaming secara detail. Berguna saat menyetel threshold.",
      },
      storage: {
        title: "Penyimpanan",
      ...
      phases: {
        light: {
          title: "Fase ringan",
          description: "Pass aktivitas terkini yang murah untuk menyiapkan kandidat replay.",
        },
        deep: {
          title: "Fase dalam",
          description:
            "Pass promosi berbasis skor yang meluluskan entri jangka pendek ke dalam memori.",
        },
        rem: {
          title: "Fase REM",
      ...
      phaseFields: {
        ...
        limit: "Batas",
        limitHelp: "Jumlah maksimum entri yang diproses fase ini per pengoperasian.",
        dedupeSimilarity: "Kemiripan dedupe",
        dedupeSimilarityHelp: "Kemiripan di atas mana dua kandidat dianggap sebagai duplikat.",
        minScore: "Skor minimum",
        minScoreHelp: "Skor promosi yang harus dicapai sebuah entri.",
        minRecallCount: "Recall minimum",
        minRecallCountHelp:
          "Seberapa sering sebuah entri harus diingat kembali sebelum dapat dipromosikan.",
        minUniqueQueries: "Kueri unik minimum",
        minUniqueQueriesHelp: "Berapa banyak kueri berbeda yang harus memunculkan entri.",
        recencyHalfLifeDays: "Waktu paruh keterkinian (hari)",
        recencyHalfLifeDaysHelp: "Seberapa cepat sinyal ingatan lama kehilangan bobot.",
        maxAgeDays: "Usia maksimum (hari)",
        maxAgeDaysHelp: "Abaikan entri jangka pendek yang lebih tua dari ini.",
        maxPromotedSnippetTokens: "Token cuplikan terpromosi maks",
  ...
  labsPage: {
    ...
    localModelLean: {
      ...
      description:
        "Buang alat default yang berat yang ditangani dengan buruk oleh model lokal yang lebih kecil, menyisakan set yang lebih pendek yang dapat mereka gunakan dengan andal.",
    },
    auditMessages: {
      title: "Metadata audit pesan",
      description:
        "Rekam metadata tanpa konten untuk percakapan langsung di catatan audit. Konten pesan tidak pernah disimpan.",
    },
  },
  aboutPage: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Lihat aktivitas, biaya, dan tren penggunaan.",
    identity: {
      title: "Identitas",
  ...
  skillWorkshop: {
    ...
    evaluation: {
      ...
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "Revisi proposal saat ini tidak dapat diidentifikasi.",
        revisionChanged: "Revisi proposal berubah selama evaluasi.",
      },
    },
    empty: {
    ...
    today: {
      ...
      evaluate: "Evaluasi",
      runChecks: "Jalankan pemeriksaan proposal",
      tweakIt: "Sesuaikan",
  ...
  dreaming: {
    ...
    header: {
      ...
      engineOff: "Mesin memori Nonaktif. Pilih mesin di Pengaturan untuk mengaktifkan dreaming.",
    },
    toggleConfirmation: {
      subtitle: "Dreaming adalah pengaturan global; tidak dibatasi pada agen ini.",
      enableTitle: "Aktifkan Dreaming untuk Semua Agen",
      enableDetail:
        "Penyapuan dreaming malam hari akan berjalan di setiap ruang kerja agen yang dikonfigurasi, mempromosikan ingatan jangka pendek ke memori jangka panjang. Ini berlaku segera.",
      enableConfirm: "Aktifkan Dreaming",
      disableTitle: "Nonaktifkan Dreaming untuk Semua Agen",
      disableDetail:
        "Penyapuan dreaming malam hari akan berhenti untuk setiap agen yang dikonfigurasi, bukan hanya yang ini. Memori yang sudah tertulis tetap ada; tidak ada yang baru dipromosikan. Ini berlaku segera.",
    ...
    actions: {
      dedupeRemovedOneAndKept: "Menghapus {removed} entri mimpi duplikat dan menyimpan {kept}.",
      dedupeRemovedManyAndKept: "Menghapus {removed} entri mimpi duplikat dan menyimpan {kept}.",
      dedupeRemovedOne: "Menghapus {removed} entri mimpi duplikat.",
      dedupeRemovedMany: "Menghapus {removed} entri mimpi duplikat.",
      repairArchivedThreadCorpus: "korpus utas yang diarsipkan",
      repairArchivedIngestionState: "status ingesti terarsip",
      repairArchivedDreamDiary: "diary mimpi terarsip",
      repairNoChanges: "Perbaikan cache mimpi selesai tanpa perubahan.",
      repairCompleteWithArchive: "Perbaikan cache mimpi selesai: {actions}. Arsip: {archiveDir}",
      repairComplete: "Perbaikan cache mimpi selesai: {actions}.",
      backfillComplete: "Mengisi ulang {count} entri diary mimpi.",
      resetDiaryComplete: "Menghapus {count} entri diary mimpi yang telah diisi ulang.",
      clearReplayedComplete: "Menghapus {count} entri jangka pendek yang telah diputar ulang.",
      complete: "Tindakan diary mimpi selesai.",
      confirmRepair:
        "Perbaiki Cache Mimpi? Ini akan mengarsipkan file cache mimpi turunan dan membangunnya kembali dari input yang bersih. Diary mimpi Anda tetap tidak tersentuh.",
      confirmDedupe:
        "Deduplikasi Diary Mimpi? Ini akan menulis ulang DREAMS.md dan hanya menghapus entri diary duplikat yang persis sama.",
      archivePathCopied: "Path arsip disalin.",
      archivePathCopyFailed: "Tidak dapat menyalin path arsip.",
      updateFailed: "Tidak dapat memperbarui pengaturan dreaming.",
      unsupportedPlugin: 'Plugin memori terpilih "{pluginId}" tidak mendukung pengaturan dreaming.',
      configHashMissing: "Config hash hilang; segarkan dan coba lagi.",
    },
    wiki: {
      ...
      counts: {
        pageOne: "{count} halaman",
        pages: "{count} halaman",
        claimRowOne: "{count} baris klaim",
        claimRows: "{count} baris klaim",
        openQuestionOne: "{count} pertanyaan terbuka",
        openQuestions: "{count} pertanyaan terbuka",
        contradictionOne: "{count} kontradiksi",
        contradictions: "{count} kontradiksi",
        chats: "{count} obrolan",
        sensitive: "{count} sensitif",
        signals: "{count} sinyal",
        messages: "{count} pesan",
        userMessages: "{count} pengguna",
        assistantMessages: "{count} asisten",
      },
      pageGroupSummary: "{label} · {count}",
      noPagesYet: "Belum ada halaman",
      sectionPageSummary: "{label}: {count}",
      questionCountOnPages: "{questionCount} di {pageCount}",
      risk: {
      ...
      pageNotFound: "Tidak ada halaman wiki yang ditemukan untuk {lookup}.",
      previewTruncated: "Menampilkan bagian pertama dari halaman ini.",
      previewTruncatedWithTotal:
        "Menampilkan bagian pertama dari halaman ini (total {count} baris).",
      importedClusterSummary: "Obrolan yang diimpor dikelompokkan berdasarkan {label}.",
      withheldDigestOne: "{count} ringkasan ditahan menunggu peninjauan.",
      withheldDigests: "{count} ringkasan ditahan menunggu peninjauan.",
      details: "Detail",
      hideDetails: "Sembunyikan detail",
      vault: "Vault",
      fullVaultBreakdown: "Rincian lengkap vault: {breakdown}.",
      selectedSection: "Bagian yang dipilih: {summary}.",
      latestUpdate: "Pembaruan terbaru {date}.",
      noContent: "Tidak ada konten wiki yang tersedia.",
    },
    phrases: {
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      signedInNoModels:
        "Anda telah masuk, tetapi akun ini tidak menampilkan model yang dapat digunakan. Pilih penyedia atau akun lain untuk melanjutkan.",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Intensitas token harian untuk rentang yang dipilih, hingga satu tahun.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Masih ada hasil pencarian. Gunakan prefiks id yang lebih panjang.",
    },
    commandResults: {
      startingNewThread: "Memulai thread baru...",
      resettingThread: "Mereset thread...",
      stoppingCurrentRun: "Menghentikan run saat ini...",
      chatHistoryCleared: "Riwayat chat dihapus.",
      exportingThread: "Mengekspor thread...",
      unknownCommand: "Perintah tidak dikenal: `{command}`",
      options: "Opsi: {options}.",
      sessionUnavailable: "Kapabilitas sesi tidak tersedia",
      help: {
        availableCommands: "Perintah yang Tersedia",
        agentCommand: "agen",
        openMenu: "Ketik `/` untuk membuka menu perintah.",
      },
      compaction: {
        failed: "Pemadatan gagal.",
        failedWithReason: "Pemadatan gagal: {reason}",
        tokenSummary: " ({before} -> {after} token)",
        succeeded: "Konteks berhasil dipadatkan",
        skipped: "Pemadatan dilewati.",
        skippedWithReason: "Pemadatan dilewati: {reason}",
      },
      model: {
        current: "**Model saat ini:** {model}",
        available: "**Tersedia:** {models}",
        more: "+{count} lainnya",
        getFailed: "Gagal mendapatkan info model: {error}",
        set: "Model diatur ke {model}.",
        setFailed: "Gagal mengatur model: {error}",
      },
      thinking: {
        current: "Level thinking saat ini: {level}.",
        getFailed: "Gagal mendapatkan level thinking: {error}",
        reset: "Level thinking direset ke default.",
        resetFailed: "Gagal mereset level thinking: {error}",
        unrecognized: 'Level thinking "{level}" tidak dikenali. Level yang valid: {options}.',
        unsupported:
          'Level thinking "{level}" tidak didukung untuk model ini. Level yang valid: {options}.',
        set: "Level thinking diatur ke {level}.",
        setFailed: "Gagal mengatur level thinking: {error}",
      },
      verbose: {
        current: "Level verbose saat ini: {level}.",
        getFailed: "Gagal mendapatkan level verbose: {error}",
        unrecognized: 'Level verbose "{level}" tidak dikenali. Level yang valid: off, on, full.',
        set: "Mode verbose diatur ke {level}.",
        setFailed: "Gagal mengatur mode verbose: {error}",
      },
      fast: {
        autoValue: "auto ({seconds} dtk)",
        on: "aktif",
        off: "nonaktif",
        sourceSession: " (sesi)",
        ...
        current: "Mode cepat saat ini: {value}",
        options: "on, off, auto ({seconds} dtk), default, status",
        getFailed: "Gagal mendapatkan mode cepat: {error}",
        reset: "Mode cepat disetel ulang ke default.",
        resetFailed: "Gagal menyetel ulang mode cepat: {error}",
        unrecognized:
          'Mode cepat "{mode}" tidak dikenali. Level valid: on, off, auto, default, status.',
        setAuto: "Mode cepat disetel ke auto.",
        enabled: "Mode cepat diaktifkan.",
        disabled: "Mode cepat dinonaktifkan.",
        setFailed: "Gagal menyetel mode cepat: {error}",
      },
      usage: {
        noActiveThread: "Tidak ada thread aktif.",
        notAvailable: "t/a",
        title: "Penggunaan Thread",
        inputTokens: "Input: {count} token",
        outputTokens: "Output: {count} token",
        totalTokens: "Total: {count} token",
        context: "Konteks: {percent} dari {total}",
        model: "Model: {model}",
        failed: "Gagal mendapatkan penggunaan: {error}",
      },
      agents: {
        none: "Tidak ada agent yang dikonfigurasi.",
        title: "**Agent** ({count})",
        default: "default",
        runtime: " · runtime {runtime}",
        failed: "Gagal menampilkan agent: {error}",
      },
      steer: {
        timeout: "Run aktif berakhir sebelum pesan steer diterima.",
        failed: "Steer gagal sebelum mencapai run; coba lagi.",
        usage: "Penggunaan: `/steer <message>`",
        noActiveRun: "Tidak ada run aktif. Gunakan input chat atau `/redirect`.",
        succeeded: "Berhasil di-steer.",
        requestFailed: "Gagal melakukan steer: {error}",
      },
      redirect: {
        timeout: "Run aktif berakhir sebelum pesan redirect diterima.",
        failed: "Redirect gagal sebelum mencapai run; coba lagi.",
        usage: "Penggunaan: `/redirect <message>`",
        succeeded: "Berhasil dialihkan.",
        requestFailed: "Gagal melakukan redirect: {error}",
      },
    },
    sessionSharing: {
      menu: "Berbagi thread",
    ...
    actions: {
      copyAsMarkdown: "Salin sebagai markdown",
      dismissError: "Tutup kesalahan",
      exitFocusMode: "Keluar dari mode fokus",
      scrollToLatest: "Gulir ke terbaru",
    },
    markdown: {
      truncated: "… terpotong ({total} karakter, menampilkan {shown} pertama).",
    },
    codeBlock: {
      jsonLines: "JSON · {count} baris",
    },
    workspaceConflict: {
    ...
    sidebar: {
      ...
      groups: "Grup",
      coding: "Coding",
      noSessionsForAgent: "Tidak ada sesi ditemukan untuk agent ini",
      ...
      catalogDiscoveryHelp:
        "{error}. Konfigurasikan penemuan thread native di Settings > Automation > Plugins.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        ...
        applyingSettings: "Menerapkan pengaturan obrolan",
        waitingForRun: "Menunggu proses saat ini",
        runningCommand: "Menjalankan perintah",
        waitingForReconnect: "Menunggu penyambungan ulang",
        needsReview: "Perlu ditinjau",
      },
      imageCount: "Gambar ({count})",
    },
    goals: {
      edit: "Edit tujuan",
      pause: "Jeda tujuan",
      ...
      clear: "Hapus tujuan",
      showDetails: "Tampilkan detail sasaran",
      hideDetails: "Sembunyikan detail sasaran",
    },
    questions: {
      ...
      expired: "Kedaluwarsa",
      cancelled: "Dibatalkan",
      disconnected: "Tidak tersambung. Coba lagi setelah tersambung kembali.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      message: "pesan",
      currentMessage: "pesan saat ini",
      actions: "Tindakan pesan",
      selectionActions: "Tindakan pilihan",
      moreDetails: "Detail lainnya",
      askInSideChat: "Tanyakan di obrolan samping",
      rewind: "Putar ulang",
      ...
      duplicatesCollapsed: "{count} pesan identik berturut-turut diciutkan",
      contextFor: "Konteks pesan untuk {timestamp}",
    },
    mediaPlayer: {
      play: "Putar",
      pause: "Jeda",
    ...
    modelControls: {
      ...
      chatOnly: "Hanya obrolan",
      chatOnlyHelp:
        "Model ini dapat mengobrol, tetapi tidak dapat menggunakan alat. Pilih model lain untuk tugas file, perintah, web, atau media.",
      ...
      fastResponsesAria: "Respons cepat: {state}",
    },
    rail: {
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "Konten lengkap tidak tersedia karena entri transkrip yang tersimpan terlalu besar untuk dikembalikan dengan aman.",
      fullContentNotVisible:
        "Konten lengkap tidak tersedia karena entri transkrip ini tidak memiliki proyeksi WebChat yang terlihat.",
      fullContentUnavailable: "Konten lengkap tidak lagi tersedia untuk entri transkrip ini.",
      copyContents: "Salin isi file",
      fileChanged: "File berubah di disk sejak dimuat.",
      renderPreview: "Render pratinjau",
      imagePreview: "Pratinjau gambar",
      file: "File",
      markdownPreview: "Pratinjau Markdown",
      toolDetails: "Detail alat",
      reloadFailed: "Gagal memuat ulang file terbaru.",
      overwriteLoadFailed: "Gagal memuat file terbaru sebelum menimpa.",
      fullContentLoadFailed: "Gagal memuat konten lengkap: {error}",
    },
    sidebarColumns: {
      chat: "Chat",
      discussion: "Diskusi",
    ...
    composer: {
      ...
      compactingContext: "Meringkas konteks...",
      compacting: "Meringkas",
      compact: "Ringkas",
      contextCompacted: "Konteks diringkas",
      fallbackActive: "Fallback aktif: {model}",
      fallbackCleared: "Fallback dibersihkan: {model}",
      fallbackSelected: "Dipilih: {model}",
      fallbackCurrent: "Aktif: {model}",
      fallbackPrevious: "Fallback sebelumnya: {model}",
      fallbackReason: "Alasan: {reason}",
      fallbackAttempts: "Percobaan: {attempts}",
      ...
      menu: {
        ...
        scopeSessionHint:
          "Server disimpan dalam keadaan nonaktif secara global dan hanya aktif untuk sesi ini.",
        ...
        noSkills: "Tidak ada Skills yang tersedia.",
        noConnectors: "Tidak ada server MCP yang dikonfigurasi.",
        depsMissing: "dependensi tidak ada",
        skillBlocked: "tidak tersedia untuk agen ini",
        sessionTag: "sesi",
        offlineBlocked: "Sambungkan ke Gateway untuk mengubah kapabilitas sesi.",
        readOnlyBlocked: "Akses tulis diperlukan untuk mengubah kapabilitas sesi.",
        adminBlocked: "Akses admin diperlukan untuk mengelola konektor.",
        savingBlocked: "Tunggu perubahan kapabilitas sesi saat ini selesai.",
      },
      overrides: {
        count: "{count} penggantian sesi",
        countOne: "{count} penggantian sesi",
        clear: "Bersihkan penggantian sesi",
      },
      contextUsage: {
    ...
    attachments: {
      ...
      outsideAllowedFolders: "Di luar folder yang diizinkan",
      unavailable: "Tidak tersedia",
      checking: "Memeriksa...",
    },
    voice: {
  ...
  cron: {
    adminRequired: "Hanya menelusuri. Perubahan otomatisasi memerlukan akses operator.admin.",
    tabs: {
