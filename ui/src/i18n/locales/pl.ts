...
export const pl: TranslationMap = {
  common: {
    ...
    copyCode: "Kopiuj kod",
    resizeSplitView: "Zmień rozmiar widoku podzielonego",
    delete: "Usuń",
    remove: "Usuń",
    dismiss: "Odrzuć",
    unselect: "Odznacz",
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "Przekroczono limit czasu żądania po 30 sekundach; serwer mógł już zastosować zmianę — sprawdź profil przed ponowną próbą.",
        ...
        publishFailed: "Publikacja profilu nie powiodła się na wszystkich przekaźnikach.",
        published: "Profil opublikowany na przekaźnikach.",
        importFailed: "Import profilu nie powiódł się",
        importFailedStatus: "Import profilu nie powiódł się ({status})",
        importedFromRelays: "Profil zaimportowany z przekaźników. Sprawdź i opublikuj.",
        imported: "Profil zaimportowany. Sprawdź i opublikuj.",
      },
    },
  },
  lazyView: {
    ...
    stylesFailed: "Nie udało się załadować stylów, więc strona może wyglądać na uszkodzoną.",
  },
  updates: {
    refreshRequired: "Serwer zaktualizowany — odśwież, aby uzyskać pełne możliwości",
    coalescedRestart:
      "Aktualizacja zainstalowana. Ponowne uruchomienie gatewaya jest już w toku; status zostanie odświeżony po ponownym połączeniu.",
    error: "Błąd aktualizacji: {error}",
    status: "Aktualizacja {status}: {reason}. {guidance}",
    verificationFailed:
      "Aktualizacja zainstalowana, ale uruchomiona wersja nie zmieniła się — ponowne uruchomienie mogło zostać zablokowane.",
    ...
    outcomeUnknown:
      "Żądanie aktualizacji mogło zostać przyjęte, ale Gateway nie zgłosił ostatecznego wyniku po ponownym połączeniu. Uruchom `openclaw update status` przed ponowną próbą.",
    failureReasons: {
      ...
      notGitInstall:
        "To nie jest git checkout. Uruchom `openclaw update` z CLI, aby wykonać globalną ponowną instalację.",
      notOpenclawRoot:
        "Uruchom aktualizację z checkoutu OpenClaw lub użyj ścieżki globalnej ponownej instalacji CLI.",
      depsInstallFailed:
        "Instalacja zależności nie powiodła się. Napraw błąd instalacji i spróbuj ponownie.",
      buildFailed: "Budowanie nie powiodło się. Napraw błąd budowania i spróbuj ponownie.",
      buildDirty:
        "Kompilacja wybranej wersji zmieniła pliki checkout. Spróbuj ponownie z wersją zawierającą wygenerowane artefakty.",
      uiBuildFailed:
        "Przebudowa control UI nie powiodła się. Napraw błąd kompilacji UI i spróbuj ponownie.",
      globalInstallFailed:
        "Globalna instalacja pakietu nie została zweryfikowana na dysku. Spróbuj ponownie lub przeinstaluj z CLI.",
      restartDisabled:
        "Aktualizacja nie została zastosowana, ponieważ restarty Gateway są wyłączone. Włącz restarty w konfiguracji, a następnie spróbuj ponownie.",
      restartUnavailable:
        "Tej globalnej instalacji nie można bezpiecznie zastąpić, gdy restarty są wyłączone i nie ma nadzorcy.",
      restartUnhealthy:
        "Proces zastępczy nigdy nie osiągnął sprawności. Poprzedni proces pozostał aktywny, abyś mógł go przywrócić.",
      managedServiceHandoffAlreadyRunning:
        "Inna zarządzana aktualizacja jest już uruchomiona. Poczekaj na jej zakończenie, a następnie odśwież status aktualizacji.",
      doctorFailed:
        "Naprawa Doctor nie powiodła się. Uruchom `openclaw doctor --non-interactive` i spróbuj ponownie.",
      default:
        "Sprawdź logi Gateway, aby poznać dokładną przyczynę błędu, i spróbuj ponownie po jej usunięciu.",
    },
    postRestart: {
      restartUnhealthy:
        "Proces zastępczy nigdy nie osiągnął sprawności, a poprzedni proces pozostał aktywny.",
      default: "Sprawdź logi Gateway, aby poznać przyczynę błędu procesu zastępczego.",
    },
  },
  nodes: {
    pairing: {
  ...
  newSession: {
    ...
    draft: "Wersja robocza",
    draftDescription: "Zachowaj ten wątek dla siebie, dopóki go nie opublikujesz",
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Otwórz wątek i przełącz na widok panelu, aby dodać go tutaj.",
    loadError: "Nie udało się załadować paneli: {error}",
  },
  sessionsView: {
    subagentPrefix: "Podagent:",
    automationPrefix: "Automatyzacja:",
  ...
  agents: {
    ...
    defaults: {
      ...
      description:
        "Domyślne ustawienia dziedziczone przez każdego agenta, o ile nie zostaną nadpisane.",
    },
    copyId: "Copy ID",
    ...
    files: {
      ...
      addFile: "Dodaj plik…",
      createHint: "Ten plik jeszcze nie istnieje. Zapisanie utworzy go w obszarze roboczym agenta.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  configForm: {
    redactedPlaceholder: "[ukryte - kliknij odsłoń, aby wyświetlić]",
    sectionHelp: "Pomoc dla {section}",
    ...
    defaultValue: "Domyślnie: {value}",
    usingDefault: "Używanie domyślnej wartości: {value}",
    resetToDefault: "Przywróć domyślne",
    select: "Wybierz...",
    nullValue: "null",
    jsonValue: "Wartość JSON",
    invalidJson: "Wprowadź prawidłowy JSON przed opuszczeniem tego pola.",
    invalidString: "Wprowadź wartość zgodną z ograniczeniami tego ustawienia.",
    invalidNumber: "Wprowadź wartość w dozwolonym zakresie i kroku.",
    draftRejected: "Nie udało się zapisać tego ustawienia. Twój szkic jest nadal tutaj.",
    ...
    sections: {
      ...
      tts: {
        label: "Głos",
        description: "Odtwarzanie tekstu na mowę, głosy i persony",
      },
      session: {
        label: "Sesja",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardFirstVisited: "Pierwsza wizyta {date}",
      lobsterdexCardShinySeen: "✦ Błyszcząca dostrzeżona {date}",
      lobsterdexCardCopyLink: "Kopiuj link",
      lobsterdexOpen: "Otwórz Lobsterdex",
    },
    security: {
      intro:
        "Przejrzyj dostęp do gateway, zasady narzędzi, uwierzytelnianie urządzeń i zatwierdzenia.",
  ...
  configView: {
    ...
    syncPendingHint: "Oczekiwanie na synchronizację przez gateway.",
    notifications: {
    ...
    appearance: {
      intro: "Ustawienia motywu, czatu i paska bocznego dla tego klienta Control UI.",
      theme: "Motyw",
  ...
  terminal: {
    ...
    uploadTooLarge: "Plik przekracza limit przesyłania terminala 16 MiB: {file}",
    uploadUnsafeCmdPath:
      "Nie można bezpiecznie wstawić przesłanej ścieżki zawierającej % lub ! do cmd.exe",
    uploadUnsupportedShell:
      "Nie można bezpiecznie wstawić przesłanej ścieżki do nieobsługiwanej powłoki: {shell}",
  },
  browser: {
    title: "Przeglądarka",
    ...
    errors: {
      ...
      screenshotPathMissing: "Zrzut ekranu przeglądarki nie zwrócił ścieżki multimediów.",
      screenshotFetchTimedOut: "Upłynął limit czasu pobierania zrzutu ekranu.",
      screenshotFetchFailed: "Pobieranie zrzutu ekranu nie powiodło się ({status}).",
      screenshotReadFailed: "Odczyt zrzutu ekranu nie powiódł się.",
      screenshotDecodeFailed: "Dekodowanie zrzutu ekranu nie powiodło się.",
  ...
  subtitles: {
    ...
    dashboards: "Wątki, które otwierają się w widoku panelu.",
    ...
    lobsterdex: "Każda paleta lobster, która odwiedziła tę przeglądarkę.",
  ...
  modelSetup: {
    ...
    required: {
      ...
      body: "OpenClaw nie mógł znaleźć dostawcy i modelu skonfigurowanego dla tego agenta. Dodaj je przed rozpoczęciem rozmowy.",
      action: "Skonfiguruj dostawcę",
    },
    connectionFailure: {
      title: "OpenClaw nie mógł użyć skonfigurowanej AI",
      body: "Ten agent ma wybranego dostawcę i model, ale połączenie nie powiodło się. Sprawdź logowanie dostawcy lub klucz API, dostęp do modelu oraz status usługi, a następnie spróbuj ponownie.",
    ...
    unavailable: {
      ...
      signIn: "Zaloguj się przez {provider}",
    ...
    prepare: {
      ...
      ollamaButton: "Sprawdź i skonfiguruj",
      ollamaLabel: "Ollama",
      ollamaHint: "Pobierz model obsługujący narzędzia z serwera Ollama",
      llamaCppLabel: "Model lokalny (llama.cpp)",
      providerNotReady:
        "{provider} nie udostępnił użytecznego modelu lokalnego. Sprawdź wynik konfiguracji, a następnie spróbuj ponownie.",
    },
    manual: {
      title: "Połącz za pomocą klucza API lub tokenu",
      provider: "Dostawca",
      selectProvider: "Wybierz dostawcę",
      selectProviderHint: "Wybierz źródło tego poświadczenia",
      accessValue: "Klucz API lub token",
      accessValueFor: "Klucz API lub token {provider}",
      accessValuePlaceholder: "Wklej klucz API lub token",
      connect: "Połącz",
      connectAndVerify: "Połącz i zweryfikuj",
      verifyHint:
        "OpenClaw weryfikuje rzeczywistą odpowiedź modelu przed oznaczeniem połączenia jako gotowego.",
      required: "Wybierz dostawcę i wprowadź klucz API lub token.",
    },
    success: {
      title: "Twoja sztuczna inteligencja jest gotowa",
      body: "OpenClaw otrzymał rzeczywistą odpowiedź od {modelRef}. Możesz już zacząć czatować.",
      activeModel: "Aktywny model",
      latency: "Zweryfikowano w {latencyMs} ms",
      detail: "{modelRef} · {latencyMs} ms",
      openChat: "Otwórz czat",
      continueSetup: "Kontynuuj konfigurację",
      stayHere: "Pozostań w ustawieniach",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "Z poprzednich sesji",
      subtitle:
        "Przygotuj zaufane wspomnienia z wcześniejszych sesji agenta. Śnienie awansuje przydatne z nich do pamięci długoterminowej.",
      dateRange: "Zakres dat sesji",
      dateRangeHint: "Pozostaw jedną z dat pustą, aby przeskanować cały dostępny zakres.",
      from: "Od",
      to: "Do",
      actions: "Uzupełnij",
      preview: "Podgląd",
      ...
      applying: "Stosowanie…",
      rollback: "Wycofaj",
      previewSummary: "{candidates} kandydatów w ciągu {days} dni",
      previewTruncated:
        "Ten podgląd pokazuje pierwszą ograniczoną partię. Zastosowanie kontynuuje przez pozostałych kandydatów.",
      candidateCount: "{count} kandydatów",
      noCandidates: "Nie znaleziono nowych zaufanych kandydatów z sesji.",
      progress: "Przetworzono {days} dni · {staged} przygotowanych",
      processedCandidates: "Przetworzono {count} kandydatów z sesji",
      processedDayCountOne: "Przetworzono {count} dzień",
      processedDayCount: "Przetworzono {count} dni",
      complete: "{count} przygotowanych; awans następuje poprzez śnienie",
      rollbackConfirmTitle: "Wycofać uzupełnianie sesji?",
      rollbackConfirmDescription:
        "Usuń wpisy dziennika i zapisane wspomnienia utworzone przez uzupełnianie sesji dla tego agenta.",
      rollbackWarning:
        "Śledzone kursory sesji pozostają na miejscu, więc usunięte wpisy nie zostaną ponownie zapisane.",
      rollbackComplete: "Uzupełnianie sesji wycofane",
      rollbackCounts: "Usunięto {diary} wpisów dziennika i {staged} wpisów zapisanych",
      unavailable: "Uzupełnianie sesji jest niedostępne na tym Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      title: "OpenClaw",
      toggle: "Zapytaj OpenClaw",
      close: "Zamknij Ask OpenClaw",
      resize: "Zmień rozmiar Ask OpenClaw",
      dockBottom: "Zadokuj Ask OpenClaw na dole",
      dockRight: "Zadokuj Ask OpenClaw po prawej",
    },
    history: {
      button: "Historia",
  ...
  mcpServers: {
    ...
    sessionChanged: "Aktywna sesja zmieniła się, zanim można ją było włączyć.",
  ...
  mcpPage: {
    intro: "Połącz i zarządzaj serwerami MCP, które udostępniają narzędzia dla OpenClaw.",
    ...
    setUpFirstServer: "Skonfiguruj swój pierwszy serwer MCP",
  ...
  talkPage: {
    ...
    voiceSection: {
      ...
      description:
        "Ciągłe rozmowy głosowe z agentem. Poniższe selektory zapisują ustawienia talk.realtime; pełny formularz poniżej obejmuje wszystko inne.",
    },
    status: {
      title: "Status",
      ready: "Gotowe",
      ...
      unavailable: "Niedostępne",
      unavailableHint: "Połącz się z Gateway, aby sprawdzić gotowość głosu w czasie rzeczywistym.",
      activeProvider: "Aktywny dostawca: {provider}",
      noProvider: "Nie skonfigurowano jeszcze żadnego dostawcy głosu w czasie rzeczywistym.",
    },
    provider: {
      title: "Dostawca",
      description:
        "Automatycznie wybiera pierwszego dostawcę z działającymi danymi uwierzytelniającymi.",
      auto: "Automatycznie",
    },
    model: {
      title: "Model",
      description: "Model głosowy działający w czasie rzeczywistym dla sesji Talk w przeglądarce.",
      default: "Domyślny dostawcy",
      defaultNamed: "Domyślny ({model})",
    },
    voice: {
      title: "Głos mówcy",
      description:
        "Głos używany do odpowiedzi mówionych. GPT-Live blokuje głos po rozpoczęciu rozmowy.",
      default: "Domyślny dostawcy",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live działa z subskrypcją ChatGPT: zaloguj się raz poleceniem „openclaw models auth login --provider openai”. Nie jest potrzebny klucz Platform API. Tylko Talk w przeglądarce. Delegowana praca może być sterowana w trakcie działania i wymaga dokładnego potwierdzenia głosowego dla działań o dużym wpływie.",
      ready: "Gotowe",
    },
  },
  memoryPage: {
    intro: "Wybierz, jak OpenClaw przechowuje, przeszukuje i utrzymuje pamięć agenta.",
    ...
    overview: {
      hero: {
        ...
        hibernating: "Pamięć hibernuje",
        needsAttention: "Pamięć wymaga uwagi",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Sprawdzanie silnika pamięci i cyklu snów tego agenta.",
        offDescription: "Wybierz silnik pamięci w Ustawieniach, aby ją wybudzić.",
        disabledDescription:
          "Wybrany silnik pamięci jest wyłączony. Włącz go ponownie w Ustawieniach.",
        gatewayOffline: "Gateway jest offline, więc status pamięci jest niedostępny.",
        hybridSearch: "wyszukiwanie hybrydowe",
        keywordSearch: "wyszukiwanie słów kluczowych (bez osadzeń)",
      ...
      schedule: {
        ...
        lightDescription:
          "Sortuje świeże notatki krótkoterminowe i przygotowuje obiecujących kandydatów bez zmiany pamięci długoterminowej.",
        remDescription:
          "Analizuje motywy i powtarzające się pomysły w niedawnej aktywności, aby wzmocnić ranking bez zmiany pamięci długoterminowej.",
        deepDescription:
          "Ocenia przygotowanych kandydatów, promuje najlepszych do pamięci długoterminowej (MEMORY.md) i zapisuje dziennik snów.",
        nextRun: "następne {time}",
        lastRun: "ostatnie {time}",
        notScheduled: "Niezaplanowane",
        learnMore: "Jak działa śnienie",
        openDocs: "Otwórz przewodnik śnienia",
      },
      activity: {
        title: "Aktywność",
        promotedToday: "Awansowane dzisiaj",
        promotedTotal: "Awansowane łącznie",
        shortTermCount: "Oczekujące wpisy krótkoterminowe",
        phaseHitCount: "Sygnały fazowe",
        lightPhaseHitCount: "Trafienia fazy lekkiej",
        remPhaseHitCount: "Trafienia fazy REM",
      },
      health: {
        title: "Kondycja silnika",
        provider: "Dostawca",
        embeddings: "Osadzenia",
        runtime: "Środowisko wykonawcze osadzeń",
        healthy: "Gotowe",
        unavailable: "Niedostępne",
    ...
    memories: {
      ...
      searchButton: "Szukaj",
      idle: "Wyszukaj osobę, projekt, decyzję lub cokolwiek innego, co ten agent pamięta.",
      searching: "Przeszukiwanie wspomnień…",
      results: "{count} wyników",
      empty: "Żadne wspomnienie nie pasuje do „{query}”.",
      error: "Wyszukiwanie wspomnień nie powiodło się: {message}",
      retry: "Ponów",
      gatewayUpdateRequired: "Zaktualizuj Gateway, aby przeszukiwać wspomnienia z Control UI.",
      hybridSearch: "wyszukiwanie hybrydowe",
      ...
      fileLoading: "Wczytywanie całego pliku pamięci…",
      fileError: "Nie można wczytać tego pliku pamięci: {message}",
      fileUnsupported: "Tego pliku pamięci nie można wyświetlić jako tekst.",
    },
    engine: {
      title: "Silnik",
      description:
      ...
      offHint: "Pamięć jest wyłączona w konfiguracji: plugins.slots.memory jest ustawione na none.",
      ...
      disabledHint:
        "Slot pamięci wskazuje na ten plugin, ale sam plugin jest wyłączony, więc pamięć nie działa.",
      enable: "Włącz",
    },
    backend: {
      title: "Backend",
      description: "Sposób przechowywania i pobierania pamięci dla wybranego silnika.",
      rowTitle: "Backend pobierania",
      builtin: "Wbudowany",
      qmd: "QMD",
      invalid: "Nieprawidłowa skonfigurowana wartość",
      builtinHint: "Pliki pamięci są indeksowane i przeszukiwane przez samego OpenClaw.",
      qmdHint: "Pobieranie jest delegowane do QMD. Jego ustawienia pojawiają się poniżej.",
      invalidHint:
        "Skonfigurowana wartość memory.backend jest nieprawidłowa. Wybierz backend lub zresetuj ją, aby użyć domyślnej.",
    },
    addons: {
      title: "Dodatki",
      description:
        "Te pluginy działają jako warstwa nad silnikiem, zamiast konkurować o slot, więc dowolna kombinacja może działać jednocześnie.",
      activeMemory: {
      ...
      changeFailed: "Nie można zaktualizować {plugin}",
    ...
    search: {
      intro:
        "Domyślne ustawienia osadzania i pobierania współdzielone przez każdego agenta, który nie ma nadpisania pamięci.",
    },
    dreaming: {
      intro:
        "Dreaming działa jako jedno zarządzane zadanie cron we wszystkich obszarach roboczych agentów, więc te ustawienia są globalne. Są własnością wtyczki {plugin}.",
      schedule: {
        title: "Harmonogram",
        description: "Kiedy uruchamia się pełne przetwarzanie i który model je opisuje.",
      },
      frequency: {
        label: "Częstotliwość dreaming",
        help: "Harmonogram cron dla pełnego przetwarzania dreaming (light, REM, następnie deep). Pozostaw puste, aby użyć domyślnych wartości wtyczki.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        ...
        default: "Lokalna strefa czasowa Gateway",
      },
      model: {
        label: "Model dreaming",
        help: "Nadpisanie dostawcy/modelu dla narracji dziennika snów. Wymaga zezwolenia na nadpisania modelu subagenta.",
        placeholder: "anthropic/claude-sonnet-4-6",
        default: "Model agenta",
      },
      verboseLogging: {
        label: "Szczegółowe logowanie",
        help: "Loguj szczegółowo każdą fazę dreaming. Przydatne przy dostrajaniu progów.",
      },
      storage: {
        title: "Przechowywanie",
        description: "Gdzie zapisywane są przeniesione wspomnienia i raporty dreaming.",
        modeLabel: "Tryb przechowywania",
        modeHelp: "Inline zapisuje do pliku pamięci; separate przechowuje dedykowany plik raportu.",
        modes: {
          inline: "Inline",
          separate: "Oddzielnie",
          both: "Oba",
        ...
        separateReportsHelp: "Trzymaj raporty ze śnienia poza głównym plikiem pamięci.",
      },
      phases: {
        light: {
          title: "Faza lekka",
          description:
            "Tani przegląd ostatniej aktywności, który przygotowuje kandydatów do odtworzenia.",
        },
        deep: {
          title: "Faza głęboka",
          description:
            "Punktowany przegląd promujący, który przenosi wpisy krótkoterminowe do pamięci.",
        },
        rem: {
          title: "Faza REM",
          description:
            "Przegląd wzorców szukający powtarzających się motywów w oknie retrospekcji.",
        },
      },
      phaseFields: {
        enabled: "Włączone",
        enabledHelp: "Uruchamiaj tę fazę podczas przeglądu.",
        lookbackDays: "Dni retrospekcji",
        lookbackDaysHelp:
          "Jak daleko wstecz sięga ta faza. Pozostaw puste, aby użyć domyślnej wartości wtyczki.",
        limit: "Limit",
        limitHelp: "Maksymalna liczba wpisów przetwarzanych przez tę fazę na jedno uruchomienie.",
        dedupeSimilarity: "Podobieństwo deduplikacji",
        dedupeSimilarityHelp:
          "Podobieństwo, powyżej którego dwóch kandydatów jest traktowanych jako duplikaty.",
        minScore: "Minimalny wynik",
        minScoreHelp: "Wynik promocji, który musi osiągnąć wpis.",
        minRecallCount: "Minimalna liczba przywołań",
        minRecallCountHelp:
          "Jak często wpis musi zostać przywołany, zanim będzie mógł zostać awansowany.",
        minUniqueQueries: "Minimalna liczba unikalnych zapytań",
        minUniqueQueriesHelp: "Ile odrębnych zapytań musiało wywołać wpis.",
        recencyHalfLifeDays: "Okres półtrwania świeżości (dni)",
        recencyHalfLifeDaysHelp: "Jak szybko starsze sygnały przywołania tracą na wadze.",
        maxAgeDays: "Maksymalny wiek (dni)",
        maxAgeDaysHelp: "Ignoruj wpisy krótkoterminowe starsze niż to.",
        maxPromotedSnippetTokens: "Maks. tokenów awansowanego fragmentu",
      ...
      agentScope: {
        title: "Widok agenta",
        description:
          "Powyższe ustawienia są globalne. Dziennik snów, liczniki krótkoterminowe i działania konserwacyjne poniżej należą do jednego agenta.",
        rowTitle: "Agent",
      },
      unsupported: {
        title: "Ustawienia snów",
        rowTitle: "Niedostępne dla tego silnika",
        description:
          "Wtyczka {plugin} zajmuje slot pamięci, a jej schemat konfiguracji nie ma sekcji snów, więc tych ustawień nie można zapisać. Zmień silnik na karcie Przegląd, aby je edytować.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    localModelLean: {
      ...
      description:
        "Usuń ciężkie domyślne narzędzia, z którymi mniejsze modele lokalne słabo sobie radzą, pozostawiając krótszy zestaw, którego mogą używać niezawodnie.",
    },
    auditMessages: {
      title: "Metadane audytu wiadomości",
      description:
        "Zapisuj w rejestrze audytu metadane bezpośrednich rozmów pozbawione treści. Treść wiadomości nigdy nie jest przechowywana.",
    },
  },
  aboutPage: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Wyświetl aktywność, koszty i trendy użycia.",
    identity: {
      title: "Tożsamość",
  ...
  skillWorkshop: {
    ...
    notices: {
      applied: "Zastosowane",
      rejected: "Odrzucone",
      revisionRequested: "Poproszono o poprawkę",
    },
    revision: {
    ...
    evaluation: {
      ...
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "Nie można zidentyfikować bieżącej wersji propozycji.",
        revisionChanged: "Wersja propozycji zmieniła się podczas ewaluacji.",
      },
    },
    empty: {
    ...
    today: {
      ...
      evaluate: "Oceń",
      runChecks: "Uruchom sprawdzanie propozycji",
      tweakIt: "Dostosuj",
  ...
  dreaming: {
    ...
    header: {
      ...
      engineOff:
        "Silnik pamięci jest wyłączony. Wybierz silnik w Ustawieniach, aby włączyć śnienie.",
    },
    toggleConfirmation: {
      subtitle: "Dreaming to ustawienie globalne; nie dotyczy tylko tego agenta.",
      enableTitle: "Włącz Dreaming dla wszystkich agentów",
      enableDetail:
        "Nocne przeczesywanie w trybie dreaming będzie działać w każdej skonfigurowanej przestrzeni roboczej agenta, przenosząc krótkoterminowe wspomnienia do pamięci długoterminowej. Zmiana obowiązuje od razu.",
      enableConfirm: "Włącz Dreaming",
      disableTitle: "Wyłącz Dreaming dla wszystkich agentów",
      disableDetail:
        "Nocne przeczesywanie w trybie dreaming zostanie zatrzymane dla każdego skonfigurowanego agenta, nie tylko tego. Zapisane już wspomnienia pozostają; nic nowego nie zostanie przeniesione. Zmiana obowiązuje od razu.",
      disableConfirm: "Wyłącz Dreaming",
      saving: "Zapisywanie…",
    ...
    actions: {
      ...
      dedupeRemovedManyAndKept: "Usunięto {removed} zduplikowanych wpisów snu i zachowano {kept}.",
      dedupeRemovedOne: "Usunięto {removed} zduplikowany wpis snu.",
      dedupeRemovedMany: "Usunięto {removed} zduplikowanych wpisów snu.",
      repairArchivedThreadCorpus: "zarchiwizowany korpus wątków",
      repairArchivedIngestionState: "zarchiwizowany stan pozyskiwania",
      repairArchivedDreamDiary: "zarchiwizowany dziennik snów",
      repairNoChanges: "Naprawa pamięci podręcznej snów zakończona bez zmian.",
      ...
      backfillComplete: "Uzupełniono {count} wpisów dziennika snów.",
      resetDiaryComplete: "Usunięto {count} uzupełnionych wpisów dziennika snów.",
      clearReplayedComplete: "Wyczyszczono {count} odtworzonych wpisów krótkoterminowych.",
      complete: "Akcja dziennika snów zakończona.",
      confirmRepair:
        "Naprawić pamięć podręczną snów? Spowoduje to zarchiwizowanie pochodnych plików pamięci podręcznej snów i odbudowanie ich z czystych danych wejściowych. Twój dziennik snów pozostanie nietknięty.",
      confirmDedupe:
        "Usunąć duplikaty z dziennika snów? Spowoduje to przepisanie pliku DREAMS.md i usunięcie tylko dokładnych duplikatów wpisów dziennika.",
      archivePathCopied: "Skopiowano ścieżkę archiwum.",
      archivePathCopyFailed: "Nie można skopiować ścieżki archiwum.",
      updateFailed: "Nie można zaktualizować ustawień śnienia.",
      unsupportedPlugin: "Wybrana wtyczka pamięci „{pluginId}” nie obsługuje ustawień śnienia.",
    ...
    wiki: {
      ...
      emptyWiki: "Wiki pamięci nie jest jeszcze wypełniona",
      emptyWikiHint:
      ...
      counts: {
        ...
        userMessages: "{count} użytkownik",
        assistantMessages: "{count} asystent",
      },
      ...
      previewTruncated: "Wyświetlanie pierwszego fragmentu tej strony.",
      previewTruncatedWithTotal:
        "Wyświetlanie pierwszego fragmentu tej strony (łącznie {count} wierszy).",
      importedClusterSummary: "Zaimportowane czaty zgrupowane wokół {label}.",
      withheldDigestOne: "{count} podsumowanie zostało wstrzymane do przeglądu.",
      withheldDigests: "{count} podsumowań zostało wstrzymanych do przeglądu.",
      details: "Szczegóły",
      hideDetails: "Ukryj szczegóły",
      vault: "Skarbiec",
      fullVaultBreakdown: "Pełny podział skarbca: {breakdown}.",
      selectedSection: "Wybrana sekcja: {summary}.",
      latestUpdate: "Ostatnia aktualizacja {date}.",
      noContent: "Brak dostępnej treści wiki.",
    },
    phrases: {
      ...
      defragmentingMemoryLane: "defragmentacja ścieżki pamięci…",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      heading: "Połącz zweryfikowany model AI",
      signedInNoModels:
        "Jesteś zalogowany, ale to konto nie udostępnia żadnych użytecznych modeli. Wybierz innego dostawcę lub konto, aby kontynuować.",
  ...
  usage: {
    ...
    heatmap: {
      title: "Aktywność tokenów",
      subtitle: "Dzienna intensywność tokenów dla wybranego zakresu, do jednego roku.",
      cellTokens: "{tokens} tokenów",
      less: "Mniej",
      more: "Więcej",
    },
    providerUsage: {
  ...
  chat: {
    ...
    commandResults: {
      ...
      stoppingCurrentRun: "Zatrzymywanie bieżącego uruchomienia...",
      chatHistoryCleared: "Historia czatu wyczyszczona.",
      ...
      compaction: {
        ...
        succeeded: "Kontekst pomyślnie skompaktowany",
        skipped: "Kompaktowanie pominięte.",
        skippedWithReason: "Kompaktowanie pominięte: {reason}",
      },
      model: {
      ...
      thinking: {
        current: "Bieżący poziom myślenia: {level}.",
        getFailed: "Nie udało się pobrać poziomu myślenia: {error}",
        reset: "Zresetowano poziom myślenia do domyślnego.",
        resetFailed: "Nie udało się zresetować poziomu myślenia: {error}",
        unrecognized: "Nierozpoznany poziom myślenia „{level}”. Prawidłowe poziomy: {options}.",
        unsupported:
          "Nieobsługiwany poziom myślenia „{level}” dla tego modelu. Prawidłowe poziomy: {options}.",
        set: "Ustawiono poziom myślenia na {level}.",
        setFailed: "Nie udało się ustawić poziomu myślenia: {error}",
      },
      verbose: {
        ...
        set: "Ustawiono tryb szczegółowy na {level}.",
      ...
      fast: {
        ...
        sourceDefault: " (domyślne)",
        current: "Bieżący tryb szybki: {value}",
        options: "on, off, auto ({seconds} sek), default, status",
        getFailed: "Nie udało się pobrać trybu szybkiego: {error}",
        reset: "Tryb szybki przywrócono do domyślnego.",
      ...
      usage: {
        ...
        model: "Model: {model}",
        failed: "Nie udało się pobrać użycia: {error}",
      },
      agents: {
        none: "Nie skonfigurowano agentów.",
        title: "**Agenci** ({count})",
        default: "domyślne",
        runtime: " · środowisko wykonawcze {runtime}",
        failed: "Nie udało się wyświetlić agentów: {error}",
      },
      steer: {
        timeout: "Aktywne uruchomienie zakończyło się przed zaakceptowaniem wiadomości sterującej.",
        failed: "Sterowanie nie powiodło się przed dotarciem do uruchomienia; spróbuj ponownie.",
        usage: "Użycie: `/steer <message>`",
        noActiveRun: "Brak aktywnego uruchomienia. Użyj pola czatu lub `/redirect`.",
        succeeded: "Skierowano.",
        requestFailed: "Nie udało się sterować: {error}",
      },
      redirect: {
        timeout:
          "Aktywne uruchomienie zakończyło się przed zaakceptowaniem wiadomości przekierowującej.",
        failed:
          "Przekierowanie nie powiodło się przed dotarciem do uruchomienia; spróbuj ponownie.",
    ...
    sessionHeader: {
      ...
      gatewayPicker: {
        ...
        primaryTag: "podstawowy",
        setPrimary: "Ustaw jako podstawowy…",
        openSettings: "Ustawienia Gateway…",
        connected: "Połączono",
    ...
    markdown: {
      truncated: "… skrócono ({total} znaków, pokazano pierwsze {shown}).",
    },
    codeBlock: {
      jsonLines: "JSON · {count} wierszy",
    },
    workspaceConflict: {
    ...
    queue: {
      ...
      states: {
        ...
        waitingForRun: "Oczekiwanie na bieżące uruchomienie",
    ...
    questions: {
      ...
      expired: "Wygasł",
      cancelled: "Anulowano",
      disconnected: "Brak połączenia. Spróbuj ponownie po ponownym połączeniu.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      message: "wiadomość",
      currentMessage: "bieżąca wiadomość",
      actions: "Akcje wiadomości",
      selectionActions: "Akcje zaznaczenia",
      moreDetails: "Więcej szczegółów",
      askInSideChat: "Zapytaj w czacie bocznym",
      rewind: "Cofnij",
      ...
      duplicatesCollapsed: "Zwinięto {count} kolejnych identycznych wiadomości",
    ...
    modelControls: {
      ...
      fastHelp: "Szybkie odpowiedzi kończą się wcześniej i mogą zużywać więcej limitów.",
      speedUnsupported: "Kontrola szybkości nie jest obsługiwana dla tego modelu.",
      contextWindow: "Kontekst: {count}",
      chatOnly: "Tylko czat",
      chatOnlyHelp:
        "Ten model może prowadzić czat, ale nie może korzystać z narzędzi. Wybierz inny model do zadań związanych z plikami, poleceniami, siecią lub multimediami.",
      providerModels: "Modele {provider}",
      resetReasoning: "Przywróć domyślne ({level})",
      useDefaultReasoning: "Użyj domyślnego rozumowania ({level})",
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "Pełna treść jest niedostępna, ponieważ zapisany wpis transkrypcji jest zbyt duży, aby bezpiecznie go zwrócić.",
      fullContentNotVisible:
        "Pełna treść jest niedostępna, ponieważ ten wpis transkrypcji nie ma widocznej projekcji WebChat.",
      fullContentUnavailable: "Pełna treść nie jest już dostępna dla tego wpisu transkrypcji.",
      copyContents: "Kopiuj zawartość pliku",
      fileChanged: "Plik został zmieniony na dysku od czasu jego wczytania.",
      renderPreview: "Renderuj podgląd",
      imagePreview: "Podgląd obrazu",
      file: "Plik",
      markdownPreview: "Podgląd Markdown",
      toolDetails: "Szczegóły narzędzia",
      reloadFailed: "Nie udało się ponownie wczytać najnowszego pliku.",
      overwriteLoadFailed: "Nie udało się wczytać najnowszego pliku przed nadpisaniem.",
    ...
    sidebarColumns: {
      ...
      dropOnEmptyLeft: "Przenieś {panel} na pusty lewy pasek boczny",
    ...
    composer: {
      ...
      fallbackActive: "Aktywny fallback: {model}",
      fallbackCleared: "Fallback wyczyszczony: {model}",
      fallbackSelected: "Wybrano: {model}",
      fallbackCurrent: "Aktywny: {model}",
      fallbackPrevious: "Poprzedni fallback: {model}",
      fallbackReason: "Powód: {reason}",
      fallbackAttempts: "Próby: {attempts}",
      cancelReply: "Anuluj odpowiedź",
      attachmentPreview: "Podgląd załącznika",
      ...
      menu: {
        ...
        savingBlocked: "Poczekaj na zakończenie bieżącej zmiany możliwości sesji.",
      },
      overrides: {
  ...
  cron: {
    adminRequired: "Tylko przeglądanie. Zmiany automatyzacji wymagają dostępu operator.admin.",
    tabs: {
