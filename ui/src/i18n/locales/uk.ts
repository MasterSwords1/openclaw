...
export const uk: TranslationMap = {
  common: {
    ...
    resizeSplitView: "Змінити розмір розділеного вигляду",
    delete: "Видалити",
    remove: "Видалити",
    dismiss: "Закрити",
  ...
  mcpApp: {
    ...
    errors: {
      gatewayUnavailable: "Gateway додатка MCP недоступний",
      mountUnavailable: "Монтування додатка MCP недоступне",
      sandboxTimedOut: "Час очікування пісочниці додатка MCP вичерпано",
      sandboxUnavailable: "Пісочниця додатка MCP недоступна",
      initializationTimedOut: "Час очікування ініціалізації додатка MCP вичерпано",
      requestFailed: "Запит не вдався",
      invalidSandboxUrl: "URL пісочниці додатка MCP недійсний",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "Час очікування запиту вичерпано за 30 секунд; сервер міг усе ж застосувати зміну — перевірте профіль перед повторною спробою.",
        operationFailed: "{prefix}: {error}",
        updateFailed: "Не вдалося оновити профіль",
        updateFailedStatus: "Не вдалося оновити профіль ({status})",
        publishFailed: "Не вдалося опублікувати профіль на жодному з реле.",
        published: "Профіль опубліковано на реле.",
        importFailed: "Не вдалося імпортувати профіль",
        importFailedStatus: "Не вдалося імпортувати профіль ({status})",
        importedFromRelays: "Профіль імпортовано з реле. Перегляньте та опублікуйте.",
        imported: "Профіль імпортовано. Перегляньте та опублікуйте.",
      },
    },
  },
  lazyView: {
  ...
  updates: {
    refreshRequired: "Сервер оновлено — оновіть сторінку для повного функціоналу",
    coalescedRestart:
      "Оновлення встановлено. Перезапуск gateway вже виконується; статус оновиться після повторного підключення.",
    ...
    failureReasons: {
      ...
      buildDirty:
        "Вибрана ревізія змінила файли checkout під час збірки. Повторіть із ревізією, яка містить свої згенеровані артефакти.",
      uiBuildFailed:
        "Не вдалося перезібрати Control UI. Виправте помилку збірки UI та повторіть спробу.",
      globalInstallFailed:
        "Глобальне встановлення пакета не пройшло перевірку на диску. Повторіть спробу або перевстановіть через CLI.",
      restartDisabled:
      ...
      restartUnavailable:
        "Це глобальне встановлення не можна безпечно замінити, поки перезапуски вимкнено та відсутній супервізор.",
      restartUnhealthy:
        "Замінний процес так і не став справним. Попередній процес залишився активним, щоб ви могли відновитися.",
      managedServiceHandoffAlreadyRunning:
        "Інше кероване оновлення вже виконується. Дочекайтеся його завершення, а потім оновіть статус оновлення.",
      doctorFailed:
        "Відновлення Doctor не вдалося. Виконайте `openclaw doctor --non-interactive` і повторіть спробу.",
      default:
        "Перегляньте журнали gateway, щоб з’ясувати точну причину збою, і повторіть спробу після усунення проблеми.",
    },
    postRestart: {
      restartUnhealthy:
        "Замінний процес так і не став справним, а попередній процес залишився активним.",
      default: "Перевірте журнали gateway щодо збою заміни.",
    },
  },
  nodes: {
    pairing: {
  ...
  configForm: {
    ...
    sectionHelp: "Довідка для {section}",
    ...
    invalidJson: "Введіть коректний JSON, перш ніж покинути це поле.",
    invalidString: "Введіть значення, що відповідає обмеженням цього налаштування.",
    invalidNumber: "Введіть значення в межах дозволеного діапазону та кроку.",
    draftRejected: "Це налаштування не вдалося зберегти. Ваш чернетковий запис збережено.",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Блискучий помічено {date}",
      lobsterdexCardCopyLink: "Копіювати посилання",
      lobsterdexOpen: "Відкрити Lobsterdex",
    },
    security: {
      intro:
        "Перегляньте доступ до gateway, політику інструментів, автентифікацію пристроїв і затвердження.",
      title: "Безпека",
  ...
  configView: {
    ...
    syncPendingHint: "Очікування синхронізації через gateway.",
    notifications: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Необов’язкова CSS-ширина для центрованого транскрипту, наприклад 960px, 82% або min(1280px, 82%).",
      messageWidthInvalid:
    ...
    formUnsafeCount: "1 налаштування в цій конфігурації можна редагувати лише як текст: {paths}",
    formUnsafeCountPlural:
      "{count} налаштувань у цій конфігурації можна редагувати лише як текст: {paths}",
    formUnsafeMore: "+ще {count}",
    openRawEditor: "Відкрити редактор Raw",
  ...
  terminal: {
    ...
    uploadTooLarge: "Файл перевищує ліміт завантаження терміналу 16 MiB: {file}",
    uploadUnsafeCmdPath:
      "Неможливо безпечно вставити завантажений шлях, що містить % або !, у cmd.exe",
    uploadUnsupportedShell:
      "Неможливо безпечно вставити завантажений шлях у непідтримувану оболонку: {shell}",
  },
  browser: {
    title: "Браузер",
    ...
    errors: {
      ...
      screenshotPathMissing: "Знімок екрана браузера не повернув шлях до медіа.",
      screenshotFetchTimedOut: "Час очікування отримання знімка екрана вичерпано.",
  ...
  subtitles: {
    ...
    talk: "Голос у реальному часі: провайдер, модель і голос диктора.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaButton: "Перевірити та налаштувати",
      ollamaLabel: "Ollama",
      ollamaHint: "Завантажте модель із підтримкою інструментів із вашого сервера Ollama",
      llamaCppLabel: "Локальна модель (llama.cpp)",
      providerNotReady:
        "{provider} не надав придатної локальної моделі. Перегляньте результат налаштування, потім повторіть спробу.",
    },
    manual: {
      title: "Підключення за допомогою ключа API або токена",
      provider: "Постачальник",
      selectProvider: "Виберіть постачальника",
      selectProviderHint: "Виберіть, звідки надходить ця облікова інформація",
      accessValue: "Ключ API або токен",
      accessValueFor: "API-ключ або токен {provider}",
      accessValuePlaceholder: "Вставте ключ API або токен",
      connect: "Підключити",
      connectAndVerify: "Підключити та перевірити",
      verifyHint:
        "OpenClaw перевіряє справжню відповідь моделі, перш ніж позначити з'єднання готовим.",
      required: "Виберіть постачальника та введіть ключ API або токен.",
    },
    success: {
      title: "Ваш ШІ готовий",
      body: "OpenClaw отримав справжню відповідь від {modelRef}. Тепер ви можете почати спілкування.",
    ...
    wizard: {
      ...
      prepareDialogLabel: "Налаштування локальної моделі",
      title: "Увійти через постачальника",
      prepareTitle: "Налаштуйте локальну модель",
      starting: "Починається вхід через постачальника…",
      prepareStarting: "Запуск налаштування локальної моделі…",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "З минулих сеансів",
      subtitle:
        "Підготуйте надійні спогади з попередніх сеансів агента. Сновидіння переносить корисні з них у довготривалу пам’ять.",
      dateRange: "Діапазон дат сеансів",
      dateRangeHint: "Залиште будь-яку дату порожньою, щоб просканувати весь доступний діапазон.",
      from: "Від",
      to: "До",
      actions: "Зворотне заповнення",
      preview: "Попередній перегляд",
      previewing: "Попередній перегляд…",
      apply: "Застосувати",
      applying: "Застосування…",
      rollback: "Відкотити",
      previewSummary: "{candidates} кандидатів за {days} днів",
      previewTruncated:
        "Цей попередній перегляд показує перший обмежений пакет. Застосування продовжиться для решти кандидатів.",
      candidateCount: "{count} кандидатів",
      noCandidates: "Нових надійних кандидатів із сеансів не знайдено.",
      progress: "Оброблено {days} днів · {staged} підготовлено",
      processedCandidates: "Оброблено {count} кандидатів із сеансів",
      processedDayCountOne: "Оброблено {count} день",
      processedDayCount: "Оброблено {count} днів",
      complete: "{count} підготовлено; просування відбувається через сновидіння",
      rollbackConfirmTitle: "Скасувати заповнення сесії?",
      rollbackConfirmDescription:
        "Видалити записи щоденника та підготовлені спогади, створені під час заповнення сесії для цього агента.",
      rollbackWarning:
        "Відстежувані курсори сесій залишаються на місці, тому видалені записи не будуть підготовлені знову.",
      rollbackComplete: "Заповнення сесії скасовано",
      rollbackCounts: "Видалено {diary} записів щоденника та {staged} підготовлених записів",
      unavailable: "Заповнення сесії недоступне на цьому Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "Веб-застосунок уже працює. Додавайте канал лише тоді, коли хочете писати OpenClaw з іншого сервісу.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Сервер збережено як глобально вимкнений, але увімкнути його для цієї сесії не вдалося: {error}",
  ...
  talkPage: {
    intro: "Налаштуйте провайдерів голосу в реальному часі, моделі та голоси мовців.",
    voiceSection: {
      title: "Голос у реальному часі",
      description:
        "Безперервні голосові розмови з вашим агентом. Селектори нижче записують налаштування talk.realtime; повна форма нижче охоплює все інше.",
    },
    status: {
      title: "Статус",
      ready: "Готово",
      ...
      unavailable: "Недоступно",
      unavailableHint:
        "Підключіться до Gateway, щоб перевірити готовність голосу в реальному часі.",
      activeProvider: "Активний провайдер: {provider}",
      noProvider: "Провайдер голосу в реальному часі ще не налаштовано.",
    },
    provider: {
      title: "Постачальник",
      description: "Auto обирає першого провайдера з робочими обліковими даними.",
      auto: "Автоматично",
    },
    model: {
      title: "Модель",
      description: "Модель голосу в реальному часі для сесій Talk у браузері.",
      default: "Стандартний постачальника",
      defaultNamed: "Стандартна ({model})",
    },
    voice: {
      title: "Голос диктора",
      description: "Голос для озвучення відповідей. GPT-Live фіксує голос після початку виклику.",
      default: "Стандартний постачальника",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live працює з підпискою ChatGPT: увійдіть один раз за допомогою «openclaw models auth login --provider openai». Ключ Platform API не потрібен. Тільки Browser Talk. Делегованою роботою можна керувати під час виконання, а для дій із високим впливом потрібне точне усне підтвердження.",
      ready: "Готово",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        waking: "Пробудження пам'яті…",
        hibernating: "Пам'ять у режимі сну",
        needsAttention: "Пам'ять потребує уваги",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Перевірка рушія пам'яті цього агента та циклу сновидінь.",
        offDescription: "Виберіть рушій пам'яті в Налаштуваннях, щоб пробудити її.",
        disabledDescription:
          "Вибраний рушій пам'яті вимкнено. Увімкніть його знову в Налаштуваннях.",
        gatewayOffline: "Gateway офлайн, тому статус пам'яті недоступний.",
        hybridSearch: "гібридний пошук",
        keywordSearch: "пошук за ключовими словами (без embeddings)",
      ...
      schedule: {
        title: "Розклад сну",
        lightDescription:
          "Сортує свіжі короткочасні нотатки та готує перспективних кандидатів, не змінюючи довготривалу памʼять.",
        remDescription:
          "Аналізує теми та повторювані ідеї в нещодавній активності, щоб посилити ранжування, не змінюючи довготривалу памʼять.",
        deepDescription:
          "Оцінює підготовлених кандидатів, переносить найкращих у довготривалу памʼять (MEMORY.md) і записує щоденник снів.",
        nextRun: "наступний {time}",
        lastRun: "останній {time}",
        notScheduled: "Не заплановано",
        learnMore: "Як працює сновидіння",
        openDocs: "Відкрити посібник зі сновидінь",
      },
      activity: {
        title: "Активність",
        promotedToday: "Перенесено сьогодні",
        promotedTotal: "Перенесено всього",
        shortTermCount: "Очікують короткочасні записи",
        phaseHitCount: "Сигнали фаз",
        lightPhaseHitCount: "Спрацювання легкої фази",
        remPhaseHitCount: "Спрацювання REM-фази",
      },
      health: {
        title: "Стан рушія",
        provider: "Постачальник",
        embeddings: "Ембединги",
        runtime: "Середовище ембедингів",
        healthy: "Готово",
        unavailable: "Недоступно",
      ...
      shortcuts: {
        title: "Дослідити памʼять",
        memories: "Пошук спогадів",
        diary: "Читати щоденник снів",
        settings: "Налаштувати памʼять",
      },
    },
    memories: {
      searchLabel: "Пошук спогадів",
      searchPlaceholder: "Шукати серед спогадів цього агента",
      searchButton: "Пошук",
      idle: "Знайдіть людину, проєкт, рішення чи будь-що інше, що памʼятає цей агент.",
      searching: "Пошук спогадів…",
      results: "{count} результатів",
      empty: "Жоден спогад не відповідає «{query}».",
      error: "Помилка пошуку спогадів: {message}",
      retry: "Повторити",
      gatewayUpdateRequired: "Оновіть gateway, щоб шукати спогади з Control UI.",
      hybridSearch: "гібридний пошук",
      ...
      fileUnsupported: "Цей файл пам'яті не можна показати як текст.",
    },
    engine: {
      title: "Рушій",
      description:
    ...
    backend: {
      ...
      builtin: "Вбудований",
      qmd: "QMD",
      invalid: "Недійсне налаштоване значення",
      ...
      invalidHint:
        "Налаштоване значення memory.backend недійсне. Виберіть бекенд або скиньте його, щоб використовувати типове.",
    },
    addons: {
      title: "Додатки",
      description:
    ...
    dreaming: {
      ...
      timezone: {
        ...
        default: "Локальний часовий пояс Gateway",
      },
      model: {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Увімкніть захист на основі рухомої історії, який попереджає або блокує повторні виклики інструментів, коли агент перестає прогресувати.",
    },
    localModelLean: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Перегляд активності, витрат і тенденцій використання.",
    identity: {
      title: "Ідентичність",
  ...
  skillWorkshop: {
    ...
    notices: {
      applied: "Застосовано",
      rejected: "Відхилено",
      revisionRequested: "Запит на перегляд надіслано",
    },
    revision: {
    ...
    evaluation: {
      ...
      evaluatorVersion: "Оцінювач {version}",
      mode: "Режим {mode}",
      findings: "Виявлення",
      metrics: "Метрики",
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "Не вдалося визначити поточну ревізію пропозиції.",
        revisionChanged: "Ревізія пропозиції змінилася під час оцінювання.",
      },
    },
    empty: {
  ...
  dreaming: {
    ...
    header: {
      ...
      engineOff:
        "Рушій пам'яті вимкнено. Виберіть рушій у Налаштуваннях, щоб увімкнути сновидіння.",
    },
    toggleConfirmation: {
    ...
    actions: {
      dedupeRemovedOneAndKept: "Видалено {removed} дубльований запис сну, збережено {kept}.",
      dedupeRemovedManyAndKept: "Видалено {removed} дубльованих записів снів, збережено {kept}.",
      dedupeRemovedOne: "Видалено {removed} дубльований запис сну.",
      dedupeRemovedMany: "Видалено {removed} дубльованих записів снів.",
      repairArchivedThreadCorpus: "архівований корпус потоків",
      repairArchivedIngestionState: "архівований стан завантаження",
      repairArchivedDreamDiary: "архівований щоденник снів",
      repairNoChanges: "Відновлення кешу снів завершено без змін.",
      repairCompleteWithArchive: "Відновлення кешу снів завершено: {actions}. Архів: {archiveDir}",
      repairComplete: "Відновлення кешу снів завершено: {actions}.",
      backfillComplete: "Заповнено {count} записів щоденника снів.",
      resetDiaryComplete: "Видалено {count} заповнених записів щоденника снів.",
      clearReplayedComplete: "Очищено {count} відтворених короткострокових записів.",
      complete: "Дію зі щоденником снів завершено.",
      confirmRepair:
        "Відновити кеш снів? Це архівує похідні файли кешу снів і перебудовує їх із чистих вхідних даних. Ваш щоденник снів залишиться незмінним.",
      confirmDedupe:
        "Видалити дублікати зі щоденника снів? Це перезапише DREAMS.md і видалить лише точні дублікати записів щоденника.",
      archivePathCopied: "Шлях до архіву скопійовано.",
      archivePathCopyFailed: "Не вдалося скопіювати шлях до архіву.",
      updateFailed: "Не вдалося оновити налаштування снів.",
      unsupportedPlugin: "Обраний плагін пам’яті «{pluginId}» не підтримує налаштування снів.",
      configHashMissing: "Відсутній хеш конфігурації; оновіть і повторіть спробу.",
    },
    wiki: {
      ...
      counts: {
        ...
        openQuestionOne: "{count} відкрите питання",
        openQuestions: "{count} відкритих питань",
      ...
      pageNotFound: "Сторінку wiki для {lookup} не знайдено.",
      previewTruncated: "Показано перший фрагмент цієї сторінки.",
      previewTruncatedWithTotal: "Показано перший фрагмент цієї сторінки (усього {count} рядків).",
      importedClusterSummary: "Імпортовані чати згруповані навколо {label}.",
      withheldDigestOne: "{count} дайджест затримано до перевірки.",
      withheldDigests: "{count} дайджестів затримано до перевірки.",
      details: "Деталі",
      hideDetails: "Сховати деталі",
      vault: "Сховище",
      fullVaultBreakdown: "Повна розбивка сховища: {breakdown}.",
      selectedSection: "Вибраний розділ: {summary}.",
      latestUpdate: "Останнє оновлення {date}.",
      noContent: "Вміст wiki недоступний.",
    },
    phrases: {
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      heading: "Підключіть перевірену модель AI",
      signedInNoModels:
        "Ви ввійшли, але цей обліковий запис не надає доступних моделей. Оберіть іншого постачальника або обліковий запис, щоб продовжити.",
      notConfigured: "Оберіть постачальника та перевірте модель, яку використовуватиме OpenClaw.",
      noModels: "Немає доступних моделей",
      modelRequired: "Потрібна модель",
      chooseProvider: "Оберіть іншого постачальника",
    },
    logout: {
      action: "Вийти",
  ...
  usage: {
    ...
    heatmap: {
      title: "Активність токенів",
      subtitle: "Щоденна інтенсивність токенів для вибраного діапазону, до одного року.",
      cellTokens: "{tokens} токенів",
      less: "Менше",
      more: "Більше",
    },
    providerUsage: {
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілка потоку змінилася — перегляньте та надішліть повторно.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
    ...
    commandResults: {
      startingNewThread: "Запуск нового потоку...",
      resettingThread: "Скидання потоку...",
      stoppingCurrentRun: "Зупинка поточного запуску...",
      chatHistoryCleared: "Історію чату очищено.",
      exportingThread: "Експортування потоку...",
      unknownCommand: "Невідома команда: `{command}`",
      options: "Параметри: {options}.",
      sessionUnavailable: "Можливість сеансу недоступна",
      help: {
      ...
      compaction: {
        failed: "Не вдалося ущільнити.",
        failedWithReason: "Не вдалося ущільнити: {reason}",
        tokenSummary: " ({before} -> {after} токенів)",
        succeeded: "Контекст успішно ущільнено",
        skipped: "Ущільнення пропущено.",
        skippedWithReason: "Ущільнення пропущено: {reason}",
      },
      model: {
        ...
        set: "Модель встановлено на {model}.",
        setFailed: "Не вдалося встановити модель: {error}",
      },
      thinking: {
        current: "Поточний рівень мислення: {level}.",
        getFailed: "Не вдалося отримати рівень мислення: {error}",
        reset: "Рівень мислення скинуто до типового.",
        resetFailed: "Не вдалося скинути рівень мислення: {error}",
        unrecognized: 'Нерозпізнаний рівень мислення "{level}". Припустимі рівні: {options}.',
        unsupported:
          'Непідтримуваний рівень мислення "{level}" для цієї моделі. Припустимі рівні: {options}.',
        set: "Рівень мислення встановлено на {level}.",
        setFailed: "Не вдалося встановити рівень мислення: {error}",
      },
      verbose: {
        current: "Поточний рівень докладності: {level}.",
        getFailed: "Не вдалося отримати рівень докладності: {error}",
        unrecognized:
          'Нерозпізнаний рівень докладності "{level}". Припустимі рівні: off, on, full.',
        set: "Режим докладності встановлено на {level}.",
        setFailed: "Не вдалося встановити режим докладності: {error}",
      },
      fast: {
        autoValue: "авто ({seconds} с)",
        on: "увімк.",
        off: "вимк.",
        sourceSession: " (сеанс)",
        ...
        options: "on, off, авто ({seconds} с), default, status",
        getFailed: "Не вдалося отримати швидкий режим: {error}",
        reset: "Швидкий режим скинуто до типового.",
        resetFailed: "Не вдалося скинути швидкий режим: {error}",
        unrecognized:
          'Нерозпізнаний швидкий режим "{mode}". Дійсні рівні: on, off, auto, default, status.',
        setAuto: "Швидкий режим встановлено на auto.",
      ...
      usage: {
        ...
        notAvailable: "н/д",
        title: "Використання гілки",
        inputTokens: "Вхід: {count} токенів",
        outputTokens: "Вихід: {count} токенів",
        totalTokens: "Разом: {count} токенів",
        context: "Контекст: {percent} з {total}",
        model: "Модель: {model}",
        failed: "Не вдалося отримати використання: {error}",
      },
      agents: {
        none: "Немає налаштованих агентів.",
        title: "**Агенти** ({count})",
        default: "стандарт",
      ...
      steer: {
        timeout:
          "Активний запуск завершився до того, як повідомлення для скерування було прийнято.",
        failed: "Скерування не вдалося до того, як воно досягло запуску; спробуйте ще раз.",
        usage: "Використання: `/steer <message>`",
        noActiveRun: "Немає активного запуску. Скористайтеся полем чату або `/redirect`.",
        succeeded: "Скеровано.",
        requestFailed: "Не вдалося скерувати: {error}",
      },
      redirect: {
        timeout:
          "Активний запуск завершився до того, як повідомлення для перенаправлення було прийнято.",
        failed: "Перенаправлення не вдалося до того, як воно досягло запуску; спробуйте ще раз.",
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Діяти в цій гілці можуть лише власник і учасники.",
    },
    sessionSuggestions: {
      suggest: "Запропонувати",
      suggestMessage: "Запропонувати повідомлення",
      attachmentsUnsupported: "Видаліть вкладення перед надсиланням текстової пропозиції.",
      sendNow: "Надіслати пропозицію {author} зараз",
      queue: "Поставити пропозицію {author} в чергу",
      edit: "Редагувати пропозицію {author}",
      dismiss: "Відхилити пропозицію {author}",
      typing: "{name} друкує…",
    ...
    markdown: {
      truncated: "… скорочено ({total} символів, показано перші {shown}).",
    },
    codeBlock: {
    ...
    sidebar: {
      ...
      groups: "Групи",
      coding: "Програмування",
      noSessionsForAgent: "Для цього агента не знайдено сеансів",
      ...
      catalogDiscoveryHelp:
        "{error}. Налаштуйте нативне виявлення потоків у Settings > Automation > Plugins.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        ...
        waitingForRun: "Очікування поточного запуску",
    ...
    goals: {
      ...
      clear: "Очистити ціль",
      showDetails: "Показати деталі цілі",
      hideDetails: "Приховати деталі цілі",
    },
    questions: {
      ...
      expired: "Застарів",
      cancelled: "Скасовано",
      disconnected: "Немає з'єднання. Спробуйте знову після повторного підключення.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      currentMessage: "поточне повідомлення",
      actions: "Дії з повідомленням",
      selectionActions: "Дії з вибраним",
      moreDetails: "Докладніше",
      askInSideChat: "Запитати в бічному чаті",
      ...
      duplicatesCollapsed: "{count} однакових повідомлень поспіль згорнуто",
      contextFor: "Контекст повідомлення для {timestamp}",
    },
    mediaPlayer: {
      play: "Відтворити",
      pause: "Призупинити",
    ...
    modelControls: {
      ...
      fastHelp:
        "Швидкі відповіді завершуються раніше та можуть використовувати більшу частину ваших лімітів.",
      speedUnsupported: "Керування швидкістю не підтримується для цієї моделі.",
      contextWindow: "Контекст: {count}",
      chatOnly: "Лише чат",
      chatOnlyHelp:
        "Ця модель може спілкуватися, але не може використовувати інструменти. Оберіть іншу модель для роботи з файлами, командами, вебом або медіа.",
    ...
    rail: {
      ...
      subtitle: "Запитайте про цей сеанс або його проєкт",
      expand: "Розгорнути панель сеансу",
      collapse: "Згорнути панель сеансу",
      hide: "Приховати панель сеансу",
      show: "Показати панель сеансу",
      clear: "Очистити гілку помічника",
      plan: "План",
      ...
      empty: "Поставте запитання лише для читання про цей сеанс або його проєкт.",
      askLabel: "Запитати помічника сеансу",
      askPlaceholder: "Що мені варто знати?",
      askSubmit: "Запитувати",
      askPending: "Перевіряю сеанс…",
      askBusy: "Помічник уже відповідає на запитання.",
      askUnavailable: "Помічник зараз не може відповісти.",
      asOf: "станом на {time}",
      health: {
        "on-track": "За планом",
        grinding: "Працює",
    ...
    detailPanel: {
      ...
      fullContentNotVisible:
        "Повний вміст недоступний, оскільки цей запис стенограми не має видимої проєкції WebChat.",
      fullContentUnavailable: "Повний вміст більше недоступний для цього запису стенограми.",
      copyContents: "Копіювати вміст файлу",
      fileChanged: "Файл змінено на диску після його завантаження.",
      renderPreview: "Показати попередній перегляд",
      imagePreview: "Попередній перегляд зображення",
      file: "Файл",
      markdownPreview: "Попередній перегляд Markdown",
      toolDetails: "Деталі інструмента",
      reloadFailed: "Не вдалося перезавантажити останній файл.",
      overwriteLoadFailed: "Не вдалося завантажити останній файл перед перезаписом.",
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Офлайн — {count} у черзі; повідомлення надішлються після відновлення з'єднання.",
      ...
      compactingContext: "Стиснення контексту...",
      compacting: "Стиснення",
      compact: "Стиснути",
      contextCompacted: "Контекст стиснуто",
      fallbackActive: "Резервний активний: {model}",
      fallbackCleared: "Резервний очищено: {model}",
      fallbackSelected: "Вибрано: {model}",
      fallbackCurrent: "Активний: {model}",
      fallbackPrevious: "Попередній резервний: {model}",
      fallbackReason: "Причина: {reason}",
      fallbackAttempts: "Спроби: {attempts}",
      cancelReply: "Скасувати відповідь",
      attachmentPreview: "Попередній перегляд вкладення",
      ...
      menu: {
        ...
        scopeEverywhere: "Всюди",
        scopeSessionHint:
          "Сервер зберігається глобально вимкненим і ввімкненим лише для цієї сесії.",
        scopeEverywhereHint: "Сервер зберігається та ввімкнено для кожної сесії.",
        toolAccess: {
          ...
          summary: "Увімкнено {enabled} із {total} інструментів",
          summaryOne: "Увімкнено {enabled} із {total} інструмента",
        },
        ...
        savingBlocked: "Зачекайте завершення поточної зміни можливостей сеансу.",
      },
      overrides: {
        count: "{count} перевизначень сеансу",
        countOne: "{count} перевизначення сеансу",
    ...
    attachments: {
      ...
      outsideAllowedFolders: "Поза дозволеними теками",
      unavailable: "Недоступно",
      checking: "Перевірка...",
    },
    voice: {
    ...
    backgroundTasks: {
      ...
      detailTitle: "Деталі завдання",
      backToTasks: "Назад до фонових завдань",
  ...
  cron: {
    adminRequired: "Лише перегляд. Зміни в автоматизації потребують доступу operator.admin.",
    tabs: {
