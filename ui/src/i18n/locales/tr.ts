...
export const tr: TranslationMap = {
  ...
  mcpApp: {
    ...
    errors: {
      ...
      mountUnavailable: "MCP App bağlama kullanılamıyor",
      sandboxTimedOut: "MCP App sandbox zaman aşımına uğradı",
      sandboxUnavailable: "MCP App sandbox kullanılamıyor",
      initializationTimedOut: "MCP App başlatma zaman aşımına uğradı",
      requestFailed: "İstek başarısız oldu",
      invalidSandboxUrl: "MCP App sandbox URL'si geçersiz",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        ...
        updateFailed: "Profil güncelleme başarısız oldu",
        updateFailedStatus: "Profil güncelleme başarısız oldu ({status})",
        publishFailed: "Profil yayınlama tüm röle sunucularında başarısız oldu.",
        published: "Profil röle sunucularına yayınlandı.",
        importFailed: "Profil içe aktarımı başarısız oldu",
        importFailedStatus: "Profil içe aktarımı başarısız oldu ({status})",
        importedFromRelays:
          "Profil röle sunucularından içe aktarıldı. Gözden geçirin ve yayınlayın.",
        imported: "Profil içe aktarıldı. Gözden geçirin ve yayınlayın.",
      },
    },
  },
  lazyView: {
  ...
  updates: {
    ...
    coalescedRestart:
      "Güncelleme yüklendi. Bir gateway yeniden başlatması zaten devam ediyor; durum yeniden bağlandıktan sonra yenilenecek.",
    ...
    verificationFailedWithVersions:
      "Güncelleme yüklendi ancak çalışan sürüm değişmedi — yeniden başlatma engellenmiş olabilir. Beklenen v{expectedVersion}, çalışan v{actualVersion}.",
    handoffTimeout:
      "Güncelleme devri başladı ancak yeniden bağlandıktan sonra tamamlanma bildirilmedi. Nihai sonuç için `openclaw update status` komutunu çalıştırın.",
    outcomeUnknown:
    ...
    failureReasons: {
      dirty: "Değişiklikleri commit'leyin veya stash'leyin, ardından yeniden deneyin.",
      ...
      buildDirty:
        "Seçilen düzeltmenin derlemesi checkout dosyalarını değiştirdi. Oluşturulan yapı çıktılarını içeren bir düzeltmeyle yeniden deneyin.",
      uiBuildFailed:
        "Control UI yeniden derlemesi başarısız oldu. UI derleme hatasını düzeltip yeniden deneyin.",
      globalInstallFailed:
        "Global paket kurulumu diskte doğrulanamadı. Yeniden deneyin veya CLI'dan yeniden kurun.",
      restartDisabled:
        "Gateway yeniden başlatmaları devre dışı olduğundan güncelleme uygulanmadı. Yapılandırmada yeniden başlatmaları etkinleştirin, ardından yeniden deneyin.",
      restartUnavailable:
        "Yeniden başlatmalar devre dışıyken ve bir yönetici mevcut değilken bu global kurulum güvenli şekilde değiştirilemez.",
      restartUnhealthy:
        "Yeni süreç hiçbir zaman sağlıklı hale gelmedi. Kurtarma yapabilmeniz için önceki süreç çalışır durumda kaldı.",
      managedServiceHandoffAlreadyRunning:
        "Başka bir yönetilen güncelleme zaten çalışıyor. Tamamlanmasını bekleyin, ardından güncelleme durumunu yenileyin.",
      doctorFailed:
        "Doctor onarımı başarısız oldu. `openclaw doctor --non-interactive` komutunu çalıştırıp yeniden deneyin.",
      default:
        "Tam hata için gateway günlüklerine bakın ve neden düzeltildikten sonra yeniden deneyin.",
    },
    postRestart: {
      restartUnhealthy:
        "Yeni süreç hiçbir zaman sağlıklı hale gelmedi ve önceki süreç çalışır durumda kaldı.",
      default: "Yeni süreç hatası için gateway günlüklerini kontrol edin.",
    },
  },
  nodes: {
    pairing: {
  ...
  sessionsView: {
    subagentPrefix: "Alt aracı:",
    automationPrefix: "Otomasyon:",
  ...
  agents: {
    noAgents: "No agents",
    defaults: {
      title: "Ajan varsayılanları",
      description: "Geçersiz kılınmadıkça her ajanın devraldığı varsayılanlar.",
    },
    copyId: "Copy ID",
  ...
  configForm: {
    ...
    invalidJson: "Bu alandan çıkmadan önce geçerli JSON girin.",
    invalidString: "Bu ayarın kısıtlamalarına uyan bir değer girin.",
    invalidNumber: "İzin verilen aralık ve adım içinde bir değer girin.",
    draftRejected: "Bu ayar kaydedilemedi. Taslağınız hâlâ burada.",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Parlak {date} tarihinde görüldü",
      lobsterdexCardCopyLink: "Bağlantıyı kopyala",
  ...
  configView: {
    ...
    syncPendingHint: "Gateway üzerinden senkronize olmayı bekliyor.",
    notifications: {
  ...
  terminal: {
    ...
    uploadUnsafeCmdPath:
      "% veya ! içeren yüklenmiş bir yol cmd.exe içine güvenli şekilde eklenemez",
    uploadUnsupportedShell:
      "Yüklenmiş bir yol, desteklenmeyen kabuğa güvenli şekilde eklenemez: {shell}",
  },
  browser: {
    title: "Tarayıcı",
    ...
    errors: {
      ...
      screenshotFetchTimedOut: "Ekran görüntüsü alımı zaman aşımına uğradı.",
      screenshotFetchFailed: "Ekran görüntüsü alımı başarısız oldu ({status}).",
      screenshotReadFailed: "Ekran görüntüsü okuması başarısız oldu.",
      screenshotDecodeFailed: "Ekran görüntüsü çözümlemesi başarısız oldu.",
  ...
  modelSetup: {
    ...
    prepare: {
      title: "Yerel model kur",
      intro: "Bu Gateway üzerinde yerel bir model indirin veya hazırlayın.",
      ollamaButton: "Kontrol et ve kur",
      ollamaLabel: "Ollama",
      ollamaHint: "Ollama sunucunuzdan araç destekli bir model indirin",
      llamaCppLabel: "Yerel model (llama.cpp)",
      providerNotReady:
        "{provider} kullanılabilir bir yerel model sunmadı. Kurulum sonucunu inceleyip yeniden deneyin.",
    },
    manual: {
      title: "API anahtarı veya token ile bağlan",
      provider: "Sağlayıcı",
      selectProvider: "Bir sağlayıcı seçin",
      selectProviderHint: "Bu kimlik bilgisinin nereden geldiğini seçin",
      accessValue: "API anahtarı veya token",
      accessValueFor: "{provider} API anahtarı veya belirteci",
    ...
    wizard: {
      ...
      title: "Bir sağlayıcıyla oturum açın",
      prepareTitle: "Bir yerel model kurun",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "Geçmiş oturumlardan",
      subtitle:
        "Önceki aracı oturumlarından güvenilir anıları hazırlayın. Rüya görme, yararlı olanları uzun süreli belleğe aktarır.",
      dateRange: "Oturum tarih aralığı",
      dateRangeHint: "Mevcut tüm aralığı taramak için tarihlerden birini boş bırakın.",
      from: "Başlangıç",
      to: "Bitiş",
      actions: "Geri doldur",
      preview: "Önizleme",
      ...
      applying: "Uygulanıyor…",
      rollback: "Geri al",
      previewSummary: "{days} gün boyunca {candidates} aday",
      previewTruncated:
        "Bu önizleme, ilk sınırlı grubu gösterir. Uygula, kalan adaylarla devam eder.",
      candidateCount: "{count} aday",
      noCandidates: "Yeni güvenilir oturum adayı bulunamadı.",
      progress: "{days} gün işlendi · {staged} hazırlandı",
      processedCandidates: "{count} oturum adayı işlendi",
      processedDayCountOne: "{count} gün işlendi",
      processedDayCount: "{count} gün işlendi",
      complete: "{count} hazırlandı; aktarım rüya görme yoluyla gerçekleşir",
      rollbackConfirmTitle: "Oturum geri doldurma geri alınsın mı?",
      rollbackConfirmDescription:
        "Bu aracı için oturum geri doldurma tarafından oluşturulan günlük kayıtlarını ve hazırlanmış anıları kaldırın.",
      rollbackWarning:
        "İzlenen oturum imleçleri yerinde kalır, bu nedenle kaldırılan kayıtlar tekrar hazırlanmaz.",
      rollbackComplete: "Oturum geri doldurma geri alındı",
      rollbackCounts: "{diary} günlük kaydı ve {staged} hazırlanmış kayıt kaldırıldı",
      unavailable: "Oturum geri doldurma bu Gateway'de kullanılamıyor.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupTitle: "OpenClaw'a bu uygulamanın dışından erişin",
      channelSetupBody:
        "Web uygulaması zaten çalışıyor. Yalnızca başka bir hizmetten OpenClaw'a mesaj göndermek istiyorsanız bir kanal ekleyin.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Sunucu genel olarak devre dışı kaydedildi, ancak bu oturum için etkinleştirme başarısız oldu: {error}",
    sessionChanged: "Etkin oturum, etkinleştirilmeden önce değişti.",
    sessionUnavailable: "Etkin oturum kullanılamıyor; yenileyin ve tekrar deneyin.",
  ...
  talkPage: {
    ...
    voiceSection: {
      ...
      description:
        "Aracınızla sürekli konuşma sohbetleri. Aşağıdaki seçiciler talk.realtime ayarlarını yazar; daha aşağıdaki tam form geri kalan her şeyi kapsar.",
    },
    status: {
      title: "Durum",
      ready: "Hazır",
      ...
      unavailable: "Kullanılamıyor",
      unavailableHint: "Gerçek zamanlı ses hazırlığını kontrol etmek için Gateway'e bağlanın.",
      activeProvider: "Etkin sağlayıcı: {provider}",
      noProvider: "Henüz bir gerçek zamanlı ses sağlayıcısı yapılandırılmadı.",
    },
    provider: {
      title: "Sağlayıcı",
      description: "Otomatik, çalışan kimlik bilgilerine sahip ilk sağlayıcıyı seçer.",
      auto: "Otomatik",
    },
    model: {
      title: "Model",
    ...
    voice: {
      ...
      description:
        "Sesli yanıtlarda kullanılan ses. GPT-Live, bir çağrı başladığında sesi kilitler.",
      default: "Sağlayıcı varsayılanı",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live bir ChatGPT aboneliğiyle çalışır: bir kez “openclaw models auth login --provider openai” ile oturum açın. Platform API anahtarı gerekmez. Yalnızca tarayıcı Talk. Devredilen işler çalışırken yönlendirilebilir ve yüksek etkili işlemler için tam sözlü onay gerektirir.",
      ready: "Hazır",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        hibernating: "Bellek uyku modunda",
        needsAttention: "Bellek ilgi gerektiriyor",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Bu aracının bellek motoru ve rüya döngüsü kontrol ediliyor.",
        offDescription: "Uyandırmak için Ayarlar'da bir bellek motoru seçin.",
        disabledDescription: "Seçili bellek motoru devre dışı. Ayarlar'dan yeniden etkinleştirin.",
        gatewayOffline: "Gateway çevrimdışı, bu nedenle bellek durumu kullanılamıyor.",
        hybridSearch: "hibrit arama",
        keywordSearch: "anahtar kelime araması (gömme yok)",
      ...
      schedule: {
        title: "Uyku programı",
        lightDescription:
          "Yeni kısa vadeli notları düzenler ve uzun vadeli belleği değiştirmeden umut verici adayları hazırlar.",
        remDescription:
          "Uzun vadeli belleği değiştirmeden sıralamayı güçlendirmek için son etkinlikteki temalar ve tekrarlayan fikirler üzerine düşünür.",
        deepDescription:
          "Hazırlanan adayları puanlar, korunanları uzun vadeli belleğe (MEMORY.md) taşır ve rüya günlüğünü yazar.",
      ...
      activity: {
        title: "Etkinlik",
        promotedToday: "Bugün taşınan",
        promotedTotal: "Toplam taşınan",
        shortTermCount: "Bekleyen kısa vadeli girişler",
        phaseHitCount: "Aşama sinyalleri",
        lightPhaseHitCount: "Hafif aşama isabetleri",
        remPhaseHitCount: "REM aşaması isabetleri",
      },
      health: {
        title: "Motor sağlığı",
        provider: "Sağlayıcı",
        embeddings: "Embeddings",
        runtime: "Embedding çalışma zamanı",
        healthy: "Hazır",
        unavailable: "Kullanılamıyor",
        notChecked: "Kontrol edilmedi",
        notCheckedDescription: "Embedding hazırlığı henüz kontrol edilmedi.",
        checking: "Kontrol ediliyor…",
        test: "Test et",
      ...
      shortcuts: {
        ...
        memories: "Anıları ara",
        diary: "Rüya günlüğünü oku",
        settings: "Belleği yapılandır",
      },
    },
    memories: {
      searchLabel: "Anıları ara",
      searchPlaceholder: "Bu ajanın anılarını ara",
      searchButton: "Ara",
      idle: "Bu ajanın hatırladığı bir kişiyi, projeyi, kararı veya başka herhangi bir şeyi arayın.",
      searching: "Anılar aranıyor…",
      results: "{count} sonuç",
      empty: "“{query}” ile eşleşen anı bulunamadı.",
      error: "Anı araması başarısız oldu: {message}",
      retry: "Tekrar dene",
      gatewayUpdateRequired: "Control UI'dan anıları aramak için gateway'i güncelleyin.",
      hybridSearch: "hibrit arama",
      keywordSearch: "anahtar kelime araması",
      lineRange: "satır {start}–{end}",
      score: "puan {score}",
      sourceMemory: "bellek",
      sourceSessions: "oturum",
      fileLoading: "Tam bellek dosyası yükleniyor…",
    ...
    backend: {
      ...
      builtin: "Yerleşik",
      qmd: "QMD",
      invalid: "Geçersiz yapılandırılmış değer",
      ...
      invalidHint:
        "Yapılandırılmış memory.backend değeri geçersiz. Bir arka uç seçin veya varsayılanı kullanmak için sıfırlayın.",
    },
    addons: {
      title: "Eklentiler",
      description:
      ...
      toggleAriaLabel: "{plugin} özelliğini etkinleştir veya devre dışı bırak",
    ...
    dreaming: {
      ...
      timezone: {
        ...
        default: "Gateway yerel saat dilimi",
      },
      model: {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Bir aracı ilerleme kaydetmeyi durdurduğunda tekrarlanan araç çağrılarını uyaran veya engelleyen dinamik geçmiş korumalarını etkinleştirin.",
    },
    localModelLean: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Etkinliği, maliyetleri ve kullanım eğilimlerini görüntüleyin.",
    identity: {
      title: "Kimlik",
  ...
  skillWorkshop: {
    ...
    evaluation: {
      ...
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "Mevcut öneri revizyonu belirlenemedi.",
        revisionChanged: "Öneri revizyonu değerlendirme sırasında değişti.",
      },
    },
    empty: {
    ...
    today: {
      ...
      evaluate: "Değerlendir",
      runChecks: "Öneri kontrollerini çalıştır",
  ...
  dreaming: {
    ...
    header: {
      ...
      off: "Dreaming Kapalı",
      engineOff:
        "Bellek motoru Kapalı. Rüya görmeyi etkinleştirmek için Ayarlar'dan bir motor seçin.",
    },
    toggleConfirmation: {
    ...
    actions: {
      dedupeRemovedOneAndKept: "{removed} yinelenen rüya girişi kaldırıldı ve {kept} tutuldu.",
      dedupeRemovedManyAndKept: "{removed} yinelenen rüya girişi kaldırıldı ve {kept} tutuldu.",
      dedupeRemovedOne: "{removed} yinelenen rüya girişi kaldırıldı.",
      dedupeRemovedMany: "{removed} yinelenen rüya girişi kaldırıldı.",
      repairArchivedThreadCorpus: "arşivlenmiş konu bütünü",
      ...
      backfillComplete: "{count} rüya günlüğü girişi geriye dönük dolduruldu.",
      resetDiaryComplete: "Geriye dönük doldurulmuş {count} rüya günlüğü girişi kaldırıldı.",
      clearReplayedComplete: "Yeniden oynatılan {count} kısa vadeli giriş temizlendi.",
      complete: "Rüya günlüğü eylemi tamamlandı.",
      confirmRepair:
        "Rüya Önbelleği Onarılsın mı? Bu işlem türetilen rüya önbelleği dosyalarını arşivler ve temiz girdilerden yeniden oluşturur. Rüya günlüğünüz olduğu gibi kalır.",
      confirmDedupe:
        "Rüya Günlüğü Yinelenenleri Kaldırılsın mı? Bu işlem DREAMS.md dosyasını yeniden yazar ve yalnızca birebir yinelenen günlük girişlerini kaldırır.",
      ...
      configHashMissing: "Config hash eksik; yenileyip tekrar deneyin.",
    },
    wiki: {
      ...
      questionCountOnPages: "{pageCount} üzerinde {questionCount}",
      risk: {
      ...
      importedClusterSummary: "İçe aktarılan sohbetler {label} etrafında kümelendi.",
      withheldDigestOne: "{count} özet inceleme beklenirken bekletildi.",
      withheldDigests: "{count} özet inceleme beklenirken bekletildi.",
      details: "Ayrıntılar",
      hideDetails: "Ayrıntıları gizle",
      vault: "Kasa",
      fullVaultBreakdown: "Tam kasa dökümü: {breakdown}.",
      selectedSection: "Seçili bölüm: {summary}.",
      latestUpdate: "Son güncelleme {date}.",
      noContent: "Wiki içeriği mevcut değil.",
    },
    phrases: {
  ...
  modelProviders: {
    ...
    readiness: {
      title: "Yapay zeka kurulumu",
      heading: "Doğrulanmış bir yapay zeka modeli bağlayın",
      signedInNoModels:
  ...
  usage: {
    ...
    heatmap: {
      title: "Token Etkinliği",
      subtitle: "Seçilen aralık için günlük token yoğunluğu, bir yıla kadar.",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable: "Tarayıcı eşleştirme isteği henüz mevcut değil. Birazdan tekrar deneyin.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Konu dalları değiştirdi — gözden geçirip yeniden gönderin.",
    },
    waitingForApproval: "Onay bekleniyor…",
    startupStatus: {
    ...
    commandResults: {
      startingNewThread: "Yeni konu başlatılıyor...",
      resettingThread: "Konu sıfırlanıyor...",
      stoppingCurrentRun: "Mevcut çalıştırma durduruluyor...",
      chatHistoryCleared: "Sohbet geçmişi temizlendi.",
      exportingThread: "Konu dışa aktarılıyor...",
      ...
      model: {
        current: "**Mevcut model:** {model}",
        available: "**Kullanılabilir:** {models}",
        more: "+{count} daha",
        getFailed: "Model bilgisi alınamadı: {error}",
      ...
      verbose: {
        ...
        set: "Ayrıntı modu {level} olarak ayarlandı.",
        setFailed: "Ayrıntı modu ayarlanamadı: {error}",
      },
      fast: {
        autoValue: "otomatik ({seconds} sn)",
        on: "açık",
        off: "kapalı",
        sourceSession: " (oturum)",
        sourceAgent: " (varsayılan: aracı)",
      ...
      usage: {
        noActiveThread: "Etkin iş parçacığı yok.",
        notAvailable: "yok",
        title: "İş Parçacığı Kullanımı",
        inputTokens: "Giriş: {count} token",
        outputTokens: "Çıkış: {count} token",
        totalTokens: "Toplam: {count} token",
        context: "Bağlam: {total} içinde {percent}",
        model: "Model: {model}",
        failed: "Kullanım alınamadı: {error}",
      },
      agents: {
      ...
      steer: {
        timeout: "Yönlendirme mesajı kabul edilmeden önce etkin çalışma sona erdi.",
        failed: "Yönlendirme çalışmaya ulaşmadan başarısız oldu; tekrar deneyin.",
        usage: "Kullanım: `/steer <message>`",
        noActiveRun: "Etkin çalışma yok. Bunun yerine sohbet girişini veya `/redirect` kullanın.",
        succeeded: "Yönlendirildi.",
        requestFailed: "Yönlendirilemedi: {error}",
      },
      redirect: {
        timeout: "Yeniden yönlendirme mesajı kabul edilmeden önce etkin çalışma sona erdi.",
        failed: "Yeniden yönlendirme çalışmaya ulaşmadan başarısız oldu; tekrar deneyin.",
        usage: "Kullanım: `/redirect <message>`",
        succeeded: "Yeniden yönlendirildi.",
        requestFailed: "Yeniden yönlendirilemedi: {error}",
      },
    },
    sessionSharing: {
      menu: "Konu paylaşımı",
      ...
      readOnlyNotice: "Bu konu başlığında yalnızca konu sahibi ve üyeler işlem yapabilir.",
    },
    sessionSuggestions: {
      suggest: "Öner",
      ...
      dismiss: "{author} adlı kişinin önerisini yoksay",
      typing: "{name} yazıyor…",
    ...
    markdown: {
      truncated: "… kısaltıldı ({total} karakter, ilk {shown} gösteriliyor).",
    },
    codeBlock: {
    ...
    skills: {
      menu: "Skill referansları",
      label: "Skills",
      loading: "Skills yükleniyor…",
    },
    splitView: {
    ...
    sidebar: {
      ...
      catalogDiscoveryHelp:
        "{error}. Yerel iş parçacığı keşfini Ayarlar > Otomasyon > Eklentiler bölümünden yapılandırın.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        ...
        waitingForRun: "Mevcut çalıştırma bekleniyor",
    ...
    messages: {
      ...
      voiceNote: "Sesli not",
      duplicatesCollapsed: "{count} ardışık aynı mesaj daraltıldı",
      contextFor: "{timestamp} için mesaj bağlamı",
    },
    mediaPlayer: {
      play: "Oynat",
      pause: "Duraklat",
      ...
      videoUnavailable: "Bu format oynatılamıyor — bunun yerine indirin.",
    },
    modelControls: {
      current: "Geçerli",
      default: "Varsayılan",
      ...
      fastHelp:
        "Hızlı yanıtlar daha erken tamamlanır ve kullanım sınırlarınızın daha fazlasını kullanabilir.",
      speedUnsupported: "Bu model için hız denetimi desteklenmiyor.",
      contextWindow: "{count} bağlam",
      chatOnly: "Yalnızca sohbet",
      chatOnlyHelp:
        "Bu model sohbet edebilir, ancak araçları kullanamaz. Dosya, komut, web veya medya görevleri için başka bir model seçin.",
    ...
    rail: {
      ...
      subtitle: "Bu oturum veya projesi hakkında soru sorun",
      expand: "Oturum panelini genişlet",
      collapse: "Oturum panelini daralt",
      hide: "Oturum panelini gizle",
      show: "Oturum panelini göster",
      clear: "Yardımcı dizisini temizle",
      plan: "Plan",
      ...
      finished: "Bitti {time}",
      empty: "Bu oturum veya projesi hakkında salt okunur bir soru sorun.",
      askLabel: "Oturum yardımcısına sor",
      askPlaceholder: "Neyi bilmem gerekiyor?",
      askSubmit: "Sor",
      askPending: "Oturum kontrol ediliyor…",
      askBusy: "Yardımcı zaten bir soruyu yanıtlıyor.",
      askUnavailable: "Yardımcı şu anda yanıt veremiyor.",
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "Depolanan döküm kaydı güvenli şekilde döndürülemeyecek kadar büyük olduğundan tam içerik kullanılamıyor.",
      fullContentNotVisible:
        "Bu döküm kaydının görünür bir WebChat projeksiyonu olmadığından tam içerik kullanılamıyor.",
      fullContentUnavailable: "Bu döküm kaydı için tam içerik artık kullanılamıyor.",
      copyContents: "Dosya içeriğini kopyala",
      fileChanged: "Dosya yüklendiğinden bu yana diskte değişti.",
      renderPreview: "Önizlemeyi işle",
    ...
    composer: {
      ...
      fallbackActive: "Yedek etkin: {model}",
      fallbackCleared: "Yedek temizlendi: {model}",
      fallbackSelected: "Seçildi: {model}",
      fallbackCurrent: "Etkin: {model}",
      fallbackPrevious: "Önceki yedek: {model}",
      fallbackReason: "Neden: {reason}",
      fallbackAttempts: "Denemeler: {attempts}",
      ...
      menu: {
        ...
        noSkills: "Kullanılabilir skill yok.",
        noConnectors: "Yapılandırılmış MCP sunucusu yok.",
        depsMissing: "bağımlılıklar eksik",
        skillBlocked: "bu ajan için kullanılamıyor",
        sessionTag: "oturum",
        offlineBlocked: "Oturum yeteneklerini değiştirmek için gateway'e bağlanın.",
        readOnlyBlocked: "Oturum yeteneklerini değiştirmek için yazma erişimi gerekir.",
        adminBlocked: "Bağlayıcıları yönetmek için yönetici erişimi gerekir.",
        savingBlocked: "Geçerli oturum yeteneği değişikliğinin bitmesini bekleyin.",
      },
      overrides: {
        count: "{count} oturum geçersiz kılması",
        countOne: "{count} oturum geçersiz kılması",
        clear: "Oturum geçersiz kılmalarını temizle",
      },
      contextUsage: {
