...
export const nl: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Het updateverzoek is mogelijk geaccepteerd, maar de Gateway heeft na het opnieuw verbinden geen eindresultaat gerapporteerd. Voer `openclaw update status` uit voordat je het opnieuw probeert.",
    failureReasons: {
  ...
  configForm: {
    ...
    defaultValue: "Standaard: {value}",
    usingDefault: "Standaardwaarde gebruiken: {value}",
    resetToDefault: "Terugzetten naar standaard",
    select: "Selecteren...",
    nullValue: "null",
    jsonValue: "JSON-waarde",
    invalidJson: "Voer geldige JSON in voordat je dit veld verlaat.",
    invalidString: "Voer een waarde in die voldoet aan de beperkingen van deze instelling.",
    invalidNumber: "Voer een waarde in binnen het toegestane bereik en de toegestane stap.",
    draftRejected: "Deze instelling kon niet worden opgeslagen. Je concept staat er nog.",
  ...
  configView: {
    ...
    syncPendingHint: "Wachten op synchronisatie via de gateway.",
    notifications: {
      title: "Pushmeldingen",
    ...
    formUnsafeCount: "1 instelling in deze config kan alleen als tekst worden bewerkt: {paths}",
    formUnsafeCountPlural:
      "{count} instellingen in deze config kunnen alleen als tekst worden bewerkt: {paths}",
    formUnsafeMore: "+{count} meer",
    openRawEditor: "Raw-editor openen",
  ...
  modelSetup: {
    ...
    unavailable: {
      ...
      signIn: "Aanmelden met {provider}",
      useApiKey: "API-sleutel gebruiken",
    },
    signIn: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} heeft geen bruikbaar lokaal model beschikbaar gesteld. Bekijk het instellingsresultaat en probeer het opnieuw.",
    },
    manual: {
    ...
    wizard: {
      ...
      prepareStarting: "Bezig met opzetten van lokaal model…",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "De web-app werkt al. Voeg alleen een kanaal toe als je OpenClaw wilt bereiken vanaf een andere dienst.",
      channelSetupAction: "Een kanaal instellen",
      channelSetupDismiss: "De web-app blijven gebruiken",
    },
  },
  mcpServers: {
  ...
  mcpPage: {
    ...
    setUpFirstServer: "Stel je eerste MCP-server in",
  ...
  talkPage: {
    ...
    provider: {
      title: "Provider",
      description: "Auto kiest de eerste provider met werkende inloggegevens.",
      auto: "Automatisch",
    },
    model: {
      title: "Model",
  ...
  memoryPage: {
    ...
    backend: {
      ...
      builtin: "Ingebouwd",
      qmd: "QMD",
      invalid: "Ongeldige geconfigureerde waarde",
      ...
      invalidHint:
        "De geconfigureerde memory.backend-waarde is ongeldig. Kies een backend of reset deze om de standaard te gebruiken.",
    },
    addons: {
      title: "Add-ons",
      description:
    ...
    dreaming: {
      ...
      timezone: {
        ...
        default: "Lokale tijdzone van Gateway",
      },
      model: {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Schakel rollende-geschiedenisbeveiligingen in die waarschuwen of herhaalde tool-aanroepen blokkeren wanneer een agent geen voortgang meer maakt.",
    },
    localModelLean: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Bekijk activiteit, kosten en gebruikstrends.",
    identity: {
      title: "Identiteit",
  ...
  skillWorkshop: {
    ...
    today: {
      ...
      evaluate: "Evalueren",
      runChecks: "Voorstelcontroles uitvoeren",
      tweakIt: "Aanpassen",
  ...
  dreaming: {
    ...
    header: {
      ...
      off: "Dromen uit",
      engineOff:
        "Geheugenengine staat uit. Kies een engine in Instellingen om dromen in te schakelen.",
    },
    toggleConfirmation: {
    ...
    actions: {
      dedupeRemovedOneAndKept: "{removed} dubbele droomvermelding verwijderd en {kept} behouden.",
    ...
    wiki: {
      ...
      emptyWiki: "Geheugenwiki is nog niet gevuld",
      emptyWikiHint:
      ...
      counts: {
        ...
        contradictions: "{count} tegenstrijdigheden",
        chats: "{count} chats",
        sensitive: "{count} gevoelig",
        signals: "{count} signalen",
        messages: "{count} berichten",
        userMessages: "{count} gebruiker",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      signedInNoModels:
        "Je bent aangemeld, maar dit account biedt geen bruikbare modellen. Kies een andere provider of account om verder te gaan.",
  ...
  chat: {
    ...
    commandResults: {
      ...
      fast: {
        ...
        on: "aan",
        off: "uit",
        sourceSession: " (sessie)",
        sourceAgent: " (standaard: agent)",
        sourceModel: " (standaard: model)",
      ...
      usage: {
        ...
        notAvailable: "n.v.t.",
        title: "Threadgebruik",
        inputTokens: "Invoer: {count} tokens",
        outputTokens: "Uitvoer: {count} tokens",
        totalTokens: "Totaal: {count} tokens",
        context: "Context: {percent} van {total}",
        model: "Model: {model}",
        failed: "Kan gebruik niet ophalen: {error}",
      },
      agents: {
        none: "Geen agents geconfigureerd.",
        title: "**Agents** ({count})",
        default: "standaard",
    ...
    markdown: {
      truncated: "… ingekort ({total} tekens, eerste {shown} weergegeven).",
    },
    codeBlock: {
      jsonLines: "JSON · {count} regels",
    },
    workspaceConflict: {
    ...
    sidebar: {
      ...
      groups: "Groepen",
      coding: "Programmeren",
      noSessionsForAgent: "Geen sessies gevonden voor deze agent",
    ...
    messages: {
      ...
      duplicatesCollapsed: "{count} opeenvolgende identieke berichten samengevouwen",
      contextFor: "Berichtcontext voor {timestamp}",
    },
    mediaPlayer: {
      play: "Afspelen",
      pause: "Pauzeren",
    ...
    rail: {
      title: "Sessiehulp",
      subtitle: "Stel een vraag over deze sessie of het bijbehorende project",
      expand: "Sessiebalk uitvouwen",
      collapse: "Sessiebalk invouwen",
      hide: "Sessiebalk verbergen",
      show: "Sessiebalk tonen",
      clear: "Hulpthread wissen",
      plan: "Plan",
      ...
      finished: "Voltooid {time}",
      empty: "Stel een alleen-lezen vraag over deze sessie of het bijbehorende project.",
      askLabel: "Vraag de sessiehulp",
      askPlaceholder: "Wat moet ik weten?",
      askSubmit: "Vragen",
      askPending: "Sessie controleren…",
      askBusy: "De hulp beantwoordt al een vraag.",
      askUnavailable: "De hulp kan nu geen antwoord geven.",
      asOf: "vanaf {time}",
      health: {
        "on-track": "Op koers",
        grinding: "Bezig",
    ...
    composer: {
      ...
      fallbackCleared: "Fallback gewist: {model}",
      fallbackSelected: "Geselecteerd: {model}",
      fallbackCurrent: "Actief: {model}",
      fallbackPrevious: "Vorige fallback: {model}",
      fallbackReason: "Reden: {reason}",
      fallbackAttempts: "Pogingen: {attempts}",
      cancelReply: "Antwoord annuleren",
      attachmentPreview: "Voorbeeld van bijlage",
      ...
      menu: {
        ...
        noSkills: "Geen Skills beschikbaar.",
        noConnectors: "Geen MCP-servers geconfigureerd.",
      ...
      overrides: {
        count: "{count} sessie-overschrijvingen",
        countOne: "{count} sessie-overschrijving",
        clear: "Sessie-overschrijvingen wissen",
      },
      contextUsage: {
    ...
    attachments: {
      ...
      outsideAllowedFolders: "Buiten toegestane mappen",
      unavailable: "Niet beschikbaar",
      checking: "Controleren...",
    },
    voice: {
    ...
    backgroundTasks: {
      ...
      backToTasks: "Terug naar achtergrondtaken",
