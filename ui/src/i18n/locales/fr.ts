...
export const fr: TranslationMap = {
  ...
  mcpApp: {
    ...
    errors: {
      gatewayUnavailable: "Gateway MCP App indisponible",
      mountUnavailable: "Point de montage MCP App indisponible",
      sandboxTimedOut: "Délai d'attente du sandbox MCP App dépassé",
      sandboxUnavailable: "Sandbox MCP App indisponible",
      initializationTimedOut: "Délai d'initialisation de MCP App dépassé",
      requestFailed: "Échec de la requête",
      invalidSandboxUrl: "L'URL du sandbox MCP App est invalide",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "La requête a expiré après 30 secondes ; le serveur a peut-être tout de même appliqué la modification — vérifiez le profil avant de réessayer.",
        operationFailed: "{prefix} : {error}",
        updateFailed: "Échec de la mise à jour du profil",
        updateFailedStatus: "Échec de la mise à jour du profil ({status})",
        publishFailed: "Échec de la publication du profil sur tous les relais.",
        published: "Profil publié sur les relais.",
        importFailed: "Échec de l'importation du profil",
        importFailedStatus: "Échec de l'importation du profil ({status})",
        importedFromRelays: "Profil importé depuis les relais. Vérifiez et publiez.",
        imported: "Profil importé. Vérifiez et publiez.",
      },
    },
  },
  lazyView: {
    ...
    retry: "Réessayer",
    stylesFailed: "Le chargement des styles a échoué, la page peut donc paraître dégradée.",
  },
  updates: {
    refreshRequired:
      "Serveur mis à jour — actualisez pour bénéficier de toutes les fonctionnalités",
    coalescedRestart:
      "Mise à jour installée. Un redémarrage du gateway est déjà en cours ; l'état sera actualisé après la reconnexion.",
    error: "Erreur de mise à jour : {error}",
    status: "Mise à jour {status} : {reason}. {guidance}",
    verificationFailed:
      "Mise à jour installée mais la version en cours d'exécution n'a pas changé — le redémarrage a peut-être été bloqué.",
    ...
    failureReasons: {
      ...
      notGitInstall:
        "Ce n'est pas un checkout git. Exécutez `openclaw update` depuis le CLI pour une réinstallation globale.",
      notOpenclawRoot:
        "Exécutez la mise à jour depuis un checkout OpenClaw ou utilisez la voie de réinstallation globale du CLI.",
      depsInstallFailed:
        "L'installation des dépendances a échoué. Corrigez l'erreur d'installation et réessayez.",
      buildFailed: "La compilation a échoué. Corrigez l'erreur de compilation et réessayez.",
      buildDirty:
        "La build de la révision sélectionnée a modifié des fichiers de checkout. Réessayez avec une révision qui inclut ses artefacts générés.",
      uiBuildFailed:
        "La reconstruction du control UI a échoué. Corrigez l'erreur de build de l'UI et réessayez.",
      globalInstallFailed:
        "L'installation du package global n'a pas été vérifiée sur le disque. Réessayez ou réinstallez depuis la CLI.",
      restartDisabled:
        "La mise à jour n'a pas été appliquée car les redémarrages du gateway sont désactivés. Activez les redémarrages dans la configuration, puis réessayez.",
      restartUnavailable:
        "Cette installation globale ne peut pas être remplacée en toute sécurité tant que les redémarrages sont désactivés et qu'aucun superviseur n'est présent.",
      restartUnhealthy:
        "Le processus de remplacement n'est jamais devenu sain. Le processus précédent est resté actif pour vous permettre de récupérer.",
      managedServiceHandoffAlreadyRunning:
        "Une autre mise à jour gérée est déjà en cours. Attendez qu'elle se termine, puis actualisez l'état de la mise à jour.",
      doctorFailed:
        "La réparation Doctor a échoué. Exécutez `openclaw doctor --non-interactive` et réessayez.",
      default:
        "Consultez les journaux du gateway pour connaître l'échec exact et réessayez une fois la cause corrigée.",
    },
    postRestart: {
      restartUnhealthy:
        "Le processus de remplacement n'est jamais devenu sain et le processus précédent est resté actif.",
      default: "Vérifiez les journaux du gateway pour l'échec du remplacement.",
    },
  },
  nodes: {
    pairing: {
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Ouvrez un fil et basculez sur la face Tableau de bord pour l'ajouter ici.",
  ...
  agents: {
    noAgents: "No agents",
    defaults: {
      title: "Valeurs par défaut de l'agent",
      description: "Valeurs par défaut dont hérite chaque agent, sauf substitution.",
    },
    copyId: "Copy ID",
    ...
    files: {
      ...
      createHint:
        "Ce fichier n'existe pas encore. L'enregistrement le créera dans l'espace de travail de l'agent.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  configForm: {
    redactedPlaceholder: "[masqué - cliquez sur révéler pour afficher]",
    sectionHelp: "Aide pour {section}",
    ...
    defaultValue: "Par défaut : {value}",
    usingDefault: "Valeur par défaut utilisée : {value}",
    resetToDefault: "Réinitialiser par défaut",
    select: "Sélectionner...",
    nullValue: "null",
    jsonValue: "Valeur JSON",
    invalidJson: "Saisissez un JSON valide avant de quitter ce champ.",
    invalidString: "Saisissez une valeur qui respecte les contraintes de ce paramètre.",
    ...
    sections: {
      ...
      tts: {
        label: "Voix",
        description: "Sortie de synthèse vocale, voix et personas",
      },
      session: {
        label: "Session",
  ...
  quickSettings: {
    ...
    model: {
      ...
      default: "Par défaut",
      modelPolicy: "Politique de modèle",
      thinkingLevels: {
        off: "Désactivée",
        low: "Faible",
        medium: "Moyenne",
    ...
    appearance: {
      ...
      lobsterdexCardFirstVisited: "Première visite le {date}",
      lobsterdexCardShinySeen: "✦ Shiny repéré {date}",
      lobsterdexCardCopyLink: "Copier le lien",
      lobsterdexOpen: "Ouvrir Lobsterdex",
    },
    security: {
      intro:
        "Vérifiez l'accès au Gateway, la politique des outils, l'authentification des appareils et les approbations.",
      title: "Sécurité",
  ...
  configView: {
    ...
    syncPendingHint: "En attente de synchronisation via le gateway.",
    notifications: {
    ...
    appearance: {
      intro: "Préférences de thème, de chat et de barre latérale pour ce client Control UI.",
      theme: "Thème",
    ...
    chatPrefs: {
      ...
      messageWidth: "Largeur du message",
      messageWidthHint:
        "Largeur CSS facultative pour la transcription centrée, telle que 960px, 82% ou min(1280px, 82%).",
      messageWidthInvalid:
    ...
    formUnsafeCount:
      "1 paramètre de cette config ne peut être modifié qu'en tant que texte : {paths}",
    formUnsafeCountPlural:
      "{count} paramètres de cette config ne peuvent être modifiés qu'en tant que texte : {paths}",
    formUnsafeMore: "+{count} de plus",
    openRawEditor: "Ouvrir l'éditeur brut",
  ...
  terminal: {
    ...
    uploadTooLarge: "Le fichier dépasse la limite de téléversement de 16 Mio du terminal : {file}",
    uploadUnsafeCmdPath:
      "Impossible d'insérer en toute sécurité un chemin téléversé contenant % ou ! dans cmd.exe",
    uploadUnsupportedShell:
      "Impossible d'insérer en toute sécurité un chemin téléversé dans un shell non pris en charge : {shell}",
  },
  browser: {
    title: "Navigateur",
    ...
    errors: {
      requestFailed: "La requête du navigateur a échoué : {error}",
      screenshotPathMissing: "La capture d'écran du navigateur n'a pas renvoyé de chemin de média.",
      screenshotFetchTimedOut: "Le délai de récupération de la capture d'écran a expiré.",
      screenshotFetchFailed: "La récupération de la capture d'écran a échoué ({status}).",
      screenshotReadFailed: "La lecture de la capture d'écran a échoué.",
      screenshotDecodeFailed: "Le décodage de la capture d'écran a échoué.",
      canvasUnavailable: "Contexte Canvas 2D indisponible.",
    },
    annotatePrompt: {
      introTitled:
  ...
  subtitles: {
    ...
    dashboards: "Fils qui s'ouvrent sur leur face tableau de bord.",
    ...
    lobsterdex: "Chaque palette de homard ayant visité ce navigateur.",
    automation: "Commandes, hooks, cron et plugins.",
    mcp: "Serveurs MCP, authentification, outils et diagnostics.",
    memory: "Moteur de mémoire, backend, recherche et rêve.",
    talk: "Voix en temps réel : fournisseur, modèle et voix du locuteur.",
  ...
  modelSetup: {
    ...
    required: {
      ...
      body: "OpenClaw n'a pas trouvé de fournisseur ni de modèle configuré pour cet agent. Ajoutez-en un avant de démarrer une conversation.",
      action: "Configurer un fournisseur",
    },
    connectionFailure: {
      title: "OpenClaw n'a pas pu utiliser l'IA configurée",
      body: "Cet agent a un fournisseur et un modèle sélectionnés, mais la connexion a échoué. Vérifiez la connexion au fournisseur ou la clé API, l'accès au modèle et l'état du service, puis réessayez.",
      action: "Vérifier les paramètres du fournisseur",
    },
    ...
    unavailable: {
      ...
      useApiKey: "Utiliser une clé API",
    },
    signIn: {
    ...
    manual: {
      ...
      verifyHint:
        "OpenClaw vérifie une véritable réponse de modèle avant de marquer la connexion comme prête.",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "À partir des sessions passées",
      subtitle:
        "Préparez les mémoires fiables des sessions précédentes de l'agent. Le rêve promeut les plus utiles en mémoire à long terme.",
      dateRange: "Plage de dates des sessions",
      dateRangeHint: "Laissez l'une des dates vide pour analyser toute la plage disponible.",
      from: "Du",
      to: "Au",
      actions: "Remplir",
      preview: "Aperçu",
      ...
      applying: "Application…",
      rollback: "Annuler",
      previewSummary: "{candidates} candidats sur {days} jours",
      previewTruncated:
        "Cet aperçu affiche le premier lot limité. L'application se poursuit avec les candidats restants.",
      candidateCount: "{count} candidats",
      noCandidates: "Aucun nouveau candidat de session fiable n'a été trouvé.",
      progress: "{days} jours traités · {staged} préparés",
      processedCandidates: "{count} candidats de session traités",
      processedDayCountOne: "{count} jour traité",
      processedDayCount: "{count} jours traités",
      complete: "{count} préparés ; la promotion se fait via le rêve",
      rollbackConfirmTitle: "Annuler le remplissage des sessions ?",
      rollbackConfirmDescription:
        "Supprimer les entrées de journal et les souvenirs préparés créés par le remplissage des sessions pour cet agent.",
      rollbackWarning:
        "Les curseurs de session suivis restent en place, donc les entrées supprimées ne seront pas préparées à nouveau.",
      rollbackComplete: "Remplissage des sessions annulé",
      rollbackCounts: "{diary} entrées de journal et {staged} entrées préparées supprimées",
      unavailable: "Le remplissage des sessions n'est pas disponible sur ce Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      title: "OpenClaw",
      toggle: "Demander à OpenClaw",
      close: "Fermer Ask OpenClaw",
      resize: "Redimensionner Ask OpenClaw",
      dockBottom: "Ancrer Ask OpenClaw en bas",
      dockRight: "Ancrer Ask OpenClaw à droite",
    },
    history: {
      button: "Historique",
    ...
    nudge: {
      ...
      channelSetupTitle: "Joindre OpenClaw en dehors de cette application",
      channelSetupBody:
      ...
      channelSetupDismiss: "Continuer avec l'application web",
    },
  },
  mcpServers: {
  ...
  mcpPage: {
    intro: "Connectez et gérez les serveurs MCP qui fournissent des outils à OpenClaw.",
    ...
    setUpFirstServer: "Configurez votre premier serveur MCP",
  ...
  talkPage: {
    intro:
      "Configurez les fournisseurs de voix en temps réel, les modèles et les voix des locuteurs.",
    voiceSection: {
      title: "Voix en temps réel",
      description:
        "Conversations vocales continues avec votre agent. Les sélecteurs ci-dessous écrivent les paramètres talk.realtime ; le formulaire complet plus bas couvre tout le reste.",
    },
    status: {
      title: "Statut",
      ready: "Prêt",
      ...
      unavailable: "Indisponible",
      unavailableHint:
        "Connectez-vous au Gateway pour vérifier la disponibilité de la voix en temps réel.",
      activeProvider: "Fournisseur actif : {provider}",
      noProvider: "Aucun fournisseur de voix en temps réel n'est encore configuré.",
    },
    provider: {
      title: "Fournisseur",
      description: "Auto choisit le premier fournisseur avec des identifiants fonctionnels.",
      auto: "Automatique",
    },
    model: {
      title: "Modèle",
      description: "Modèle de voix en temps réel pour les sessions Talk du navigateur.",
      default: "Valeur par défaut du fournisseur",
      defaultNamed: "Par défaut ({model})",
    },
    voice: {
      title: "Voix du locuteur",
      description:
        "Voix utilisée pour les réponses vocales. GPT-Live verrouille la voix dès qu'un appel commence.",
      default: "Valeur par défaut du fournisseur",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live fonctionne avec un abonnement ChatGPT : connectez-vous une fois avec « openclaw models auth login --provider openai ». Aucune clé Platform API requise. Browser Talk uniquement. Le travail délégué peut être piloté pendant son exécution et nécessite une confirmation vocale exacte pour les actions à fort impact.",
      ready: "Prêt",
    },
  },
  memoryPage: {
    intro: "Choisissez comment OpenClaw stocke, recherche et gère la mémoire de l'agent.",
    tablistLabel: "Sections de mémoire",
    tabs: {
      overview: "Aperçu",
      memories: "Souvenirs",
      dreams: "Rêves",
    ...
    overview: {
      hero: {
        awake: "La mémoire est active",
        waking: "Réveil de la mémoire…",
        hibernating: "La mémoire est en veille",
        needsAttention: "La mémoire nécessite une attention",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Vérification du moteur de mémoire et du cycle de rêve de cet agent.",
        offDescription: "Choisissez un moteur de mémoire dans les Paramètres pour l'activer.",
        disabledDescription:
          "Le moteur de mémoire sélectionné est désactivé. Réactivez-le dans les Paramètres.",
        gatewayOffline: "Le gateway est hors ligne, l'état de la mémoire est donc indisponible.",
        hybridSearch: "recherche hybride",
        keywordSearch: "recherche par mots-clés (sans embeddings)",
      ...
      schedule: {
        ...
        lightDescription:
          "Trie les notes récentes à court terme et prépare les candidats prometteurs sans modifier la mémoire à long terme.",
        remDescription:
          "Réfléchit aux thèmes et aux idées récurrentes de l'activité récente pour renforcer le classement sans modifier la mémoire à long terme.",
        deepDescription:
          "Évalue les candidats préparés, promeut ceux à conserver dans la mémoire à long terme (MEMORY.md) et rédige le journal des rêves.",
        nextRun: "prochain {time}",
        lastRun: "dernier {time}",
        notScheduled: "Non planifié",
        learnMore: "Fonctionnement des rêves",
        openDocs: "Ouvrir le guide des rêves",
      },
      activity: {
        title: "Activité",
        promotedToday: "Promus aujourd'hui",
        promotedTotal: "Total promu",
        shortTermCount: "Entrées à court terme en attente",
        phaseHitCount: "Signaux de phase",
        lightPhaseHitCount: "Occurrences en phase légère",
        remPhaseHitCount: "Occurrences en phase REM",
      },
      health: {
        title: "Santé du moteur",
        provider: "Fournisseur",
        embeddings: "Embeddings",
        runtime: "Runtime des embeddings",
        healthy: "Prêt",
        unavailable: "Indisponible",
        notChecked: "Non vérifié",
        notCheckedDescription: "La disponibilité de l'embedding n'a pas encore été vérifiée.",
        checking: "Vérification…",
        test: "Tester",
      ...
      shortcuts: {
        ...
        diary: "Lire le journal des rêves",
        settings: "Configurer la mémoire",
      },
    },
    memories: {
      searchLabel: "Rechercher des souvenirs",
      searchPlaceholder: "Rechercher dans les souvenirs de cet agent",
      searchButton: "Recherche",
      idle: "Recherchez une personne, un projet, une décision ou tout ce dont cet agent se souvient.",
      searching: "Recherche de souvenirs…",
      results: "{count} résultats",
      empty: "Aucun souvenir ne correspond à « {query} ».",
      error: "Échec de la recherche de souvenirs : {message}",
      retry: "Réessayer",
      gatewayUpdateRequired:
        "Mettez à jour le gateway pour rechercher des souvenirs depuis le Control UI.",
      hybridSearch: "recherche hybride",
      keywordSearch: "recherche par mot-clé",
      lineRange: "lignes {start}–{end}",
      score: "score {score}",
      sourceMemory: "mémoire",
      sourceSessions: "sessions",
      fileLoading: "Chargement du fichier de mémoire complet…",
      fileError: "Impossible de charger ce fichier de mémoire : {message}",
      fileUnsupported: "Ce fichier de mémoire ne peut pas être affiché sous forme de texte.",
    },
    engine: {
      title: "Moteur",
      description:
      ...
      changeFailed: "Impossible de changer le moteur de mémoire",
    ...
    backend: {
      title: "Backend",
      description: "Comment la mémoire est stockée et récupérée pour le moteur sélectionné.",
      rowTitle: "Backend de récupération",
      builtin: "Intégré",
      qmd: "QMD",
      invalid: "Valeur configurée invalide",
      builtinHint: "Les fichiers de mémoire sont indexés et recherchés par OpenClaw lui-même.",
      qmdHint: "La récupération est déléguée à QMD. Ses paramètres apparaissent ci-dessous.",
      invalidHint:
        "La valeur memory.backend configurée est invalide. Choisissez un backend ou réinitialisez-la pour utiliser la valeur par défaut.",
    },
    addons: {
      title: "Modules complémentaires",
      description:
        "Ces plugins se superposent au moteur au lieu de se disputer l'emplacement, de sorte que toute combinaison peut fonctionner en même temps.",
      activeMemory: {
      ...
      toggleAriaLabel: "Activer ou désactiver {plugin}",
      changeFailed: "Impossible de mettre à jour {plugin}",
    ...
    import: {
      title: "Importer",
      description:
        "Importez la mémoire existante d'autres assistants dans un espace de travail d'agent.",
      link: "Ouvrir l'import de mémoire",
    },
    search: {
      intro:
        "Paramètres d'embedding et de récupération par défaut partagés par chaque agent qui n'a pas de remplacement de mémoire.",
    },
    dreaming: {
      intro:
        "Le rêve s'exécute comme une seule tâche cron gérée sur tous les espaces de travail des agents, donc ces paramètres sont globaux. Ils sont gérés par le plugin {plugin}.",
      schedule: {
        title: "Planification",
        description: "Quand le balayage complet s'exécute et quel modèle le narre.",
      },
      frequency: {
        label: "Fréquence du rêve",
        help: "Cadence cron pour le balayage complet du rêve (léger, paradoxal, puis profond). Laissez vide pour la valeur par défaut du plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        ...
        default: "Fuseau horaire local du Gateway",
      },
      model: {
        label: "Modèle de rêve",
        help: "Remplacement du fournisseur/modèle pour la narration du journal de rêve. Nécessite que les remplacements de modèle des sous-agents soient autorisés.",
        placeholder: "anthropic/claude-sonnet-4-6",
        default: "Modèle de l'agent",
      },
      verboseLogging: {
        label: "Journalisation détaillée",
        help: "Journalise chaque phase du rêve en détail. Utile pour ajuster les seuils.",
      },
      storage: {
        title: "Stockage",
        description: "Où sont écrites les mémoires promues et les rapports de rêve.",
        modeLabel: "Mode de stockage",
        modeHelp:
          "Inline écrit dans le fichier de mémoire ; separate conserve un fichier de rapport dédié.",
        modes: {
          inline: "Inline",
          separate: "Séparé",
          both: "Les deux",
        ...
        separateReportsHelp: "Garder les rapports de rêve hors du fichier de mémoire principal.",
      },
      phases: {
        light: {
          title: "Phase légère",
          description:
            "Passage économique sur l'activité récente qui prépare les candidats à la relecture.",
        },
        deep: {
          title: "Phase profonde",
          description:
            "Passage de promotion noté qui fait passer les entrées à court terme en mémoire.",
        },
        rem: {
          title: "Phase REM",
          description:
            "Passage sur les motifs qui recherche les thèmes récurrents dans la fenêtre d'analyse.",
        },
      },
      phaseFields: {
        enabled: "Activé",
        enabledHelp: "Exécuter cette phase pendant le balayage.",
        lookbackDays: "Jours d'analyse rétrospective",
        lookbackDaysHelp:
          "Jusqu'où cette phase lit en arrière. Laisser vide pour la valeur par défaut du plugin.",
        limit: "Limite",
        ...
        dedupeSimilarityHelp:
          "Similarité au-dessus de laquelle deux candidats sont considérés comme des doublons.",
        minScore: "Score minimum",
        minScoreHelp: "Score de promotion qu'une entrée doit atteindre.",
        minRecallCount: "Rappels minimum",
        minRecallCountHelp:
          "Fréquence à laquelle une entrée doit être rappelée avant de pouvoir être promue.",
        minUniqueQueries: "Nombre minimal de requêtes uniques",
        minUniqueQueriesHelp: "Nombre de requêtes distinctes ayant fait remonter l'entrée.",
        recencyHalfLifeDays: "Demi-vie de récence (jours)",
        recencyHalfLifeDaysHelp:
          "Rapidité avec laquelle les anciens signaux de rappel perdent en importance.",
        maxAgeDays: "Âge maximal (jours)",
        maxAgeDaysHelp: "Ignorer les entrées à court terme plus anciennes que cette valeur.",
        maxPromotedSnippetTokens: "Nombre maximal de jetons par extrait promu",
        maxPromotedSnippetTokensHelp:
          "Budget de jetons pour chaque extrait promu. La provenance reste attachée.",
        minPatternStrength: "Force minimale de motif",
        minPatternStrengthHelp: "Force qu'un motif récurrent doit atteindre pour être signalé.",
      },
      agentScope: {
        title: "Vue de l'agent",
        description:
          "Les paramètres ci-dessus sont globaux. Le journal de rêve, les décomptes à court terme et les actions de maintenance ci-dessous appartiennent à un seul agent.",
        rowTitle: "Agent",
      },
      unsupported: {
        title: "Paramètres de rêve",
        rowTitle: "Non disponible pour ce moteur",
        description:
          "Le plugin {plugin} occupe l'emplacement de mémoire et son schéma de configuration ne comporte aucune section de rêve, ces paramètres ne peuvent donc pas être enregistrés. Changez de moteur dans l'onglet Aperçu pour les modifier.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Activez les protections basées sur l'historique glissant qui avertissent ou bloquent les appels d'outils répétés lorsqu'un agent cesse de progresser.",
    },
    localModelLean: {
      title: "Outils allégés pour les modèles locaux",
      description:
        "Abandonnez les outils lourds par défaut que les petits modèles locaux gèrent mal, pour ne conserver qu'un ensemble réduit qu'ils peuvent utiliser de manière fiable.",
    },
    auditMessages: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Consultez l'activité, les coûts et les tendances d'utilisation.",
    identity: {
      title: "Identité",
  ...
  skillWorkshop: {
    ...
    evaluation: {
      ...
      evaluatorVersion: "Évaluateur {version}",
      mode: "Mode {mode}",
      findings: "Constats",
      metrics: "Métriques",
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "La révision de proposition actuelle n'a pas pu être identifiée.",
        revisionChanged: "La révision de proposition a changé pendant l'évaluation.",
      },
    },
    empty: {
    ...
    today: {
      ...
      evaluate: "Évaluer",
      runChecks: "Exécuter les vérifications de proposition",
      tweakIt: "Ajuster",
  ...
  dreaming: {
    ...
    header: {
      ...
      engineOff:
        "Le moteur de mémoire est désactivé. Choisissez un moteur dans les Paramètres pour activer le dreaming.",
    },
    toggleConfirmation: {
      subtitle:
        "Le mode Dreaming est un paramètre global ; il ne s'applique pas uniquement à cet agent.",
      enableTitle: "Activer le mode Dreaming pour tous les agents",
      enableDetail:
        "Le balayage nocturne de dreaming s'exécutera sur chaque espace de travail d'agent configuré, promouvant les rappels à court terme vers la mémoire à long terme. Ceci s'applique immédiatement.",
      enableConfirm: "Activer le mode Dreaming",
      disableTitle: "Désactiver le mode Dreaming pour tous les agents",
      disableDetail:
        "Le balayage nocturne de dreaming s'arrêtera pour chaque agent configuré, pas seulement celui-ci. Les souvenirs déjà enregistrés sont conservés ; rien de nouveau n'est promu. Ceci s'applique immédiatement.",
      disableConfirm: "Désactiver le mode Dreaming",
      saving: "Enregistrement…",
    ...
    actions: {
      dedupeRemovedOneAndKept: "{removed} entrée de rêve en double supprimée et {kept} conservée.",
      dedupeRemovedManyAndKept:
        "{removed} entrées de rêve en double supprimées et {kept} conservées.",
      dedupeRemovedOne: "{removed} entrée de rêve en double supprimée.",
      dedupeRemovedMany: "{removed} entrées de rêve en double supprimées.",
      repairArchivedThreadCorpus: "corpus de fils archivé",
      repairArchivedIngestionState: "état d'ingestion archivé",
      repairArchivedDreamDiary: "journal de rêves archivé",
      repairNoChanges: "La réparation du cache de rêves s'est terminée sans modification.",
      repairCompleteWithArchive:
        "Réparation du cache de rêves terminée : {actions}. Archive : {archiveDir}",
      repairComplete: "Réparation du cache de rêves terminée : {actions}.",
      backfillComplete: "{count} entrées du journal de rêves ont été remplies.",
      resetDiaryComplete: "{count} entrées de journal de rêves remplies ont été supprimées.",
      clearReplayedComplete: "{count} entrées à court terme rejouées ont été effacées.",
      complete: "Action du journal de rêves terminée.",
      confirmRepair:
        "Réparer le cache de rêves ? Cela archive les fichiers de cache de rêves dérivés et les reconstruit à partir d'entrées propres. Votre journal de rêves reste intact.",
      confirmDedupe:
        "Dédupliquer le journal de rêves ? Cela réécrit DREAMS.md et supprime uniquement les entrées de journal en double exact.",
      archivePathCopied: "Chemin d'archive copié.",
      archivePathCopyFailed: "Impossible de copier le chemin d'archive.",
      updateFailed: "Impossible de mettre à jour les paramètres de rêve.",
      unsupportedPlugin:
        "Le plugin de mémoire sélectionné « {pluginId} » ne prend pas en charge les paramètres de rêve.",
      configHashMissing: "Hachage de configuration manquant ; actualisez et réessayez.",
    },
    wiki: {
      ...
      counts: {
        pageOne: "{count} page",
        pages: "{count} pages",
        claimRowOne: "{count} ligne d'affirmation",
        claimRows: "{count} lignes d'affirmation",
        openQuestionOne: "{count} question ouverte",
        openQuestions: "{count} questions ouvertes",
        contradictionOne: "{count} contradiction",
        contradictions: "{count} contradictions",
        chats: "{count} conversations",
        sensitive: "{count} sensibles",
        signals: "{count} signaux",
        messages: "{count} messages",
        userMessages: "{count} utilisateur",
      ...
      questionCountOnPages: "{questionCount} sur {pageCount}",
      risk: {
      ...
      pageNotFound: "Aucune page wiki trouvée pour {lookup}.",
      previewTruncated: "Affichage du premier extrait de cette page.",
      previewTruncatedWithTotal:
        "Affichage du premier extrait de cette page ({count} lignes au total).",
      importedClusterSummary: "Discussions importées regroupées autour de {label}.",
      withheldDigestOne: "{count} résumé a été retenu en attente de révision.",
      withheldDigests: "{count} résumés ont été retenus en attente de révision.",
      details: "Détails",
      hideDetails: "Masquer les détails",
      vault: "Coffre",
      fullVaultBreakdown: "Répartition complète du coffre : {breakdown}.",
      selectedSection: "Section sélectionnée : {summary}.",
      latestUpdate: "Dernière mise à jour {date}.",
      noContent: "Aucun contenu wiki disponible.",
    },
    phrases: {
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Intensité quotidienne des tokens pour la plage sélectionnée, jusqu'à un an.",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable:
        "La demande de couplage du navigateur n'est pas encore disponible. Réessayez dans un instant.",
      loadFailed: "Impossible de charger la demande de couplage de ce navigateur : {error}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "La conversation a changé de branche — vérifiez et renvoyez.",
    },
    waitingForApproval: "En attente d'approbation…",
    startupStatus: {
    ...
    commandResults: {
      startingNewThread: "Démarrage d'un nouveau fil...",
      resettingThread: "Réinitialisation du fil...",
      stoppingCurrentRun: "Arrêt de l'exécution en cours...",
      chatHistoryCleared: "Historique de conversation effacé.",
      exportingThread: "Exportation du fil...",
      unknownCommand: "Commande inconnue : `{command}`",
      options: "Options : {options}.",
      sessionUnavailable: "La fonctionnalité de session est indisponible",
      help: {
        availableCommands: "Commandes disponibles",
        agentCommand: "agent",
        openMenu: "Tapez `/` pour ouvrir le menu des commandes.",
      },
      compaction: {
        failed: "Échec du compactage.",
        failedWithReason: "Échec du compactage : {reason}",
        tokenSummary: " ({before} -> {after} tokens)",
        succeeded: "Contexte compacté avec succès",
        skipped: "Compactage ignoré.",
        skippedWithReason: "Compactage ignoré : {reason}",
      },
      model: {
        current: "**Modèle actuel :** {model}",
        available: "**Disponibles :** {models}",
        more: "+{count} de plus",
        getFailed: "Échec de la récupération des informations du modèle : {error}",
        set: "Modèle défini sur {model}.",
        setFailed: "Échec de la définition du modèle : {error}",
      },
      thinking: {
        current: "Niveau de réflexion actuel : {level}.",
        getFailed: "Échec de l'obtention du niveau de réflexion : {error}",
        reset: "Niveau de réflexion réinitialisé à la valeur par défaut.",
        resetFailed: "Échec de la réinitialisation du niveau de réflexion : {error}",
        unrecognized: "Niveau de réflexion non reconnu « {level} ». Niveaux valides : {options}.",
        unsupported:
          "Niveau de réflexion non pris en charge « {level} » pour ce modèle. Niveaux valides : {options}.",
        set: "Niveau de réflexion défini sur {level}.",
        setFailed: "Échec de la définition du niveau de réflexion : {error}",
      },
      verbose: {
        current: "Niveau détaillé actuel : {level}.",
        getFailed: "Échec de l'obtention du niveau détaillé : {error}",
        unrecognized: "Niveau détaillé non reconnu « {level} ». Niveaux valides : off, on, full.",
        set: "Mode détaillé défini sur {level}.",
        setFailed: "Échec de la définition du mode détaillé : {error}",
      },
      fast: {
        ...
        sourceAgent: " (par défaut : agent)",
        sourceModel: " (par défaut : modèle)",
        sourceDefault: " (par défaut)",
        current: "Mode rapide actuel : {value}",
        options: "on, off, auto ({seconds} sec), default, status",
        getFailed: "Échec de la récupération du mode rapide : {error}",
        reset: "Mode rapide réinitialisé par défaut.",
        resetFailed: "Échec de la réinitialisation du mode rapide : {error}",
        unrecognized:
          "Mode rapide « {mode} » non reconnu. Niveaux valides : on, off, auto, default, status.",
        setAuto: "Mode rapide réglé sur auto.",
        enabled: "Mode rapide activé.",
        disabled: "Mode rapide désactivé.",
        setFailed: "Échec du réglage du mode rapide : {error}",
      },
      usage: {
        noActiveThread: "Aucun fil actif.",
        notAvailable: "s. o.",
        title: "Utilisation du fil",
        inputTokens: "Entrée : {count} tokens",
        outputTokens: "Sortie : {count} tokens",
        totalTokens: "Total : {count} tokens",
        context: "Contexte : {percent} sur {total}",
        model: "Modèle : {model}",
        failed: "Échec de la récupération de l'utilisation : {error}",
      },
      agents: {
        none: "Aucun agent configuré.",
        title: "**Agents** ({count})",
        default: "par défaut",
        runtime: " · exécution {runtime}",
        failed: "Échec de la liste des agents : {error}",
      },
      steer: {
        timeout:
          "L'exécution active s'est terminée avant que le message de pilotage ne soit accepté.",
        failed: "Le pilotage a échoué avant d'atteindre l'exécution ; réessayez.",
        usage: "Utilisation : `/steer <message>`",
        noActiveRun: "Aucune exécution active. Utilisez plutôt la saisie de chat ou `/redirect`.",
        succeeded: "Piloté.",
        requestFailed: "Échec du pilotage : {error}",
      },
      redirect: {
        timeout:
          "L'exécution active s'est terminée avant que le message de redirection ne soit accepté.",
        failed: "La redirection a échoué avant d'atteindre l'exécution ; réessayez.",
        usage: "Utilisation : `/redirect <message>`",
        succeeded: "Redirigé.",
        requestFailed: "Échec de la redirection : {error}",
      },
    },
    sessionSharing: {
    ...
    sessionSuggestions: {
      ...
      sendNow: "Envoyer la suggestion de {author} maintenant",
    ...
    sessionHeader: {
      ...
      gatewayPicker: {
        ...
        openSettings: "Paramètres du Gateway…",
        connected: "Connecté",
    ...
    markdown: {
      truncated: "… tronqué ({total} caractères, affichage des {shown} premiers).",
    },
    codeBlock: {
      jsonLines: "JSON · {count} lignes",
    },
    workspaceConflict: {
    ...
    sidebar: {
      ...
      groups: "Groupes",
      coding: "Codage",
      noSessionsForAgent: "Aucune session trouvée pour cet agent",
      ...
      catalogDiscoveryHelp:
        "{error}. Configurez la découverte native des threads dans Paramètres > Automatisation > Plugins.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        steering: "Pilotage",
        applyingSettings: "Application des paramètres de chat",
        waitingForRun: "En attente de l'exécution en cours",
        runningCommand: "Exécution de la commande",
        waitingForReconnect: "En attente de reconnexion",
        needsReview: "Vérification requise",
      },
    ...
    goals: {
      ...
      showDetails: "Afficher les détails de l'objectif",
      hideDetails: "Masquer les détails de l'objectif",
    },
    questions: {
      ...
      expired: "Expiré",
      cancelled: "Annulé",
      disconnected: "Non connecté. Réessayez après la reconnexion.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      askInSideChat: "Demander dans le chat latéral",
      ...
      duplicatesCollapsed: "{count} messages identiques consécutifs réduits",
      contextFor: "Contexte du message pour {timestamp}",
    },
    mediaPlayer: {
      play: "Lire",
      pause: "Suspendre",
    ...
    modelControls: {
      ...
      defaultWithModel: "Par défaut ({model})",
      defaultWithLevel: "Par défaut ({level})",
      fastHelp:
      ...
      fastResponsesAria: "Réponses rapides : {state}",
    },
    rail: {
      title: "Compagnon de session",
      subtitle: "Posez des questions sur cette session ou son projet",
      expand: "Développer le rail de session",
      collapse: "Réduire le rail de session",
      hide: "Masquer le rail de session",
      show: "Afficher le rail de session",
      clear: "Effacer le fil du compagnon",
      plan: "Plan",
      ...
      empty: "Posez une question en lecture seule sur cette session ou son projet.",
      askLabel: "Interroger le compagnon de session",
      askPlaceholder: "Que dois-je savoir ?",
      askSubmit: "Demander",
      askPending: "Vérification de la session…",
      askBusy: "Le compagnon répond déjà à une question.",
      askUnavailable: "Le compagnon ne peut pas répondre pour le moment.",
      asOf: "au {time}",
      health: {
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "Le contenu complet n'est pas disponible car l'entrée de transcription stockée est trop volumineuse pour être renvoyée en toute sécurité.",
      fullContentNotVisible:
        "Le contenu complet n'est pas disponible car cette entrée de transcription n'a pas de projection WebChat visible.",
      fullContentUnavailable:
        "Le contenu complet n'est plus disponible pour cette entrée de transcription.",
      copyContents: "Copier le contenu du fichier",
      fileChanged: "Le fichier a été modifié sur le disque depuis son chargement.",
      renderPreview: "Afficher l'aperçu",
      imagePreview: "Aperçu de l'image",
      file: "Fichier",
      markdownPreview: "Aperçu Markdown",
      toolDetails: "Détails de l'outil",
      reloadFailed: "Échec du rechargement du dernier fichier.",
      overwriteLoadFailed: "Échec du chargement du dernier fichier avant écrasement.",
      fullContentLoadFailed: "Échec du chargement du contenu complet : {error}",
    },
    sidebarColumns: {
      chat: "Chat",
    ...
    composer: {
      ...
      fallbackActive: "Repli actif : {model}",
      fallbackCleared: "Repli effacé : {model}",
      fallbackSelected: "Sélectionné : {model}",
      fallbackCurrent: "Actif : {model}",
      fallbackPrevious: "Repli précédent : {model}",
      fallbackReason: "Raison : {reason}",
      fallbackAttempts: "Tentatives : {attempts}",
      ...
      menu: {
        ...
        noSkills: "Aucun Skill disponible.",
        noConnectors: "Aucun serveur MCP configuré.",
        depsMissing: "dépendances manquantes",
        skillBlocked: "non disponible pour cet agent",
        sessionTag: "session",
        offlineBlocked: "Connectez-vous au Gateway pour modifier les capacités de la session.",
        readOnlyBlocked:
          "Un accès en écriture est requis pour modifier les capacités de la session.",
        adminBlocked: "Un accès administrateur est requis pour gérer les connecteurs.",
        savingBlocked: "Attendez la fin de la modification en cours des capacités de la session.",
      },
      overrides: {
        count: "{count} remplacements de session",
        countOne: "{count} remplacement de session",
        clear: "Effacer les remplacements de session",
      },
      contextUsage: {
    ...
    attachments: {
      ...
      outsideAllowedFolders: "En dehors des dossiers autorisés",
      unavailable: "Indisponible",
      checking: "Vérification...",
    },
    voice: {
      asking: "Demande à OpenClaw...",
      connecting: "Connexion de l'entrée vocale...",
  ...
  cron: {
    adminRequired:
      "Consultation uniquement. Les modifications d'automatisation nécessitent un accès operator.admin.",
    tabs: {
