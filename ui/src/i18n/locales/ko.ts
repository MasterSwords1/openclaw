...
export const ko: TranslationMap = {
  ...
  mcpApp: {
    ...
    errors: {
      gatewayUnavailable: "MCP App gateway를 사용할 수 없습니다",
      mountUnavailable: "MCP App 마운트를 사용할 수 없습니다",
      sandboxTimedOut: "MCP App 샌드박스 시간이 초과되었습니다",
      sandboxUnavailable: "MCP App 샌드박스를 사용할 수 없습니다",
      initializationTimedOut: "MCP App 초기화 시간이 초과되었습니다",
      requestFailed: "요청 실패",
      invalidSandboxUrl: "MCP App 샌드박스 URL이 잘못되었습니다",
    },
  },
  githubPreview: {
  ...
  channels: {
    ...
    nostr: {
      ...
      notices: {
        timeout:
          "30초 후 요청 시간이 초과되었습니다. 서버에서 변경 사항이 이미 적용되었을 수 있으니, 다시 시도하기 전에 프로필을 확인하세요.",
        operationFailed: "{prefix}: {error}",
        updateFailed: "프로필 업데이트 실패",
        updateFailedStatus: "프로필 업데이트 실패 ({status})",
        publishFailed: "모든 릴레이에서 프로필 게시에 실패했습니다.",
        published: "프로필이 릴레이에 게시되었습니다.",
        importFailed: "프로필 가져오기에 실패했습니다",
        importFailedStatus: "프로필 가져오기에 실패했습니다 ({status})",
        importedFromRelays: "릴레이에서 프로필을 가져왔습니다. 검토 후 게시하세요.",
        imported: "프로필을 가져왔습니다. 검토 후 게시하세요.",
      },
    },
  },
  lazyView: {
  ...
  updates: {
    refreshRequired: "서버가 업데이트되었습니다 — 전체 기능을 사용하려면 새로 고침하세요",
    coalescedRestart:
      "업데이트가 설치되었습니다. Gateway 재시작이 이미 진행 중이며, 다시 연결되면 상태가 새로 고쳐집니다.",
    error: "업데이트 오류: {error}",
    status: "업데이트 {status}: {reason}. {guidance}",
    verificationFailed:
      "업데이트가 설치되었지만 실행 중인 버전이 변경되지 않았습니다 — 재시작이 차단되었을 수 있습니다.",
    ...
    failureReasons: {
      ...
      buildDirty:
        "선택한 리비전의 빌드가 체크아웃 파일을 변경했습니다. 생성된 아티팩트가 포함된 리비전으로 다시 시도하세요.",
      uiBuildFailed: "control UI 재빌드에 실패했습니다. UI 빌드 오류를 수정하고 다시 시도하세요.",
      globalInstallFailed:
        "전역 패키지 설치가 디스크에서 확인되지 않았습니다. 다시 시도하거나 CLI에서 재설치하세요.",
      restartDisabled:
        "gateway 재시작이 비활성화되어 업데이트가 적용되지 않았습니다. 설정에서 재시작을 활성화한 후 다시 시도하세요.",
      restartUnavailable:
        "재시작이 비활성화되어 있고 슈퍼바이저가 없는 상태에서는 이 전역 설치를 안전하게 교체할 수 없습니다.",
      restartUnhealthy:
        "교체 프로세스가 정상 상태가 되지 못했습니다. 복구할 수 있도록 이전 프로세스가 유지되었습니다.",
      managedServiceHandoffAlreadyRunning:
        "다른 관리형 업데이트가 이미 실행 중입니다. 완료될 때까지 기다린 후 업데이트 상태를 새로 고치세요.",
      doctorFailed:
        "Doctor 복구에 실패했습니다. `openclaw doctor --non-interactive`를 실행하고 다시 시도하세요.",
      default: "정확한 실패 원인은 gateway 로그를 확인하고 원인이 해결된 후 다시 시도하세요.",
    },
    postRestart: {
      restartUnhealthy: "교체 프로세스가 정상 상태가 되지 못했고 이전 프로세스가 유지되었습니다.",
      default: "교체 실패에 대해서는 gateway 로그를 확인하세요.",
    },
  },
  nodes: {
    pairing: {
  ...
  dashboardsPage: {
    ...
    emptyDescription: "스레드를 열고 Dashboard 페이스로 전환하여 여기에 추가하세요.",
    loadError: "대시보드를 불러올 수 없습니다: {error}",
  },
  sessionsView: {
    subagentPrefix: "서브에이전트:",
    automationPrefix: "자동화:",
    ...
    approvalNeeded: "승인 필요",
    queuedMessage: "보내기 위해 대기 중인 메시지 {count}개",
    queuedMessages: "보내기 위해 대기 중인 메시지 {count}개",
  ...
  agents: {
    ...
    defaults: {
      title: "에이전트 기본값",
      description: "재정의하지 않는 한 모든 에이전트가 상속하는 기본값입니다.",
    },
    copyId: "Copy ID",
    ...
    files: {
      ...
      addFile: "파일 추가…",
      createHint: "이 파일은 아직 존재하지 않습니다. 저장하면 에이전트 워크스페이스에 생성됩니다.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  configForm: {
    redactedPlaceholder: "[편집됨 - 보려면 표시를 클릭하세요]",
    sectionHelp: "{section} 도움말",
    readGuide: "가이드 읽기",
    showAdvanced: "고급 표시",
    advancedHidden: "고급 설정 {count}개 숨김",
    advancedHiddenPlural: "고급 설정 {count}개 숨김",
    advancedDivider: "고급",
    hideValue: "값 숨기기",
    revealValue: "값 표시",
    ...
    defaultValue: "기본값: {value}",
    usingDefault: "기본값 사용: {value}",
    resetToDefault: "기본값으로 재설정",
    select: "선택...",
    nullValue: "null",
    jsonValue: "JSON 값",
    invalidJson: "이 필드를 벗어나기 전에 유효한 JSON을 입력하세요.",
    invalidString: "이 설정의 제약 조건에 맞는 값을 입력하세요.",
    invalidNumber: "허용된 범위와 단계 내의 값을 입력하세요.",
    draftRejected: "이 설정을 저장할 수 없습니다. 초안은 그대로 유지됩니다.",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardFirstVisited: "처음 방문 {date}",
      lobsterdexCardShinySeen: "✦ {date}에 반짝이 발견",
      lobsterdexCardCopyLink: "링크 복사",
      lobsterdexOpen: "Lobsterdex 열기",
    },
    security: {
      intro: "게이트웨이 접근, 도구 정책, 기기 인증, 승인을 검토합니다.",
      title: "보안",
  ...
  configView: {
    ...
    syncPendingHint: "게이트웨이를 통한 동기화를 기다리는 중입니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
    ...
    chatPrefs: {
      ...
      messageWidthInvalid:
        "960px, 82%, min(1280px, 82%), calc(100% - 2rem)와 같은 CSS 너비를 입력하세요.",
    },
    sidebarPrefs: {
      title: "사이드바",
    ...
    formUnsafeCount: "이 구성의 설정 1개는 텍스트로만 편집할 수 있습니다: {paths}",
    formUnsafeCountPlural: "이 구성의 설정 {count}개는 텍스트로만 편집할 수 있습니다: {paths}",
    formUnsafeMore: "+{count}개 더보기",
    openRawEditor: "Raw 편집기 열기",
  ...
  terminal: {
    ...
    uploadTooLarge: "파일이 16 MiB 터미널 업로드 한도를 초과합니다: {file}",
    uploadUnsafeCmdPath: "% 또는 !가 포함된 업로드 경로는 cmd.exe에 안전하게 삽입할 수 없습니다",
    uploadUnsupportedShell:
      "지원되지 않는 셸에 업로드된 경로를 안전하게 삽입할 수 없습니다: {shell}",
  },
  browser: {
    title: "브라우저",
    toggle: "브라우저 패널 전환",
    ...
    errors: {
      requestFailed: "브라우저 요청 실패: {error}",
      screenshotPathMissing: "브라우저 스크린샷이 미디어 경로를 반환하지 않았습니다.",
      screenshotFetchTimedOut: "스크린샷 가져오기 시간이 초과되었습니다.",
      screenshotFetchFailed: "스크린샷 가져오기 실패 ({status}).",
      screenshotReadFailed: "스크린샷 읽기 실패.",
      screenshotDecodeFailed: "스크린샷 디코딩 실패.",
      canvasUnavailable: "Canvas 2D 컨텍스트를 사용할 수 없습니다.",
    },
    annotatePrompt: {
      introTitled:
  ...
  subtitles: {
    ...
    dashboards: "대시보드 페이스로 열리는 스레드입니다.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaButton: "확인 및 설정",
      ollamaLabel: "Ollama",
      ollamaHint: "Ollama 서버에서 도구를 지원하는 모델을 다운로드하세요",
      llamaCppLabel: "로컬 모델 (llama.cpp)",
      providerNotReady:
        "{provider}가 사용 가능한 로컬 모델을 노출하지 않았습니다. 설정 결과를 확인한 후 다시 시도하세요.",
    },
    manual: {
      title: "API 키 또는 토큰으로 연결",
      provider: "제공업체",
      selectProvider: "제공업체 선택",
      selectProviderHint: "이 자격 증명의 출처를 선택하세요",
      accessValue: "API 키 또는 토큰",
      accessValueFor: "{provider} API 키 또는 토큰",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "지난 세션에서",
      subtitle:
        "이전 에이전트 세션의 신뢰할 수 있는 기억을 준비합니다. 드리밍이 유용한 기억을 장기 기억으로 승격합니다.",
      dateRange: "세션 날짜 범위",
      dateRangeHint: "사용 가능한 전체 범위를 스캔하려면 날짜 중 하나를 비워 두세요.",
      from: "시작",
      to: "종료",
      actions: "백필",
      preview: "미리보기",
      ...
      applying: "적용 중…",
      rollback: "롤백",
      previewSummary: "{days}일에 걸친 후보 {candidates}개",
      previewTruncated:
        "이 미리 보기는 첫 번째 제한된 배치를 표시합니다. 적용하면 나머지 후보까지 계속 진행됩니다.",
      candidateCount: "후보 {count}개",
      noCandidates: "새로운 신뢰할 수 있는 세션 후보를 찾지 못했습니다.",
      progress: "{days}일 처리됨 · {staged}개 준비됨",
      processedCandidates: "세션 후보 {count}개 처리됨",
      processedDayCountOne: "{count}일 처리됨",
      processedDayCount: "{count}일 처리됨",
      complete: "{count}개 준비됨; 승격은 드리밍을 통해 이루어집니다",
      rollbackConfirmTitle: "세션 백필을 롤백하시겠습니까?",
      rollbackConfirmDescription:
        "이 에이전트의 세션 백필로 생성된 일기 항목과 스테이징된 메모리를 제거합니다.",
      rollbackWarning:
        "추적된 세션 커서는 그대로 유지되므로 제거된 항목은 다시 스테이징되지 않습니다.",
      rollbackComplete: "세션 백필이 롤백되었습니다",
      rollbackCounts: "일기 항목 {diary}개와 스테이징된 항목 {staged}개가 제거되었습니다",
      unavailable: "이 Gateway에서는 세션 백필을 사용할 수 없습니다.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  mcpServers: {
    ...
    sessionUnavailable: "활성 세션을 사용할 수 없습니다. 새로 고침 후 다시 시도하세요.",
  ...
  mcpPage: {
    ...
    setUpFirstServer: "첫 MCP 서버 설정하기",
  ...
  talkPage: {
    intro: "실시간 음성 제공업체, 모델, 스피커 음성을 구성합니다.",
    voiceSection: {
      title: "실시간 음성",
      description:
        "에이전트와의 연속 음성 대화입니다. 아래 선택기는 talk.realtime 설정을 작성하며, 아래쪽의 전체 양식에서 나머지 모든 항목을 다룹니다.",
    },
    status: {
      title: "상태",
      ready: "준비됨",
      notReady: "구성되지 않음",
      unavailable: "사용 불가",
      unavailableHint: "실시간 음성 준비 상태를 확인하려면 Gateway에 연결하세요.",
      activeProvider: "활성 제공업체: {provider}",
      noProvider: "아직 구성된 실시간 음성 제공업체가 없습니다.",
    },
    provider: {
      title: "제공업체",
      description: "자동은 자격 증명이 유효한 첫 번째 제공자를 선택합니다.",
      auto: "자동",
    },
    model: {
      title: "모델",
      description: "브라우저 Talk 세션용 실시간 음성 모델입니다.",
      default: "제공자 기본값",
      defaultNamed: "기본값 ({model})",
    },
    voice: {
      title: "스피커 음성",
      description: "음성 응답에 사용되는 음성입니다. GPT-Live는 통화가 시작되면 음성을 고정합니다.",
      default: "제공자 기본값",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live는 ChatGPT 구독으로 작동합니다. “openclaw models auth login --provider openai”로 한 번만 로그인하세요. Platform API 키가 필요 없습니다. 브라우저 Talk 전용입니다. 위임된 작업은 실행 중에 조정할 수 있으며 영향이 큰 작업에는 정확한 음성 확인이 필요합니다.",
      ready: "준비됨",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        awake: "메모리가 깨어 있습니다",
        waking: "메모리를 깨우는 중…",
        hibernating: "메모리가 대기 중입니다",
        needsAttention: "메모리에 주의가 필요합니다",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "이 에이전트의 메모리 엔진과 드림 사이클을 확인하는 중입니다.",
        offDescription: "설정에서 메모리 엔진을 선택해 깨우세요.",
        disabledDescription:
          "선택한 메모리 엔진이 비활성화되어 있습니다. 설정에서 다시 활성화하세요.",
        gatewayOffline: "Gateway가 오프라인이라 메모리 상태를 사용할 수 없습니다.",
        hybridSearch: "하이브리드 검색",
        keywordSearch: "키워드 검색 (임베딩 없음)",
        openSettings: "설정 열기",
        retry: "재시도",
        refresh: "상태 새로 고침",
      },
      schedule: {
        title: "수면 일정",
        lightDescription:
          "새로운 단기 메모를 정리하고 유망한 후보를 준비하며 장기 기억은 변경하지 않습니다.",
        remDescription:
          "최근 활동 전반의 주제와 반복되는 아이디어를 되돌아보며 장기 기억을 변경하지 않고 순위를 강화합니다.",
        deepDescription:
          "준비된 후보에 점수를 매기고, 유지할 항목을 장기 기억(MEMORY.md)으로 승격하며, 꿈 일기를 작성합니다.",
        nextRun: "다음 {time}",
        lastRun: "마지막 {time}",
      ...
      activity: {
        title: "활동",
        promotedToday: "오늘 승격됨",
        promotedTotal: "총 승격 수",
        shortTermCount: "대기 중인 단기 항목",
        phaseHitCount: "단계 신호",
        lightPhaseHitCount: "라이트 단계 히트",
        remPhaseHitCount: "REM 단계 히트",
      },
      health: {
        title: "엔진 상태",
        provider: "제공자",
        ...
        unavailable: "사용 불가",
        notChecked: "확인 안 됨",
        notCheckedDescription: "임베딩 준비 상태가 아직 확인되지 않았습니다.",
        checking: "확인 중…",
        test: "테스트",
        testing: "테스트 중…",
      },
    ...
    memories: {
      searchLabel: "메모리 검색",
      searchPlaceholder: "이 에이전트의 메모리 검색",
      searchButton: "검색",
      idle: "이 에이전트가 기억하는 사람, 프로젝트, 결정 등 무엇이든 검색하세요.",
      searching: "메모리 검색 중…",
      results: "{count}개 결과",
      empty: "“{query}”와 일치하는 메모리가 없습니다.",
      error: "메모리 검색 실패: {message}",
      retry: "재시도",
      gatewayUpdateRequired: "Control UI에서 메모리를 검색하려면 Gateway를 업데이트하세요.",
      hybridSearch: "하이브리드 검색",
      ...
      sourceMemory: "메모리",
      sourceSessions: "세션",
      fileLoading: "전체 메모리 파일을 불러오는 중…",
      fileError: "이 메모리 파일을 불러올 수 없습니다: {message}",
      fileUnsupported: "이 메모리 파일은 텍스트로 표시할 수 없습니다.",
    },
    engine: {
      title: "엔진",
      description:
    ...
    backend: {
      title: "백엔드",
      description: "선택한 엔진에 대해 메모리가 저장되고 검색되는 방식입니다.",
      rowTitle: "검색 백엔드",
      builtin: "기본 제공",
      qmd: "QMD",
      invalid: "잘못된 구성 값",
      ...
      invalidHint:
        "구성된 memory.backend 값이 잘못되었습니다. 백엔드를 선택하거나 기본값을 사용하도록 재설정하세요.",
    },
    addons: {
      title: "애드온",
      description:
        "이 플러그인들은 슬롯을 두고 경쟁하는 대신 엔진 위에 계층으로 동작하므로, 어떤 조합이든 동시에 실행할 수 있습니다.",
      activeMemory: {
        title: "활성 메모리",
      },
      memoryWiki: {
      ...
      toggleAriaLabel: "{plugin} 활성화 또는 비활성화",
      changeFailed: "{plugin}을(를) 업데이트할 수 없습니다",
      stateUnknown: "알 수 없음",
    ...
    dreaming: {
      intro:
        "Dreaming은 모든 에이전트 워크스페이스에 걸쳐 하나의 관리형 cron 작업으로 실행되므로 이 설정은 전역입니다. 이 설정은 {plugin} 플러그인이 소유합니다.",
      schedule: {
        title: "일정",
        description: "전체 스윕이 실행되는 시점과 이를 서술하는 모델입니다.",
      },
      frequency: {
        label: "Dreaming 빈도",
        help: "전체 dreaming 스윕(light, REM, deep 순)의 cron 주기입니다. 플러그인 기본값을 사용하려면 비워 두세요.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "시간대",
        ...
        default: "Gateway 로컬 시간대",
      },
      model: {
        label: "Dreaming 모델",
        help: "dream diary 서술을 위한 provider/model 재정의입니다. 서브에이전트 모델 재정의가 허용되어야 합니다.",
        placeholder: "anthropic/claude-sonnet-4-6",
        default: "에이전트 모델",
      },
      verboseLogging: {
        label: "상세 로깅",
        help: "각 dreaming 단계를 자세히 기록합니다. 임계값을 조정할 때 유용합니다.",
      },
      storage: {
        title: "스토리지",
        description: "승격된 메모리와 dreaming 보고서가 기록되는 위치입니다.",
        modeLabel: "스토리지 모드",
        modeHelp: "Inline은 메모리 파일에 기록하고, Separate는 전용 보고서 파일을 유지합니다.",
        modes: {
          inline: "Inline",
          separate: "Separate",
          both: "Both",
        },
        separateReportsLabel: "리포트 분리",
        separateReportsHelp: "dreaming 리포트를 기본 메모리 파일에서 분리합니다.",
      },
      phases: {
        light: {
          title: "라이트 단계",
          description: "리플레이 후보를 준비하는 저비용 최근 활동 처리 단계입니다.",
        },
        deep: {
          title: "딥 단계",
          description: "단기 항목을 메모리로 승격시키는 점수 기반 승격 처리 단계입니다.",
        },
        rem: {
          title: "REM 단계",
          description: "룩백 기간에 걸쳐 반복되는 주제를 찾는 패턴 처리 단계입니다.",
        },
      },
      phaseFields: {
        enabled: "활성화됨",
        ...
        lookbackDays: "룩백 일수",
        lookbackDaysHelp:
          "이 단계가 얼마나 이전까지 읽을지 설정합니다. 플러그인 기본값을 사용하려면 비워 두세요.",
        limit: "제한",
        limitHelp: "이 단계가 실행당 처리하는 최대 항목 수입니다.",
        dedupeSimilarity: "중복 제거 유사도",
        dedupeSimilarityHelp: "두 후보를 중복으로 처리하는 기준이 되는 유사도 값입니다.",
        minScore: "최소 점수",
        ...
        minUniqueQueriesHelp: "항목을 표면화한 고유 쿼리 수입니다.",
        recencyHalfLifeDays: "최근성 반감기(일)",
        recencyHalfLifeDaysHelp: "오래된 회상 신호가 얼마나 빠르게 가중치를 잃는지입니다.",
        maxAgeDays: "최대 기간(일)",
        maxAgeDaysHelp: "이 기간보다 오래된 단기 항목을 무시합니다.",
        maxPromotedSnippetTokens: "승격된 스니펫 최대 토큰",
        maxPromotedSnippetTokensHelp:
          "승격된 각 스니펫의 토큰 예산입니다. 출처 정보는 그대로 유지됩니다.",
        minPatternStrength: "최소 패턴 강도",
        minPatternStrengthHelp: "반복되는 패턴이 보고되기 위해 도달해야 하는 강도입니다.",
      },
      agentScope: {
        title: "에이전트 보기",
        description:
          "위 설정은 전역입니다. 아래의 드림 다이어리, 단기 카운트, 유지 관리 작업은 하나의 에이전트에 속합니다.",
        rowTitle: "에이전트",
      },
      unsupported: {
        title: "드리밍 설정",
        rowTitle: "이 엔진에서 사용할 수 없음",
        description:
  ...
  labsPage: {
    ...
    loopDetection: {
      title: "도구 루프 감지",
      description:
        "에이전트가 진전을 멈췄을 때 반복되는 도구 호출을 경고하거나 차단하는 롤링 히스토리 가드를 활성화합니다.",
    },
    localModelLean: {
      title: "로컬 모델용 경량 도구",
      description:
        "작은 로컬 모델이 제대로 처리하지 못하는 무거운 기본 도구를 제거하고, 안정적으로 사용할 수 있는 더 짧은 세트만 남깁니다.",
    },
    auditMessages: {
      title: "메시지 감사 메타데이터",
      description:
        "감사 원장에 직접 대화의 콘텐츠 없는 메타데이터를 기록합니다. 메시지 내용은 저장되지 않습니다.",
    },
  },
  aboutPage: {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "활동, 비용, 사용 추세를 확인합니다.",
    identity: {
      title: "ID",
      menuLabel: "ID 메뉴",
  ...
  skillWorkshop: {
    ...
    evaluation: {
      ...
      evaluatorVersion: "평가기 {version}",
      mode: "모드 {mode}",
      findings: "발견 사항",
      metrics: "지표",
      fileLine: "{file}:{line}",
      errors: {
        revisionHashUnavailable: "현재 제안 리비전을 식별할 수 없습니다.",
        revisionChanged: "평가 중에 제안 리비전이 변경되었습니다.",
      },
    },
    empty: {
  ...
  dreaming: {
    ...
    header: {
      ...
      on: "드리밍 켜짐",
      off: "드리밍 꺼짐",
      engineOff: "메모리 엔진이 꺼져 있습니다. 드리밍을 활성화하려면 설정에서 엔진을 선택하세요.",
    },
    toggleConfirmation: {
      subtitle: "Dreaming은 전역 설정으로, 이 에이전트에만 적용되지 않습니다.",
      enableTitle: "모든 에이전트에 대해 Dreaming 켜기",
      enableDetail:
        "야간 dreaming 스윕이 구성된 모든 에이전트 워크스페이스에서 실행되어, 단기 회상을 장기 기억으로 승격합니다. 즉시 적용됩니다.",
      enableConfirm: "Dreaming 켜기",
      disableTitle: "모든 에이전트에 대해 Dreaming 끄기",
      disableDetail:
        "야간 dreaming 스윕이 이 에이전트뿐만 아니라 구성된 모든 에이전트에서 중지됩니다. 이미 기록된 기억은 유지되며, 새로 승격되는 것은 없습니다. 즉시 적용됩니다.",
    ...
    actions: {
      dedupeRemovedOneAndKept: "중복 드림 항목 {removed}개를 삭제하고 {kept}개를 유지했습니다.",
      dedupeRemovedManyAndKept: "중복 드림 항목 {removed}개를 삭제하고 {kept}개를 유지했습니다.",
      dedupeRemovedOne: "중복 드림 항목 {removed}개를 삭제했습니다.",
      dedupeRemovedMany: "중복 드림 항목 {removed}개를 삭제했습니다.",
      repairArchivedThreadCorpus: "보관된 스레드 코퍼스",
      repairArchivedIngestionState: "보관된 수집 상태",
      repairArchivedDreamDiary: "보관된 꿈 일기",
      repairNoChanges: "변경 사항 없이 꿈 캐시 복구가 완료되었습니다.",
      repairCompleteWithArchive: "꿈 캐시 복구 완료: {actions}. 보관: {archiveDir}",
      repairComplete: "꿈 캐시 복구 완료: {actions}.",
      backfillComplete: "{count}개의 꿈 일기 항목을 채웠습니다.",
      resetDiaryComplete: "채워진 꿈 일기 항목 {count}개를 제거했습니다.",
      clearReplayedComplete: "재생된 단기 항목 {count}개를 지웠습니다.",
      complete: "꿈 일기 작업이 완료되었습니다.",
      confirmRepair:
        "꿈 캐시를 복구할까요? 파생된 꿈 캐시 파일을 보관하고 깨끗한 입력에서 다시 만듭니다. 꿈 일기는 그대로 유지됩니다.",
      confirmDedupe:
        "꿈 일기의 중복을 제거할까요? DREAMS.md를 다시 작성하고 정확히 중복되는 일기 항목만 제거합니다.",
      archivePathCopied: "보관 경로를 복사했습니다.",
      archivePathCopyFailed: "보관 경로를 복사할 수 없습니다.",
      updateFailed: "dreaming 설정을 업데이트할 수 없습니다.",
      unsupportedPlugin:
        '선택한 메모리 플러그인 "{pluginId}"은(는) dreaming 설정을 지원하지 않습니다.',
      configHashMissing: "구성 해시가 없습니다. 새로 고침 후 다시 시도하세요.",
    },
    wiki: {
      ...
      counts: {
        pageOne: "{count}개 페이지",
        pages: "{count}개 페이지",
        claimRowOne: "{count}개 주장 행",
        claimRows: "{count}개 주장 행",
        openQuestionOne: "{count}개 미해결 질문",
        openQuestions: "{count}개 미해결 질문",
        contradictionOne: "{count}개 모순",
        contradictions: "{count}개 모순",
        chats: "{count}개 채팅",
        sensitive: "{count}개 민감",
        signals: "{count}개 신호",
        messages: "메시지 {count}개",
        userMessages: "{count}개 사용자",
        assistantMessages: "{count}개 어시스턴트",
      },
      pageGroupSummary: "{label} · {count}",
      noPagesYet: "아직 페이지가 없습니다",
      sectionPageSummary: "{label}: {count}",
      questionCountOnPages: "{pageCount}개 페이지에 {questionCount}개",
      risk: {
        needsReview: "검토 필요",
        low: "낮은 위험",
        medium: "중간 위험",
      ...
      pageNotFound: "{lookup}에 대한 위키 페이지를 찾을 수 없습니다.",
      previewTruncated: "이 페이지의 첫 번째 청크를 표시합니다.",
      previewTruncatedWithTotal: "이 페이지의 첫 번째 청크를 표시합니다(총 {count}줄).",
      importedClusterSummary: "가져온 채팅이 {label} 중심으로 그룹화되었습니다.",
      withheldDigestOne: "검토 대기 중으로 요약 {count}개가 보류되었습니다.",
      withheldDigests: "검토 대기 중으로 요약 {count}개가 보류되었습니다.",
      details: "세부 정보",
      hideDetails: "세부 정보 숨기기",
      vault: "Vault",
      fullVaultBreakdown: "전체 vault 내역: {breakdown}.",
      selectedSection: "선택된 섹션: {summary}.",
      latestUpdate: "최근 업데이트 {date}.",
      noContent: "사용 가능한 위키 콘텐츠가 없습니다.",
    },
    phrases: {
      ...
      defragmentingMemoryLane: "기억의 조각 모으는 중…",
  ...
  modelProviders: {
    ...
    readiness: {
      title: "AI 설정",
      heading: "검증된 AI 모델 연결",
      signedInNoModels:
        "로그인되었지만 이 계정에는 사용 가능한 모델이 없습니다. 계속하려면 다른 공급자나 계정을 선택하세요.",
      notConfigured: "공급자를 선택하고 OpenClaw가 사용할 모델을 검증하세요.",
  ...
  usage: {
    ...
    heatmap: {
      title: "토큰 활동",
      subtitle: "선택한 범위의 일별 토큰 강도, 최대 1년까지.",
      cellTokens: "{tokens} 토큰",
      less: "적음",
      more: "많음",
    },
    providerUsage: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "이 레거시 브라우저는 일시적으로 사용할 수 있습니다. 기기 ID로 보안을 설정하려면 HTTPS 또는 localhost에서 다시 여세요.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "스레드가 분기를 전환했습니다 — 확인 후 다시 보내세요.",
    },
    waitingForApproval: "승인 대기 중…",
    startupStatus: {
    ...
    sessionRoute: {
      chooseTitle: "세션 선택",
      multipleMatches: "{shortId}와(과) 일치하는 세션이 두 개 이상입니다.",
      additionalMatches: "검색 결과가 남아 있습니다. 더 긴 id 접두사를 사용하세요.",
    },
    commandResults: {
      startingNewThread: "새 스레드를 시작하는 중...",
      resettingThread: "스레드를 초기화하는 중...",
      stoppingCurrentRun: "현재 실행을 중지하는 중...",
      chatHistoryCleared: "채팅 기록이 지워졌습니다.",
      exportingThread: "스레드를 내보내는 중...",
      unknownCommand: "알 수 없는 명령어: `{command}`",
      options: "옵션: {options}.",
      sessionUnavailable: "세션 기능을 사용할 수 없습니다",
      help: {
        availableCommands: "사용 가능한 명령어",
        agentCommand: "에이전트",
        openMenu: "`/`를 입력하여 명령어 메뉴를 여세요.",
      },
      compaction: {
        failed: "압축에 실패했습니다.",
        failedWithReason: "압축 실패: {reason}",
        tokenSummary: " ({before} -> {after} 토큰)",
        succeeded: "컨텍스트가 성공적으로 압축되었습니다",
        skipped: "압축을 건너뛰었습니다.",
        skippedWithReason: "압축 건너뜀: {reason}",
      },
      model: {
        current: "**현재 모델:** {model}",
        available: "**사용 가능:** {models}",
        more: "+{count}개 더보기",
        getFailed: "모델 정보를 가져오지 못했습니다: {error}",
        set: "모델이 {model}(으)로 설정되었습니다.",
        setFailed: "모델을 설정하지 못했습니다: {error}",
      },
      thinking: {
        current: "현재 사고 수준: {level}.",
        getFailed: "사고 수준을 가져오지 못했습니다: {error}",
        reset: "사고 수준이 기본값으로 초기화되었습니다.",
        resetFailed: "사고 수준을 초기화하지 못했습니다: {error}",
        unrecognized: '인식할 수 없는 사고 수준 "{level}". 유효한 수준: {options}.',
        unsupported: '이 모델에서 지원하지 않는 사고 수준 "{level}". 유효한 수준: {options}.',
        set: "사고 수준이 {level}(으)로 설정되었습니다.",
        setFailed: "사고 수준을 설정하지 못했습니다: {error}",
      },
      verbose: {
        current: "현재 상세 수준: {level}.",
        getFailed: "상세 수준을 가져오지 못했습니다: {error}",
        unrecognized: '인식할 수 없는 상세 수준 "{level}". 유효한 수준: off, on, full.',
        set: "상세 모드가 {level}(으)로 설정되었습니다.",
        setFailed: "상세 모드를 설정하지 못했습니다: {error}",
      },
      fast: {
        autoValue: "auto ({seconds}초)",
        on: "켜짐",
        off: "꺼짐",
        ...
        current: "현재 빠른 모드: {value}",
        options: "on, off, auto ({seconds}초), default, status",
        getFailed: "빠른 모드를 가져오지 못했습니다: {error}",
        reset: "빠른 모드가 기본값으로 재설정되었습니다.",
        resetFailed: "빠른 모드를 재설정하지 못했습니다: {error}",
        unrecognized:
          '인식할 수 없는 빠른 모드 "{mode}". 유효한 값: on, off, auto, default, status.',
        setAuto: "빠른 모드가 auto로 설정되었습니다.",
        enabled: "빠른 모드가 활성화되었습니다.",
        disabled: "빠른 모드가 비활성화되었습니다.",
        setFailed: "빠른 모드를 설정하지 못했습니다: {error}",
      },
      usage: {
        noActiveThread: "활성 스레드가 없습니다.",
        notAvailable: "해당 없음",
        title: "스레드 사용량",
        inputTokens: "입력: {count} 토큰",
        outputTokens: "출력: {count} 토큰",
        totalTokens: "합계: {count} 토큰",
        context: "컨텍스트: {total} 중 {percent}",
        model: "모델: {model}",
        failed: "사용량을 가져오지 못했습니다: {error}",
      },
      agents: {
        none: "구성된 에이전트가 없습니다.",
        title: "**에이전트** ({count})",
        default: "기본값",
        runtime: " · 런타임 {runtime}",
        failed: "에이전트 목록을 가져오지 못했습니다: {error}",
      },
      steer: {
        timeout: "steer 메시지가 수락되기 전에 활성 실행이 종료되었습니다.",
        failed: "실행에 도달하기 전에 steer가 실패했습니다. 다시 시도하세요.",
        usage: "사용법: `/steer <message>`",
        noActiveRun: "활성 실행이 없습니다. 대신 채팅 입력 또는 `/redirect`를 사용하세요.",
        succeeded: "방향을 조정했습니다.",
        requestFailed: "steer에 실패했습니다: {error}",
      },
      redirect: {
        timeout: "redirect 메시지가 수락되기 전에 활성 실행이 종료되었습니다.",
        failed: "실행에 도달하기 전에 redirect가 실패했습니다. 다시 시도하세요.",
        usage: "사용법: `/redirect <message>`",
        succeeded: "방향을 전환했습니다.",
        requestFailed: "redirect에 실패했습니다: {error}",
      },
    },
    sessionSharing: {
      menu: "스레드 공유",
    ...
    markdown: {
      truncated: "… 잘림 ({total}자, 처음 {shown}자 표시).",
    },
    codeBlock: {
      jsonLines: "JSON · {count}줄",
    },
    workspaceConflict: {
    ...
    sidebar: {
      ...
      groups: "그룹",
      coding: "코딩",
      noSessionsForAgent: "이 에이전트에 대한 세션이 없습니다",
      ...
      catalogDiscoveryHelp:
        "{error}. 설정 > 자동화 > 플러그인에서 네이티브 스레드 검색을 구성하세요.",
    },
    welcome: {
    ...
    queue: {
      ...
      states: {
        steering: "조정 중",
        applyingSettings: "채팅 설정 적용 중",
        waitingForRun: "현재 실행 대기 중",
        runningCommand: "명령 실행 중",
        waitingForReconnect: "재연결 대기 중",
        needsReview: "검토 필요",
      },
    ...
    goals: {
      ...
      resume: "목표 재개",
      clear: "목표 지우기",
      showDetails: "목표 세부 정보 표시",
      hideDetails: "목표 세부 정보 숨기기",
    },
    questions: {
      ...
      expired: "만료됨",
      cancelled: "취소됨",
      disconnected: "연결되지 않았습니다. 재연결 후 다시 시도하세요.",
    },
    imageLightbox: {
    ...
    messages: {
      ...
      replyingTo: "{name}님에게 답장 중",
      message: "메시지",
      currentMessage: "현재 메시지",
      actions: "메시지 작업",
      selectionActions: "선택 작업",
      moreDetails: "자세히 보기",
      askInSideChat: "사이드 채팅에서 질문",
      rewind: "되감기",
      ...
      voiceNote: "음성 메모",
      duplicatesCollapsed: "동일한 메시지 {count}개가 연속으로 접힘",
      contextFor: "{timestamp}의 메시지 컨텍스트",
    },
    mediaPlayer: {
      play: "재생",
      pause: "일시 중지",
    ...
    modelControls: {
      ...
      defaultWithModel: "기본값 ({model})",
      defaultWithLevel: "기본값 ({level})",
      fastHelp: "빠른 응답은 더 일찍 완료되지만 사용 한도를 더 많이 소모할 수 있습니다.",
      speedUnsupported: "이 모델에서는 속도 제어를 지원하지 않습니다.",
      contextWindow: "컨텍스트 {count}",
      chatOnly: "채팅 전용",
      chatOnlyHelp:
        "이 모델은 채팅은 가능하지만 도구를 사용할 수 없습니다. 파일, 명령, 웹, 미디어 작업에는 다른 모델을 선택하세요.",
      providerModels: "{provider} 모델",
      resetReasoning: "기본값으로 재설정 ({level})",
      useDefaultReasoning: "기본 추론 사용 ({level})",
      fastResponsesAria: "빠른 응답: {state}",
    },
    rail: {
      title: "세션 도우미",
      subtitle: "이 세션이나 프로젝트에 대해 문의하세요",
      expand: "세션 레일 펼치기",
      collapse: "세션 레일 접기",
      hide: "세션 레일 숨기기",
      show: "세션 레일 표시",
      ...
      finished: "완료 {time}",
      empty: "이 세션이나 프로젝트에 대해 읽기 전용 질문을 하세요.",
      askLabel: "세션 도우미에게 질문하기",
      askPlaceholder: "무엇을 알아야 하나요?",
      askSubmit: "확인",
      askPending: "세션을 확인하는 중…",
      askBusy: "도우미가 이미 질문에 답하고 있습니다.",
      askUnavailable: "지금은 도우미가 답변할 수 없습니다.",
      asOf: "{time} 기준",
      health: {
        "on-track": "순조로움",
        grinding: "작업 중",
    ...
    detailPanel: {
      ...
      fullContentOversized:
        "저장된 대화 기록 항목이 너무 커서 안전하게 반환할 수 없으므로 전체 내용을 사용할 수 없습니다.",
      fullContentNotVisible:
        "이 대화 기록 항목에는 표시 가능한 WebChat 프로젝션이 없으므로 전체 내용을 사용할 수 없습니다.",
      fullContentUnavailable: "이 대화 기록 항목의 전체 내용은 더 이상 사용할 수 없습니다.",
      copyContents: "파일 내용 복사",
      fileChanged: "파일이 로드된 이후 디스크에서 변경되었습니다.",
      renderPreview: "렌더링 미리보기",
      imagePreview: "이미지 미리보기",
      file: "파일",
      markdownPreview: "Markdown 미리보기",
      toolDetails: "도구 세부 정보",
      reloadFailed: "최신 파일을 다시 불러오지 못했습니다.",
      overwriteLoadFailed: "덮어쓰기 전에 최신 파일을 불러오지 못했습니다.",
      fullContentLoadFailed: "전체 콘텐츠를 불러오지 못했습니다: {error}",
    },
    sidebarColumns: {
      chat: "채팅",
      discussion: "토론",
    ...
    composer: {
      ...
      compacting: "압축 중",
      compact: "압축",
      contextCompacted: "컨텍스트가 압축됨",
      fallbackActive: "폴백 활성화됨: {model}",
      fallbackCleared: "폴백 해제됨: {model}",
      fallbackSelected: "선택됨: {model}",
      fallbackCurrent: "활성화됨: {model}",
      fallbackPrevious: "이전 폴백: {model}",
      fallbackReason: "이유: {reason}",
      fallbackAttempts: "시도: {attempts}",
      cancelReply: "답장 취소",
      ...
      menu: {
        ...
        addMcpServerDescription: "서버를 구성하고 사용 위치를 선택하세요.",
        scopeLabel: "사용 가능 범위",
        scopeSession: "이 세션",
        scopeEverywhere: "모든 곳",
        scopeSessionHint: "서버는 전역적으로 비활성화되어 저장되고 이 세션에서만 활성화됩니다.",
        scopeEverywhereHint: "서버는 저장되어 모든 세션에서 활성화됩니다.",
        toolAccess: {
          label: "도구 액세스",
          loading: "도구 불러오는 중…",
        ...
        noSkills: "사용 가능한 Skills가 없습니다.",
        noConnectors: "구성된 MCP 서버가 없습니다.",
        depsMissing: "종속성 누락",
        skillBlocked: "이 에이전트에서 사용할 수 없음",
        sessionTag: "세션",
        offlineBlocked: "세션 기능을 변경하려면 Gateway에 연결하세요.",
        readOnlyBlocked: "세션 기능을 변경하려면 쓰기 액세스가 필요합니다.",
        adminBlocked: "커넥터를 관리하려면 관리자 액세스가 필요합니다.",
        savingBlocked: "현재 세션 기능 변경이 완료될 때까지 기다리세요.",
      },
      overrides: {
        count: "세션 재정의 {count}개",
        countOne: "세션 재정의 {count}개",
        clear: "세션 재정의 지우기",
      },
      contextUsage: {
    ...
    attachments: {
      attachedFile: "첨부된 파일",
      outsideAllowedFolders: "허용된 폴더 외부",
      unavailable: "사용 불가",
      checking: "확인 중...",
    },
    voice: {
    ...
    backgroundTasks: {
      ...
      detailTitle: "작업 세부 정보",
      backToTasks: "백그라운드 작업으로 돌아가기",
